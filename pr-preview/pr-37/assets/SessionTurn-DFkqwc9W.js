import{j as t}from"./jsx-runtime-BO8uF4Og.js";function h({lead:e}){return t.jsxs("div",{className:`session-turn-lead lead-${e.tone}`,"data-testid":e.testId,children:[t.jsxs("p",{className:"session-turn-lead-line",children:[t.jsx("span",{className:`session-turn-lead-tag tag-${e.tone}`,"aria-hidden":"true",children:e.tag}),e.srLabel&&t.jsx("span",{className:"sr-only",children:e.srLabel}),t.jsx("span",{className:"session-turn-lead-text",children:e.text})]}),e.actions&&t.jsx("div",{className:"session-turn-lead-actions",children:e.actions}),e.detail]})}function m({headingActions:e,lead:a,narrative:r,narrativeTag:n,narrativeTestId:s,selected:i=!1,variantClassName:l="",ariaLabel:o,testId:d,articleRef:c}){const u=t.jsxs("p",{className:"session-turn-narrative","data-testid":s,children:[n&&t.jsx("span",{className:"session-turn-narrative-tag","aria-hidden":"true",children:n}),r]}),p=a?t.jsx(h,{lead:a}):null;return t.jsxs("article",{className:`session-turn ${i?"selected":""} ${l}`.trim(),"aria-label":o,"data-testid":d,ref:c,children:[p,u,e&&t.jsx("div",{className:"session-turn-heading",children:t.jsx("div",{className:"session-turn-actions",children:e})})]})}m.__docgenInfo={description:"",methods:[],displayName:"SessionTurn",props:{headingActions:{required:!1,tsType:{name:"ReactNode"},description:'Quiet action row shown after the Narrative (e.g. a "ここまで戻る" button).'},lead:{required:!1,tsType:{name:"signature",type:"object",raw:`{
  tone: TurnLeadTone;
