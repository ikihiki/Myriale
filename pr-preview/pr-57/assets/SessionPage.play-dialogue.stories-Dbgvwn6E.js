import{j as c}from"./jsx-runtime-BO8uF4Og.js";import{w as o,e as t,u as s}from"./index-C4S39nCK.js";import{M as l}from"./MyrialeApp-DoXUDVls.js";import{c as be}from"./SessionPresentation-Dg1HwfvX.js";import{M as H}from"./MockSessionContainer-DMcMbNPL.js";/* empty css               */import"./index-D4H_InIO.js";import"./ConditionTablePresentation-ybfbi74E.js";import"./Surfaces-xpIMDkG0.js";import"./EditPane-OsFMeo59.js";import"./MyrialeToggle-nBW4_8Wv.js";import"./navigationRecipes-DkSbwkz5.js";import"./index-DzKAYa42.js";import"./AppChrome-CqlUs9ri.js";import"./MyrialeMenu-CLGgTteF.js";import"./scenarioWizardStyles-DbrtSybi.js";import"./ModuleUiHost-CoZk1x5n.js";import"./account-CrOIROJF.js";import"./SessionListPresentation-Cou-SJ3F.js";import"./SessionIcons-yGOCmQwo.js";import"./SessionTurn-9KUaF1pl.js";import"./SessionActivityFeed-C9D4yeN4.js";const E=()=>{const a=be("activeSession");return{...a,playSessions:{...a.playSessions,"SES-PREP-1098":{...a.playSessions["SES-PREP-1098"],turn:12,summary:"複数ターン経過後のアプリ画面確認用ログ。"}}}},$e={title:"ユーザーストーリー/Session play dialogue",component:l,render:()=>c.jsx(l,{initialUrl:"/sessions/SES-PREP-1098",initialDb:E(),sessionContainer:H}),parameters:{notes:"docs/user-stories/session-play-dialogue-user-stories.md の各ユーザーストーリーを、Storybook Interactions の step と expect で操作説明できるアプリ画面にしたものです。"}},r=async(a,n)=>{const e=a.getByLabelText("自由に行動や会話を入力");await s.clear(e),await s.type(e,n),await s.click(a.getByRole("button",{name:"行動を送る"}))},y={name:"US-P01: AIが現在の状況を語ってほしい",play:async({canvasElement:a,step:n})=>{const e=o(a);await n("ActiveなSessionの開始時に、現在地・周囲・直近の出来事をNarrativeとして表示する",async()=>{await t(e.getByTestId("session-state")).toHaveTextContent("Active"),await t(e.getByTestId("turn-1-narrative")).toHaveTextContent("水没した閲覧室"),await t(e.getByTestId("turn-1-narrative")).toHaveTextContent("銀の鍵"),await t(e.getByTestId("dialogue-notice")).toHaveTextContent("現在地、周囲、直近の出来事")})}},v={name:"完了済みSession: 読み取り専用で物語を開く",render:()=>{const a=E();return c.jsx(l,{initialUrl:"/sessions/SES-PREP-1098",initialDb:{...a,playSessions:{...a.playSessions,"SES-PREP-1098":{...a.playSessions["SES-PREP-1098"],state:"Completed"}}},sessionContainer:H})},play:async({canvasElement:a,step:n})=>{const e=o(a);await n("完了済みの物語はログを表示したまま進行操作を隠す",async()=>{await t(e.getByTestId("session-state")).toHaveTextContent("Completed"),await t(e.getByTestId("completed-session-read-only")).toBeVisible(),await t(e.queryByLabelText("自由に行動や会話を入力")).not.toBeInTheDocument(),await t(e.getByTestId("dialogue-log")).toHaveTextContent("水没した閲覧室")})}},u={name:"Composer: 行動判定AIとナラティブ生成AIを個別に選ぶ",play:async({canvasElement:a,step:n})=>{const e=o(a);await n("2つのAI selectorを推奨profileで初期表示する",async()=>{await t(e.getByLabelText("行動判定AI")).toHaveTextContent("推奨（Deckard 40B FP8）"),await t(e.getByLabelText("ナラティブ生成AI")).toHaveTextContent("推奨（Deckard 40B FP8）")}),await n("行動判定だけ最安profileへ変更し、ナラティブ生成の選択は独立して保持する",async()=>{await s.click(e.getByLabelText("行動判定AI")),await s.click(o(document.body).getByRole("option",{name:"最安（Qwen3.6 27B GPTQ）"})),await t(e.getByLabelText("行動判定AI")).toHaveTextContent("最安（Qwen3.6 27B GPTQ）"),await t(e.getByLabelText("ナラティブ生成AI")).toHaveTextContent("推奨（Deckard 40B FP8）")})}},p={name:"US-P02/P03: 自然言語で行動を入力し、結果を物語として受け取る",play:async({canvasElement:a,step:n})=>{const e=o(a);await n("自由入力欄に自然な文章で行動を書く",async()=>{await s.type(e.getByLabelText("自由に行動や会話を入力"),"周囲を警戒しながら閲覧室を出る"),await t(e.getByLabelText("自由に行動や会話を入力")).toHaveValue("周囲を警戒しながら閲覧室を出る")}),await n("送信すると行動として解釈され、成功・想定外の展開を含むNarrativeが生成される",async()=>{await s.click(e.getByRole("button",{name:"行動を送る"})),await t(e.getByTestId("dialogue-log")).toHaveTextContent("プレイヤーの入力: 周囲を警戒しながら閲覧室を出る"),await t(e.getByTestId("dialogue-log")).toHaveTextContent("想定外の痕跡"),await t(e.getByTestId("dialogue-notice")).toHaveTextContent("結果をNarrativeとして生成")})}},m={name:"Composer: Shift+Enterで改行し、Enterで送信する",play:async({canvasElement:a,step:n})=>{const e=o(a),i=e.getByLabelText("自由に行動や会話を入力");await n("Shift+Enterは送信せず改行する",async()=>{await s.type(i,"一行目"),await s.keyboard("{Shift>}{Enter}{/Shift}二行目"),await t(i).toHaveValue(`一行目
二行目`),await t(e.getByTestId("dialogue-log")).not.toHaveTextContent("プレイヤーの入力: 一行目")}),await n("Enterは入力を送信し、composerを空に戻す",async()=>{await s.keyboard("{Enter}"),await t(e.getByTestId("dialogue-log")).toHaveTextContent("プレイヤーの入力: 一行目 二行目"),await t(i).toHaveValue("")})}},d={name:"Narrative generation: loading中は入力操作を無効化する",render:()=>c.jsx(l,{initialUrl:"/sessions/SES-PREP-1098",initialDb:E(),sessionContainer:({sessionId:a})=>c.jsx(H,{sessionId:a,initiallySubmitting:!0})}),play:async({canvasElement:a,step:n})=>{const e=o(a);await n("Narrative生成中の進行表示を示し、重複操作につながる入力Controlsを無効化する",async()=>{await t(e.getByRole("button",{name:"Narrativeを生成中"})).toBeDisabled(),await t(e.getByLabelText("自由に行動や会話を入力")).toBeDisabled(),await t(e.getByRole("button",{name:"AIに次の行動を提案してもらう"})).toBeDisabled()})}},w={name:"Composer: 送信ボタンの二重clickでTurnを重複作成しない",render:()=>c.jsx(l,{initialUrl:"/sessions/SES-PREP-1098",initialDb:E(),sessionContainer:({sessionId:a})=>c.jsx(H,{sessionId:a,submissionDelayMs:25})}),play:async({canvasElement:a,step:n})=>{const e=o(a),i=e.getByLabelText("自由に行動や会話を入力");await s.type(i,"二重送信されないことを確認する"),await n("送信ボタンを素早く二重clickしても、最初の送信中に再送しない",async()=>{await s.dblClick(e.getByRole("button",{name:"行動を送る"}));const Ce=await e.findByRole("article",{name:"Turn 13"});await t(Ce).toHaveTextContent("プレイヤーの入力: 二重送信されないことを確認する"),await t(e.queryByRole("article",{name:"Turn 14"})).not.toBeInTheDocument()})}},T={name:"US-P04: NPCと自然に会話したい",play:async({canvasElement:a,step:n})=>{const e=o(a);await n("NPCへの発話を自由入力で送る",async()=>{await r(e,"書架の奥にいる人物に「あなたは誰？」と尋ねる")}),await n("NPCの立場・関係性に沿った返答がNarrativeに入り、会話内容が文脈に残る",async()=>{await t(e.getByTestId("dialogue-log")).toHaveTextContent("書架の奥の人物"),await t(e.getByTestId("dialogue-log")).toHaveTextContent("会話内容はセッション文脈に記録")})}},g={name:"US-P05: AIに補足説明や再説明を求めたい",play:async({canvasElement:a,step:n})=>{const e=o(a);await n("補足説明ボタンから「今の状況を簡単にまとめて」を送る",async()=>{await s.click(e.getByRole("button",{name:"状況を簡単にまとめて聞く"})),await t(e.getByTestId("dialogue-log")).toHaveTextContent("補足説明")}),await n("補足要求は行動扱いにせず、物語進行やSession状態を変化させない",async()=>{await t(e.getByTestId("dialogue-notice")).toHaveTextContent("行動ではない"),await t(e.getByTestId("session-state")).toHaveTextContent("Active"),await t(e.getByTestId("active-turn-summary")).toHaveTextContent("物語状態は変化しない")})}},B={name:"US-P05B: AIに次の行動案を推薦してほしい",play:async({canvasElement:a,step:n})=>{const e=o(a);await n("AI推薦ボタンを押すと、現在の状況に沿った行動案が入力欄へ入る",async()=>{await s.click(e.getByRole("button",{name:"AIに次の行動を提案してもらう"})),await t(e.getByLabelText("自由に行動や会話を入力")).toHaveValue("銀の鍵を扉にかざし、刻まれた星座との対応を確かめる"),await t(e.getByTestId("dialogue-notice")).toHaveTextContent("内容を編集してから送信できます")})}},x={name:"US-P06: 自分の入力がどう解釈されたか知りたい",play:async({canvasElement:a,step:n})=>{const e=o(a);await r(e,"酒場の奥にいる人物に話しかける"),await n("解釈トグルはPlayer Inputの直下にあり、押すと内部解釈を表示する",async()=>{await s.click(e.getByRole("button",{name:"Turn 13の入力解釈を見る"})),await t(e.getByTestId("turn-13-interpretation")).toHaveTextContent("NPCへの会話として解釈"),await t(e.queryByText("入力直下に内部解釈を表示しました。意図とのズレがあれば、削除・やり直しできます。")).not.toBeInTheDocument()}),await n("もう一度押すと解釈を隠せる",async()=>{await s.click(e.getByRole("button",{name:"Turn 13の入力解釈を隠す"})),await t(e.queryByTestId("turn-13-interpretation")).not.toBeInTheDocument()})}},I={name:"US-P07: 未送信の入力を取り消したい",play:async({canvasElement:a,step:n})=>{const e=o(a);await n("未送信の入力は削除ボタンで取り消せる",async()=>{await s.type(e.getByLabelText("自由に行動や会話を入力"),"入力ミス"),await s.click(e.getByRole("button",{name:"入力を消去"})),await t(e.getByLabelText("自由に行動や会話を入力")).toHaveValue(""),await t(e.getByTestId("dialogue-notice")).toHaveTextContent("入力欄の未送信テキストを無効化"),await t(e.queryByRole("button",{name:"直前のターンに戻る"})).not.toBeInTheDocument()})}},C={name:"US-P08/P10: 対話だけで進み、AIは入力を待つ",play:async({canvasElement:a,step:n})=>{const e=o(a);await n("Narrative → Input → Narrativeのループが、明示的な「次へ」なしで続く",async()=>{await r(e,"銀の鍵を掲げて反応を見る"),await r(e,"反応した書架へ近づく"),await t(e.getByTestId("dialogue-log")).toHaveTextContent("プレイヤーの入力: 反応した書架へ近づく")}),await n("AIは重要な進行を勝手に進めず、次のPlayer Inputを待つ",async()=>{await t(e.getByTestId("dialogue-notice")).toHaveTextContent("次の重要な進行は入力待ち")})}},b={name:"US-P09: 見出しリンク（TOC）から対話ログを振り返りたい",play:async({canvasElement:a,step:n})=>{const e=o(a);await n("多数のTurnに対して、TOCはTurn一覧ではなくAIが考えた場面見出しを表示する",async()=>{await t(e.getByRole("complementary",{name:"AI見出しリンクTOC"})).toHaveTextContent("目覚めと銀の鍵"),await t(e.getByRole("complementary",{name:"AI見出しリンクTOC"})).toHaveTextContent("濡れた書架の声"),await t(e.getByRole("complementary",{name:"AI見出しリンクTOC"})).toHaveTextContent("螺旋階段と星図灯"),await t(e.getByRole("complementary",{name:"AI見出しリンクTOC"})).toHaveTextContent("閉じた星座の扉"),await t(e.getByRole("article",{name:"Turn 12"})).toBeVisible()}),await n("TOCの末尾は常に最後のTurn（Turn 12）を指す見出しになっている",async()=>{await t(e.getByTestId("heading-link-12")).toHaveTextContent("Turn 12から")}),await n("AI見出しを選ぶと、その見出しが始まる切り替わりTurnへジャンプする",async()=>{await s.click(e.getByRole("button",{name:"見出し「螺旋階段と星図灯」へ（Turn 08から）"})),await t(e.getByTestId("dialogue-notice")).toHaveTextContent("場面の切り替わりTurn 08へジャンプ"),await t(e.getByTestId("active-turn-summary")).toHaveTextContent("08 / 螺旋階段へ向かう"),await t(e.getByTestId("active-heading-summary")).toHaveTextContent("螺旋階段と星図灯（Turn 08から）"),await t(e.getByTestId("session-state")).toHaveTextContent("Active")}),await n("末尾の見出しを選ぶと、最後のTurnへジャンプして選択表示される",async()=>{await s.click(e.getByTestId("heading-link-12")),await t(e.getByTestId("active-turn-summary")).toHaveTextContent("12 / 入力待ちの静止点"),await t(e.getByRole("article",{name:"Turn 12"})).toHaveClass("session-turn selected")})}},S={name:"US-P10/Notes: セッション中いつでもノートを参照・編集したい",play:async({canvasElement:a,step:n})=>{const e=o(a);await n("プレイ画面のサイドでノートを素早く確認・編集できる",async()=>{await t(e.getByRole("button",{name:/^全画面表示$/})).toBeVisible(),await t(e.getByRole("slider",{name:"ノート表示比率"})).toBeVisible(),await t(e.getByTestId("session-notes-side")).toHaveTextContent("月読ミナト"),await s.click(o(e.getByTestId("session-notes-side")).getByRole("button",{name:"月読ミナトを編集"})),await t(e.getByRole("dialog",{name:"ノート編集"})).toBeVisible(),await t(e.getByTestId("note-edit-dialog")).toHaveAttribute("data-size","editor"),await t(e.getByTestId("app-db-summary")).toHaveTextContent("open person-minato"),await s.clear(e.getByLabelText("別名")),await s.type(e.getByLabelText("別名"),"水際の案内人"),await s.click(e.getAllByRole("button",{name:"閉じる"})[0]),await t(e.queryByRole("dialog",{name:"ノート編集"})).not.toBeInTheDocument()}),await n("全画面で集中編集に切り替えても、一覧・編集・Context・整合性を1画面で操作できる",async()=>{await s.click(e.getByRole("button",{name:/^全画面表示$/})),await t(e.getByTestId("session-notes-focus")).toBeVisible(),await t(e.getByTestId("session-notes-full")).toHaveTextContent("月読ミナト"),await t(e.getByTestId("app-db-summary")).toHaveTextContent("notes full"),await s.click(o(e.getByTestId("session-notes-full")).getByRole("button",{name:"場所追加"})),await t(e.getByRole("dialog",{name:"ノート編集"})).toHaveTextContent("地下天文台"),await s.click(e.getByRole("button",{name:"閉じる"})),await s.click(o(e.getByTestId("session-notes-full")).getByRole("button",{name:"Context再構築"})),await t(o(e.getByTestId("session-notes-full")).getByTestId("context-stack")).toHaveTextContent("次ターンContext")})}},P={name:"US-P11: 「ここまで戻る」で任意の過去ターンまで巻き戻したい",play:async({canvasElement:a,step:n})=>{const e=o(a);await r(e,"書架の奥にいる人物に話しかける"),await r(e,"銀の鍵を水面に沈めてみる"),await n("過去Turnの「ここまで戻る」を押すと確認ダイアログを表示する",async()=>{const i=o(e.getByRole("article",{name:"Turn 01"}));await s.click(i.getByRole("button",{name:"ここまで戻る"})),await t(e.getByRole("dialog",{name:"巻き戻し確認"})).toBeVisible(),await t(e.getByTestId("rewind-dialog")).toHaveTextContent("非同期処理を無効化"),await t(e.getByTestId("rewind-dialog")).toHaveAttribute("data-tone","warning")}),await n("確定すると指定ターン以降を無効化し、巻き戻し地点から再入力できる",async()=>{await s.click(e.getByRole("button",{name:"巻き戻しを確定"})),await t(e.getByTestId("dialogue-log")).not.toHaveTextContent("銀の鍵を水面に沈めてみる"),await t(e.getByTestId("dialogue-notice")).toHaveTextContent("AIコンテキストを再構築"),await t(e.getByLabelText("自由に行動や会話を入力")).toBeVisible()})}};var R,A,k;y.parameters={...y.parameters,docs:{...(R=y.parameters)==null?void 0:R.docs,source:{originalSource:`{
...
}`,...(k=(A=y.parameters)==null?void 0:A.docs)==null?void 0:k.source}}};var h,U,D;v.parameters={...v.parameters,docs:{...(h=v.parameters)==null?void 0:h.docs,source:{originalSource:`{
...
}`,...(D=(U=v.parameters)==null?void 0:U.docs)==null?void 0:D.source}}};var N,L,f;u.parameters={...u.parameters,docs:{...(N=u.parameters)==null?void 0:N.docs,source:{originalSource:`{
  ...
  play: async ({
    ...
    await step('行動判定だけ最安profileへ変更し、ナラティブ生成の選択は独立して保持する', async () => {
      ...
      await userEvent.click(within(document.body).getByRole('option', {
        name: '最安（Qwen3.6 27B GPTQ）'
      }));
      await expect(canvas.getByLabelText('行動判定AI')).toHaveTextContent('最安（Qwen3.6 27B GPTQ）');
      await expect(canvas.getByLabelText('ナラティブ生成AI')).toHaveTextContent('推奨（Deckard 40B FP8）');
    });
  }
}`,...(f=(L=u.parameters)==null?void 0:L.docs)==null?void 0:f.source}}};var V,O,q;p.parameters={...p.parameters,docs:{...(V=p.parameters)==null?void 0:V.docs,source:{originalSource:`{
...
}`,...(q=(O=p.parameters)==null?void 0:O.docs)==null?void 0:q.source}}};var F,M,j;m.parameters={...m.parameters,docs:{...(F=m.parameters)==null?void 0:F.docs,source:{originalSource:`{
...
}`,...(j=(M=m.parameters)==null?void 0:M.docs)==null?void 0:j.source}}};var Q,G,W;d.parameters={...d.parameters,docs:{...(Q=d.parameters)==null?void 0:Q.docs,source:{originalSource:`{
...
}`,...(W=(G=d.parameters)==null?void 0:G.docs)==null?void 0:W.source}}};var $,z,K;w.parameters={...w.parameters,docs:{...($=w.parameters)==null?void 0:$.docs,source:{originalSource:`{
...
}`,...(K=(z=w.parameters)==null?void 0:z.docs)==null?void 0:K.source}}};var _,J,X;T.parameters={...T.parameters,docs:{...(_=T.parameters)==null?void 0:_.docs,source:{originalSource:`{
...
}`,...(X=(J=T.parameters)==null?void 0:J.docs)==null?void 0:X.source}}};var Y,Z,ee;g.parameters={...g.parameters,docs:{...(Y=g.parameters)==null?void 0:Y.docs,source:{originalSource:`{
...
}`,...(ee=(Z=g.parameters)==null?void 0:Z.docs)==null?void 0:ee.source}}};var te,ae,ne;B.parameters={...B.parameters,docs:{...(te=B.parameters)==null?void 0:te.docs,source:{originalSource:`{
...
}`,...(ne=(ae=B.parameters)==null?void 0:ae.docs)==null?void 0:ne.source}}};var se,oe,ie;x.parameters={...x.parameters,docs:{...(se=x.parameters)==null?void 0:se.docs,source:{originalSource:`{
...
}`,...(ie=(oe=x.parameters)==null?void 0:oe.docs)==null?void 0:ie.source}}};var ce,re,le;I.parameters={...I.parameters,docs:{...(ce=I.parameters)==null?void 0:ce.docs,source:{originalSource:`{
...
}`,...(le=(re=I.parameters)==null?void 0:re.docs)==null?void 0:le.source}}};var ye,ve,ue;C.parameters={...C.parameters,docs:{...(ye=C.parameters)==null?void 0:ye.docs,source:{originalSource:`{
...
}`,...(ue=(ve=C.parameters)==null?void 0:ve.docs)==null?void 0:ue.source}}};var pe,me,de;b.parameters={...b.parameters,docs:{...(pe=b.parameters)==null?void 0:pe.docs,source:{originalSource:`{
...
}`,...(de=(me=b.parameters)==null?void 0:me.docs)==null?void 0:de.source}}};var we,Te,ge;S.parameters={...S.parameters,docs:{...(we=S.parameters)==null?void 0:we.docs,source:{originalSource:`{
...
}`,...(ge=(Te=S.parameters)==null?void 0:Te.docs)==null?void 0:ge.source}}};var Be,xe,Ie;P.parameters={...P.parameters,docs:{...(Be=P.parameters)==null?void 0:Be.docs,source:{originalSource:`{
...
}`,...(Ie=(xe=P.parameters)==null?void 0:xe.docs)==null?void 0:Ie.source}}};const ze=["USP01CurrentSituationNarrative","CompletedSessionReadOnly","IndependentAiProfileSelection","USP02AndP03NaturalInputToNarrativeResult","ComposerKeyboardBehavior","NarrativeGenerationLoading","ComposerDoubleClickCreatesOneTurn","USP04TalkWithNpcNaturally","USP05AskClarificationWithoutProgress","USP05BRecommendNextAction","USP06ShowInputInterpretation","USP07DeleteDraftInput","USP08AndP10ContinuousLoopWaitsForInput","USP09ReviewLogFromToc","USP10NotesAlwaysAvailableSideAndFull","USP11RewindToAnyPastTurn"];export{v as CompletedSessionReadOnly,w as ComposerDoubleClickCreatesOneTurn,m as ComposerKeyboardBehavior,u as IndependentAiProfileSelection,d as NarrativeGenerationLoading,y as USP01CurrentSituationNarrative,p as USP02AndP03NaturalInputToNarrativeResult,T as USP04TalkWithNpcNaturally,g as USP05AskClarificationWithoutProgress,B as USP05BRecommendNextAction,x as USP06ShowInputInterpretation,I as USP07DeleteDraftInput,C as USP08AndP10ContinuousLoopWaitsForInput,b as USP09ReviewLogFromToc,S as USP10NotesAlwaysAvailableSideAndFull,P as USP11RewindToAnyPastTurn,ze as __namedExportsOrder,$e as default};
