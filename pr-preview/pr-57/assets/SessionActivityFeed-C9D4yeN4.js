import{j as e}from"./jsx-runtime-BO8uF4Og.js";import{r as q}from"./index-D4H_InIO.js";import{a as p,t as v,I as C,T as M,b as I}from"./Surfaces-xpIMDkG0.js";const P={queued:"処理待ちです。",running:"処理しています……","retry-wait":"一時的な問題のため再試行します。","cancel-requested":"キャンセルしています……",failed:"処理を完了できませんでした。",cancelled:"キャンセルしました。",succeeded:"処理が完了しました。",superseded:"Sessionが先へ進んだため、この結果は適用されませんでした。"},L={"scenario-turn":"Scenario Turn","note-proposal":"ノートの変更案",image:"場面の画像"},_={"loading-world":"世界と現在地を読み込んでいます。","enumerating-actions":"利用可能なObjectアクションを列挙しています。","selecting-action":"入力に合うObjectアクションを選んでいます。","applying-rules":"選択したアクションのルールを適用しています。","running-extension":"確定済みの拡張アクションを実行しています。","generating-narrative":"確定済みの状態からNarrativeを生成しています。",completed:"Scenario Turnが完了しました。",failed:"Scenario Turnを完了できませんでした。",cancelled:"Scenario Turnをキャンセルしました。"},k={queued:"neutral",running:"info","retry-wait":"warning","cancel-requested":"warning",failed:"danger",cancelled:"neutral",succeeded:"success",superseded:"neutral"},V={queued:v[k.queued],running:v[k.running],"retry-wait":v[k["retry-wait"]],"cancel-requested":v[k["cancel-requested"]],failed:v[k.failed],cancelled:`${v[k.cancelled]} opacity-72`,succeeded:v[k.succeeded],superseded:`${v[k.superseded]} opacity-72`},j="mx-auto mb-3 w-[min(100%,720px)] rounded-myr-card border border-myr-ink/14 bg-myr-session-artifact px-4 py-4";function A({text:n}){return e.jsx("article",{className:"session-input-item mt-0.5 mr-2 mb-2 ml-13 w-fit max-w-[min(82%,620px)] justify-self-end rounded-[18px_18px_5px_18px] border border-[#c9bce4] bg-myr-session-input px-4 py-3 text-[#2c2440] shadow-[0_7px_20px_rgba(58,43,83,.14)]","data-testid":"session-input-item","aria-label":"Player Input",children:e.jsx("p",{className:"m-0 font-bold leading-[1.55]",children:n})})}function h(){return e.jsx("article",{className:"grid gap-2 rounded-myr-card border border-myr-ink/14 bg-myr-session-turn p-4","data-testid":"program-turn-item","aria-label":"Module進行",children:e.jsxs("p",{className:"m-0 max-w-none leading-[1.65] text-[#303644]",children:[e.jsx("span",{className:"mr-2 inline-block rounded-full bg-myr-gold px-2 py-px align-middle text-myr-micro font-black tracking-[.1em] text-[#17151f]","aria-hidden":"true",children:"PROGRAM"}),"判定結果を処理し、Sessionの進行へ反映しました。"]})})}function T({turn:n}){var a,l;const r=(a=n.narrative)==null?void 0:a.interpretation;return e.jsxs("article",{className:"grid gap-2 rounded-myr-card border border-myr-ink/14 bg-myr-session-turn p-4","data-testid":"narrative-turn-item","aria-label":"公開済みNarrative Turn",children:[e.jsxs("p",{className:"m-0 max-w-none leading-[1.65] text-[#303644]",children:[e.jsx("span",{className:"mr-2 inline-block rounded-full bg-myr-gold px-2 py-px align-middle text-myr-micro font-black tracking-[.1em] text-[#17151f]","aria-hidden":"true",children:"AI"}),((l=n.narrative)==null?void 0:l.body)??"Narrativeを表示できません。"]}),r&&e.jsxs("details",{className:"rounded-lg border border-myr-ink/10 bg-white/35 px-3 py-2 text-myr-caption text-[#555b68]",children:[e.jsx("summary",{className:"cursor-pointer font-bold focus-visible:rounded focus-visible:outline-2 focus-visible:outline-offset-3 focus-visible:outline-myr-iris",children:"入力の解釈"}),e.jsx("p",{className:"mt-2 mb-0 leading-relaxed",children:r})]})]})}const O=["queued","running","retry-wait","cancel-requested"],D=n=>{const r=Number.isFinite(n)?Math.max(0,Math.floor(n/1e3)):0,a=Math.floor(r/60),l=r%60;return a>=60?`${Math.floor(a/60)}時間${a%60}分`:a>0?`${a}分${l}秒`:`${l}秒`};function $({projection:n}){const r=n.selectedAction,a=n.postState,l=n.currentLocation,s=(a==null?void 0:a.currentLocation)??l,y=l&&a&&l.id!==a.currentLocation.id,g=r?n.objects.find(i=>i.id===r.objectId):null,c=r&&a?a.objects.find(i=>i.id===r.objectId):null,m=(c==null?void 0:c.state)??(g==null?void 0:g.state),d=a==null?void 0:a.appliedEffects.find(i=>i.type==="set-state"&&i.targetId===(r==null?void 0:r.objectId)&&i.path==="state.open"),t=!!d||(a==null?void 0:a.appliedEffects.some(i=>i.type==="set-state"&&i.targetId===(r==null?void 0:r.objectId)));return e.jsxs("div",{className:"mt-2 ml-auto grid w-[min(100%,620px)] gap-1.5 rounded-xl border border-myr-ink/10 bg-myr-paper/55 px-3 py-2 text-left text-myr-caption text-myr-ink-soft","data-testid":"scenario-turn-public-projection",children:[s&&e.jsxs("p",{className:"m-0",children:[e.jsx("strong",{children:"現在地:"})," ",s.name]}),y&&e.jsxs("p",{className:"m-0","data-testid":"scenario-turn-location-transition",children:[e.jsx("strong",{children:"移動:"})," ",l.name," → ",a.currentLocation.name]}),e.jsxs("p",{className:"m-0",children:[e.jsx("strong",{children:"利用可能な行動:"})," ",n.availableActions.filter(i=>i.enabled).map(i=>i.label).join("、")||"なし"]}),r&&e.jsxs("p",{className:"m-0",children:[e.jsx("strong",{children:"解釈:"})," ",r.objectLabel?`${r.objectLabel} / `:"",r.actionLabel??r.actionCode??r.actionId]}),r&&(m||t)&&e.jsxs("p",{className:"m-0","data-testid":"scenario-turn-selected-state",children:[e.jsx("strong",{children:"対象の状態:"})," ",r.objectLabel??r.objectCode??r.objectId," / ",d?`open=${String(d.value)}`:m&&Object.hasOwn(m,"open")?`open=${String(m.open)}`:t?"state updated":JSON.stringify(m)]}),a&&e.jsxs("p",{className:"m-0",children:[e.jsx("strong",{children:"確定済み状態:"})," Revision ",a.revision,a.facts.length?` / ${a.facts.join("、")}`:""]})]})}function z({execution:n,elapsed:r}){var s;const a=n.stage??((s=n.scenarioTurn)==null?void 0:s.stage),l=n.kind==="scenario-turn"&&a?_[a]:P[n.status]??n.status;return e.jsxs("span",{className:"execution-status-copy inline-flex items-baseline justify-end gap-2",children:[L[n.kind]??n.kind,": ",l,e.jsx("span",{className:"whitespace-nowrap text-[color-mix(in_srgb,currentColor_68%,transparent)] tabular-nums","aria-hidden":"true",children:r})]},`${n.status}-${a??""}-${n.revision}`)}function S({execution:n,onAction:r,keepSucceededStatusVisible:a=!1}){var x;const l=O.includes(n.status),s=n.status==="failed",y=n.status==="succeeded",[g,c]=q.useState(()=>Date.now()),[m,d]=q.useState(!1);if(q.useEffect(()=>{if(!l)return;c(Date.now());const u=window.setInterval(()=>c(Date.now()),1e3);return()=>window.clearInterval(u)},[l]),q.useEffect(()=>{if(d(!1),!y||a)return;const u=window.setTimeout(()=>d(!0),720);return()=>window.clearTimeout(u)},[y,n.revision,a]),m)return null;const t=Date.parse(n.startedAt??n.createdAt),i=n.completedAt?Date.parse(n.completedAt):g,o=D(i-t),w=e.jsx(z,{execution:n,elapsed:o}),f=s&&n.triggerType==="player-input"&&n.capabilities.canDismiss,E=(n.capabilities.canRetry||n.capabilities.canCancel||f)&&e.jsxs("div",{className:`execution-actions flex min-h-6.5 justify-end gap-2 ${s?"mt-1.25":"mt-1"}`,children:[n.capabilities.canRetry&&e.jsx(p,{variant:"ghost",size:"sm",onClick:()=>r==null?void 0:r(n.id,"retry"),children:"再試行"}),n.capabilities.canCancel&&e.jsx(p,{variant:"ghost",size:"sm",onClick:()=>r==null?void 0:r(n.id,"cancel"),children:"キャンセル"}),f&&e.jsx(p,{variant:"ghost",size:"sm",onClick:()=>r==null?void 0:r(n.id,"dismiss"),children:"入力取り消し"})]});return e.jsxs("article",{className:`session-execution-item status-${n.status} -mt-0.75 mr-2 mb-2 ml-auto w-[min(100%,680px)] justify-self-end border-0 bg-transparent p-0 text-right text-myr-caption leading-[1.45] ${V[n.status]} ${y&&!a?"execution-is-completing":""}`,"data-testid":`execution-${n.id}`,role:s?"alert":"status","aria-live":l?"polite":void 0,children:[n.developmentDiagnostics?e.jsxs("details",{className:"m-0",children:[e.jsx("summary",{className:"execution-diagnostics-summary min-h-5 cursor-pointer list-inside text-inherit select-none focus-visible:rounded focus-visible:outline-2 focus-visible:outline-offset-3 focus-visible:outline-myr-iris",children:w}),e.jsxs("div",{className:"mt-1.75 ml-auto w-[min(100%,620px)] rounded-xl bg-myr-session-diagnostics px-4 py-3 text-left text-[#aaa2b3]",children:[e.jsx("span",{className:"mb-2 block font-extrabold",children:"開発者向け詳細"}),e.jsxs("dl",{className:"grid grid-cols-[max-content_1fr] gap-x-3 gap-y-1 [&_dd]:m-0 [&_dd]:wrap-anywhere",children:[e.jsx("dt",{children:"Execution ID"}),e.jsx("dd",{children:e.jsx("code",{children:n.id})}),e.jsx("dt",{children:"Session ID"}),e.jsx("dd",{children:e.jsx("code",{children:n.developmentDiagnostics.sessionId})}),e.jsx("dt",{children:"Revision"}),e.jsx("dd",{children:n.developmentDiagnostics.revision}),e.jsx("dt",{children:"Lease"}),e.jsxs("dd",{children:[n.developmentDiagnostics.leaseOwner??"—"," ",n.developmentDiagnostics.leaseTokenHint??""]})]}),n.developmentDiagnostics.attempts.map(u=>e.jsxs("section",{className:"mt-3.5",children:[e.jsxs("strong",{children:["Attempt ",u.attemptNumber]}),e.jsxs("dl",{className:"my-1.75 mb-2.5 grid grid-cols-[max-content_1fr] gap-x-3 gap-y-1 [&_dd]:m-0 [&_dd]:wrap-anywhere",children:[e.jsx("dt",{children:"Status"}),e.jsx("dd",{children:u.status}),e.jsx("dt",{children:"Provider"}),e.jsxs("dd",{children:[u.provider??"—"," / ",u.model??"—"]}),e.jsx("dt",{children:"Latency"}),e.jsx("dd",{children:u.latencyMilliseconds==null?"—":`${u.latencyMilliseconds}ms`})]}),u.sentPrompt&&e.jsx(b,{label:"送信したプロンプト",value:u.sentPrompt}),u.receivedResult&&e.jsx(b,{label:"受信した結果",value:u.receivedResult}),u.validationResult&&e.jsx(b,{label:"バリデーション結果",value:u.validationResult}),(u.exceptionChain||u.redactedResponseExcerpt)&&e.jsx(b,{label:"例外情報",value:JSON.stringify({exceptionChain:u.exceptionChain,redactedResponseExcerpt:u.redactedResponseExcerpt},null,2)})]},u.id))]})]}):e.jsx("div",{className:"min-h-5 text-inherit",children:w}),n.kind==="scenario-turn"&&n.scenarioTurn&&e.jsx($,{projection:n.scenarioTurn}),s&&n.kind==="scenario-turn"&&((x=n.scenarioTurn)==null?void 0:x.postState)&&e.jsx("p",{className:"mt-2 mb-0 ml-auto w-[min(100%,620px)] rounded-xl border border-myr-gold/35 bg-myr-paper/70 px-3 py-2 text-left font-bold text-myr-ruby","data-testid":"scenario-turn-committed-failure",children:"Narrativeの生成または公開に失敗しましたが、Objectの状態、配置、適用結果は確定済みです。再試行してもルールは再適用されません。"}),E]})}function b({label:n,value:r}){return e.jsxs("details",{className:"mt-1.5 border-t border-[#aaa2b3]/18 pt-2",children:[e.jsx("summary",{className:"cursor-pointer font-[750]",children:n}),e.jsx("pre",{className:"mt-1.75 max-h-65 overflow-auto wrap-anywhere whitespace-pre-wrap rounded-lg bg-myr-session-payload p-2 text-left text-myr-caption text-[#c8c1d0]",children:r})]})}function R({proposal:n,onReview:r}){const[a,l]=q.useState(!1),[s,y]=q.useState(n.proposedTitle),[g,c]=q.useState(n.proposedBody),m={expectedNoteRevision:n.expectedNoteRevision};return e.jsxs("article",{className:j,"data-testid":"note-proposal-item",children:[e.jsxs("strong",{children:["ノート変更案: ",n.proposedTitle]}),e.jsxs("div",{className:"my-2.5 grid gap-2 [&_del]:block [&_del]:rounded-myr-control [&_del]:bg-myr-session-note-removed [&_del]:p-3 [&_del]:no-underline [&_ins]:block [&_ins]:rounded-myr-control [&_ins]:bg-myr-session-note-added [&_ins]:p-3 [&_ins]:no-underline",children:[e.jsx("del",{children:n.beforeBody||"（新規ノート）"}),e.jsx("ins",{children:n.proposedBody})]}),e.jsxs("p",{children:["根拠: ",n.rationale]}),a&&e.jsxs("fieldset",{"aria-label":"ノート変更案を編集",children:[e.jsxs("label",{children:["タイトル",e.jsx(C,{value:s,onChange:d=>y(d.target.value)})]}),e.jsxs("label",{children:["本文",e.jsx(M,{value:g,onChange:d=>c(d.target.value)})]}),e.jsxs("div",{className:I,children:[e.jsx(p,{variant:"primary",size:"sm",onClick:()=>r==null?void 0:r(n.artifactId,"edit-apply",{...m,title:s,body:g}),children:"編集内容を適用"}),e.jsx(p,{variant:"ghost",size:"sm",onClick:()=>l(!1),children:"編集をやめる"})]})]}),n.status==="pending"&&!a&&e.jsxs("div",{className:I,children:[e.jsx(p,{variant:"primary",size:"sm",onClick:()=>r==null?void 0:r(n.artifactId,"apply",m),children:"適用"}),e.jsx(p,{variant:"secondary",size:"sm",onClick:()=>l(!0),children:"編集して適用"}),e.jsx(p,{variant:"danger",size:"sm",onClick:()=>r==null?void 0:r(n.artifactId,"reject",m),children:"却下"}),e.jsx(p,{variant:"ghost",size:"sm",onClick:()=>r==null?void 0:r(n.artifactId,"snooze",m),children:"あとで"})]})]})}function N({mediaUrl:n,contentType:r}){return e.jsxs("figure",{className:j,"data-testid":"image-artifact-item",children:[n?e.jsx("img",{className:"block max-h-105 w-full rounded-xl object-cover",src:n,alt:"生成された場面",loading:"lazy"}):e.jsx("div",{className:"grid min-h-myr-module-preview-min place-items-center rounded-xl bg-myr-session-preview font-extrabold",role:"img","aria-label":"画像Artifactのプレビュー",children:"画像プレビュー"}),e.jsxs("figcaption",{children:[r," / Narrativeとは独立した任意成果物"]})]})}function B({session:n,onExecutionAction:r,onNoteReview:a,keepSucceededStatusVisible:l=!1}){const s=new Map((n.inputs??[]).map(t=>[t.id,t])),y=new Map((n.executions??[]).map(t=>[t.id,t])),g=new Map(n.turns.map(t=>[t.id,t])),c=new Map((n.artifacts??[]).map(t=>[t.id,t])),m=new Map((n.noteProposals??[]).map(t=>[t.artifactId,t])),d=n.activity??[];return e.jsx("section",{className:"grid max-h-[48vh] gap-3 overflow-auto pr-2",role:"log","aria-label":"Session activity","data-testid":"session-activity-feed",children:d.map(t=>{if(t.type==="input"){const o=s.get(t.id);return o?e.jsx(A,{text:o.text},`input-${t.id}`):null}if(t.type==="execution"){const o=y.get(t.id);return o?e.jsx(S,{execution:o,onAction:r,keepSucceededStatusVisible:l},`execution-${t.id}`):null}if(t.type==="turn"){const o=g.get(t.id);return o?o.kind==="module"&&!o.narrative?e.jsx(h,{},`turn-${t.id}`):e.jsx(T,{turn:o},`turn-${t.id}`):null}const i=c.get(t.id);if(!i)return null;if(i.kind==="image")return e.jsx(N,{mediaUrl:i.mediaUrl,contentType:i.contentType},`artifact-${t.id}`);if(i.kind==="note-patch"){const o=m.get(t.id);return o?e.jsx(R,{proposal:o,onReview:a},`artifact-${t.id}`):null}return null})})}A.__docgenInfo={description:"",methods:[],displayName:"SessionInputItem",props:{text:{required:!0,tsType:{name:"string"},description:""}}};h.__docgenInfo={description:"",methods:[],displayName:"ProgramTurnItem"};T.__docgenInfo={description:"",methods:[],displayName:"NarrativeTurnItem",props:{turn:{required:!0,tsType:{name:"signature",type:"object",raw:`{
  id: string;
  position: number;
