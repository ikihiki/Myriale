import{j as S}from"./jsx-runtime-BO8uF4Og.js";import{w as s,e as a,u as o,a as x}from"./index-C4S39nCK.js";import{t as $,a as J,M as u}from"./MyrialeApp-C-yXlh3u.js";import{b as K,c as z}from"./SessionPresentation-DsmXs_f7.js";import{u as Q,n as X,S as Z}from"./AppChrome-BVr8BnXp.js";import{M as G}from"./MockStartSessionContainer-CepdrDeD.js";/* empty css               */import"./index-D4H_InIO.js";import"./Surfaces-xpIMDkG0.js";import"./scenarioWizardStyles-DbrtSybi.js";import"./navigationRecipes-DkSbwkz5.js";import"./MyrialeToggle-BJ2tbK4f.js";import"./index-DzKAYa42.js";import"./ModuleUiHost-QlDy0LN2.js";import"./account-BQw43enD.js";import"./SessionListPresentation-C_oql32z.js";import"./SessionIcons-yGOCmQwo.js";import"./SessionTurn-9KUaF1pl.js";import"./SessionActivityFeed-CMz3MXAB.js";import"./MyrialeMenu-CtcPHE9S.js";const ee={name:"霧野しおり",email:"reader@myriale.example",initials:"霧野",role:"プレイヤー"};function b(){const t=Q(),{db:n}=K(),e=Object.values(n.scenarios).map($),i=(c,Y)=>{if(t){c==="startSession"?t(c,{query:{scenarioId:Y??""}}):t(c);return}X(Z[c])};return S.jsx(J,{account:ee,scenarios:e,status:"ready",onRetry:()=>{},onRegistration:()=>i("scenarioRegister"),onStart:c=>i("startSession",c),onLogout:()=>{}})}b.__docgenInfo={description:"",methods:[],displayName:"MockScenarioListContainer"};const de={title:"ユーザーストーリー/Start session",component:u,render:()=>S.jsx(u,{initialUrl:"/scenarios",initialDb:z("activeSession"),scenarioListContainer:b,startSessionContainer:G}),parameters:{notes:"docs/user-stories/start-session.md の各ユーザーストーリーを、Storybook Interactions の step と expect で操作説明できるアプリ画面にしたものです。"}},r=async(t,n="星喰いの地下図書館")=>{await o.click(t.getByRole("button",{name:`${n}で開始`})),await t.findByTestId("selected-scenario-title")},l={name:"US-S01: シナリオから新しいセッションを開始したい",play:async({canvasElement:t,step:n})=>{const e=s(t);await n("シナリオ一覧から対象Scenarioを確認し、登録導線も見える",async()=>{await a(e.getByRole("region",{name:"シナリオ一覧"})).toBeVisible(),await a(e.getByTestId("scenario-list")).toHaveTextContent("星喰いの地下図書館"),await a(e.getByRole("button",{name:"新しいシナリオを登録"})).toBeVisible(),await a(e.queryByRole("complementary",{name:"シナリオ登録導線"})).not.toBeInTheDocument()}),await n("Scenarioを選択すると、余分な状態表示を挟まずイントロと主人公選択を表示する",async()=>{await r(e),await a(e.getByTestId("selected-scenario-title")).toHaveTextContent("星喰いの地下図書館"),await a(e.getByRole("region",{name:"イントロNarrative"})).toBeVisible(),await a(e.getByRole("region",{name:"主人公確定"})).toBeVisible(),await a(e.queryByTestId("session-notice")).not.toBeInTheDocument(),await a(e.queryByRole("complementary",{name:"セッション状態サマリー"})).not.toBeInTheDocument()})}},y={name:"US-S02: セッション開始時にシナリオのイントロを見たい",play:async({canvasElement:t,step:n})=>{const e=s(t);s(t.ownerDocument.body),await r(e),await n("Preparing状態で、主人公未確定のイントロNarrativeを読む",async()=>{await a(e.getByRole("region",{name:"イントロNarrative"})).toBeVisible(),await a(e.getByTestId("intro-narrative")).toHaveTextContent("あなたは水没した閲覧室で目を覚ます。"),await a(e.getByTestId("intro-narrative")).not.toHaveTextContent("名もなき旅人")}),await n("同じページで主人公選択ができる",async()=>{await a(e.getByRole("region",{name:"主人公確定"})).toBeVisible()})}},m={name:"US-S03: イントロ後に主人公を確定したい",play:async({canvasElement:t,step:n})=>{const e=s(t),i=s(t.ownerDocument.body);await r(e),await n("イントロと同じページで候補を選び、Session固有データとして確定する",async()=>{await o.click(e.getByRole("combobox",{name:"候補キャラクター"})),await a(i.queryByRole("option",{name:"自由生成"})).not.toBeInTheDocument(),await o.click(await i.findByRole("option",{name:"エル / 記憶を失った写字生"})),await a(e.getByLabelText("主人公の名前")).toHaveValue("エル"),await a(e.getByLabelText("主人公の名前")).toHaveAttribute("readonly"),await a(e.getByLabelText("主人公プロフィール")).toHaveValue("記憶を失った写字生"),await a(e.getByLabelText("主人公プロフィール")).toHaveAttribute("readonly"),await o.click(e.getByRole("button",{name:"開始内容を確認"})),await x(()=>a(e.getByRole("dialog",{name:"開始前の最終確認"})).toBeVisible()),await a(e.getByTestId("start-summary")).toHaveTextContent("エル / 記憶を失った写字生")})}},w={name:"US-S03C/D: 主人公を作成し、AI案は確認してから確定する",play:async({canvasElement:t,step:n})=>{const e=s(t);await r(e,"灰の駅と宛名のない切符"),await n("自由生成が許可されたシナリオでは、名前とプロフィールを最初から編集できる",async()=>{await a(e.queryByRole("combobox",{name:"主人公の扱い"})).not.toBeInTheDocument(),await o.clear(e.getByLabelText("主人公の名前")),await o.type(e.getByLabelText("主人公の名前"),"ユイ"),await a(e.getByLabelText("主人公の名前")).toHaveValue("ユイ")}),await n("AI生成ボタンはフォームを補助するだけで、自動確定しない",async()=>{await o.click(e.getByRole("button",{name:"AIに主人公を生成してもらう"})),await a(e.getByLabelText("主人公の名前")).toHaveValue("ノクト"),await a(e.getByRole("status")).toHaveTextContent("確認・修正してから確定"),await a(e.getByRole("button",{name:"開始内容を確認"})).toBeVisible()})}},p={name:"US-S03B: 選択式で許可された場合だけ自由生成へ切り替える",render:()=>S.jsx(u,{initialUrl:"/scenarios",initialDb:z("activeSession"),scenarioListContainer:b,startSessionContainer:G}),play:async({canvasElement:t,step:n})=>{const e=s(t);await r(e,"月虹の庭と眠らない時計"),await n("候補キャラクターの選択肢から、許可された自由生成へ切り替えられる",async()=>{const i=s(t.ownerDocument.body),c=e.getByRole("combobox",{name:"候補キャラクター"});await o.click(c),await o.click(await i.findByRole("option",{name:"自由生成"})),await a(c).toHaveTextContent("自由生成"),await x(()=>a(e.getByLabelText("主人公の名前")).toBeVisible()),await o.click(c),await o.click(await i.findByRole("option",{name:"カイ / 時計塔を修理する旅の技師"})),await a(e.getByLabelText("主人公の名前")).toHaveValue("カイ"),await a(e.getByLabelText("主人公の名前")).toHaveAttribute("readonly")})}},v={name:"US-S03A: 固定主人公は読み取り専用で表示する",play:async({canvasElement:t,step:n})=>{const e=s(t);await r(e,"硝子の森と夜明けの司書"),await n("固定主人公だけを表示し、選択や自由生成を許可しない",async()=>{await a(e.getByTestId("fixed-hero")).toBeVisible(),await a(e.getByLabelText("主人公の名前")).toHaveValue("リュシエン"),await a(e.getByLabelText("主人公の名前")).toHaveAttribute("readonly"),await a(e.getByLabelText("主人公プロフィール")).toHaveValue("夜明け前の森を巡る司書"),await a(e.getByLabelText("主人公プロフィール")).toHaveAttribute("readonly"),await a(e.queryByRole("combobox",{name:"候補キャラクター"})).not.toBeInTheDocument()})}},B={name:"US-S04: セッション開始前に内容を最終確認したい",play:async({canvasElement:t,step:n})=>{const e=s(t);await r(e),await n("権限があるPlayerだけがデバッグ用の解釈説明を選択できる",async()=>{const i=e.getByRole("checkbox",{name:/解釈説明を有効にする/});await a(i).not.toBeChecked(),await o.click(i),await a(i).toBeChecked()}),await o.click(e.getByRole("button",{name:"開始内容を確認"})),await n("ダイアログの開始サマリーでScenario概要、主人公、デバッグ設定を確認する",async()=>{await x(()=>a(e.getByRole("dialog",{name:"開始前の最終確認"})).toBeVisible()),await a(e.getByTestId("start-review-dialog")).toHaveAttribute("data-size","wide"),await a(e.getByTestId("start-summary")).toHaveTextContent("Scenario: 星喰いの地下図書館"),await a(e.getByTestId("start-summary")).toHaveTextContent("解釈説明: 有効（デバッグ）"),await a(e.getByTestId("start-summary")).toHaveTextContent("主人公: ミラ")}),await n("修正を選ぶとダイアログを閉じて主人公選択へ戻れる",async()=>{await o.click(e.getByRole("button",{name:"主人公選択を修正"})),await a(e.queryByRole("dialog",{name:"開始前の最終確認"})).not.toBeInTheDocument(),await a(e.getByRole("region",{name:"主人公確定"})).toBeVisible(),await a(e.getByRole("region",{name:"イントロNarrative"})).toBeVisible()})}},g={name:"US-S05: セッションを正式に開始したい",play:async({canvasElement:t,step:n})=>{const e=s(t);await r(e),await o.click(e.getByRole("button",{name:"開始内容を確認"})),await n("API未設定では架空のSessionへfallbackせず、明示的なエラーを表示する",async()=>{await o.click(e.getByRole("button",{name:"物語を始める"})),await a(e.getByRole("alert")).toHaveTextContent("Session APIが設定されていません"),await a(e.getByTestId("app-url")).not.toHaveTextContent("/sessions/SES-PREP-1098"),await a(e.queryByTestId("session-state")).not.toBeInTheDocument()})}};var d,T,R;l.parameters={...l.parameters,docs:{...(d=l.parameters)==null?void 0:d.docs,source:{originalSource:`{
...
}`,...(R=(T=l.parameters)==null?void 0:T.docs)==null?void 0:R.source}}};var I,H,C;y.parameters={...y.parameters,docs:{...(I=y.parameters)==null?void 0:I.docs,source:{originalSource:`{
...
}`,...(C=(H=y.parameters)==null?void 0:H.docs)==null?void 0:C.source}}};var h,k,V;m.parameters={...m.parameters,docs:{...(h=m.parameters)==null?void 0:h.docs,source:{originalSource:`{
...
}`,...(V=(k=m.parameters)==null?void 0:k.docs)==null?void 0:V.source}}};var E,L,A;w.parameters={...w.parameters,docs:{...(E=w.parameters)==null?void 0:E.docs,source:{originalSource:`{
...
}`,...(A=(L=w.parameters)==null?void 0:L.docs)==null?void 0:A.source}}};var U,D,f;p.parameters={...p.parameters,docs:{...(U=p.parameters)==null?void 0:U.docs,source:{originalSource:`{
...
}`,...(f=(D=p.parameters)==null?void 0:D.docs)==null?void 0:f.source}}};var P,q,N;v.parameters={...v.parameters,docs:{...(P=v.parameters)==null?void 0:P.docs,source:{originalSource:`{
...
}`,...(N=(q=v.parameters)==null?void 0:q.docs)==null?void 0:N.source}}};var F,M,O;B.parameters={...B.parameters,docs:{...(F=B.parameters)==null?void 0:F.docs,source:{originalSource:`{
...
}`,...(O=(M=B.parameters)==null?void 0:M.docs)==null?void 0:O.source}}};var j,_,W;g.parameters={...g.parameters,docs:{...(j=g.parameters)==null?void 0:j.docs,source:{originalSource:`{
