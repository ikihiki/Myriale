import{j as V}from"./jsx-runtime-BO8uF4Og.js";import{w as c,u as s,e as a}from"./index-C4S39nCK.js";import{M as x}from"./MyrialeApp-FmuhDZF_.js";import{c as W}from"./SessionPresentation-DMVNLh5r.js";import{M as X}from"./MockSessionContainer-WeLdTw78.js";/* empty css               */import"./index-D4H_InIO.js";import"./AdminAiProvidersPage-Bx_BHRQ9.js";import"./Surfaces-hfywbPiG.js";import"./AppChrome-BVHByNfO.js";import"./navigationRecipes-DkSbwkz5.js";import"./MyrialeToggle-CSioTFV0.js";import"./index-DzKAYa42.js";import"./MyrialeMenu-CZ4CxpT9.js";import"./ConditionTablePresentation-lAGcOeS6.js";import"./EditPane-CacH2v8L.js";import"./scenarioWizardStyles-CPcslTFI.js";import"./ModuleUiHost-CQPmid6l.js";import"./TurnInspectionPresentation-DFMLRMyi.js";import"./account-TPE_JDnL.js";import"./SessionListPresentation-DuKKik-D.js";import"./SessionIcons-yGOCmQwo.js";import"./SessionTurn-UcBTXClw.js";import"./NarrativeBody-4Kg13oE8.js";import"./SessionActivityFeed-B0l1fOng.js";const Be={title:"ユーザーストーリー/Session notes Lorebook",component:x,render:()=>V.jsx(x,{initialUrl:"/sessions/SES-PREP-1098",initialDb:W("lorebook"),sessionContainer:X}),parameters:{notes:"Lorebook系ユーザーストーリーは独立画面ではなく、セッション中のノートワークスペースとして表示します。編集はダイアログで行います。"}},o=t=>c(t.getByTestId("session-notes-full")),i={name:"US-L01: 人物ノートに詳細情報を登録したい",play:async({canvasElement:t,step:n})=>{const e=c(t);await n("人物ノートを作成し、編集ダイアログで構造化項目を確認する",async()=>{await s.click(o(e).getByRole("button",{name:"人物追加"})),await a(e.getByRole("dialog",{name:"ノート編集"})).toHaveTextContent("灯守アキラ"),a(e.getByLabelText("外見・種別・詳細").value).toContain("星図レンズ")})}},r={name:"US-L02: 場所ノートに詳細情報を登録したい",play:async({canvasElement:t,step:n})=>{const e=c(t);await n("場所ノートを作成し、編集ダイアログで位置関係・雰囲気・禁則を保存する",async()=>{await s.click(o(e).getByRole("button",{name:"場所追加"})),await a(e.getByRole("dialog",{name:"ノート編集"})).toHaveTextContent("地下天文台"),a(e.getByLabelText("現在状態または禁則").value).toContain("封印扉")})}},m={name:"US-L03: Canonと未確定情報を分けて管理したい",play:async({canvasElement:t,step:n})=>{const e=c(t);await n("ノートの確定度をダイアログ内で噂へ変更する",async()=>{await s.click(o(e).getByRole("button",{name:"月読ミナトを編集"})),await s.click(e.getByRole("button",{name:"噂にする"})),await a(e.getByRole("dialog",{name:"ノート編集"})).toHaveTextContent("噂"),await a(e.getByTestId("session-notes-notice")).toHaveTextContent("噂")})}},p={name:"US-L04: AIにLorebookを参照して語ってほしい",play:async({canvasElement:t,step:n})=>{const e=c(t);await n("セッション画面内でCanonノートとContextを同時に確認できる",async()=>{await a(o(e).getByTestId("canon-count")).toHaveTextContent("2件"),await a(o(e).getByTestId("context-stack")).toHaveTextContent("Lorebook Canon")})}},l={name:"US-L05: 矛盾しそうなとき勝手に変更せず確認してほしい",play:async({canvasElement:t,step:n})=>{const e=c(t);await n("矛盾候補を確認し、噂として保持する判断をユーザーが行う",async()=>{await s.click(o(e).getByRole("button",{name:"整合性チェック"})),await a(o(e).getByTestId("consistency-issue")).toHaveTextContent("矛盾候補"),await s.click(o(e).getByRole("button",{name:"噂として保持"})),await a(e.getByTestId("session-notes-notice")).toHaveTextContent("断定させません")})}},y={name:"US-L06: AIに追加候補を提案してほしい",play:async({canvasElement:t,step:n})=>{const e=c(t);await n("新規地点候補を作成し、自動確定せず編集ダイアログで開く",async()=>{await s.click(o(e).getByRole("button",{name:"場所追加"})),await a(e.getByRole("dialog",{name:"ノート編集"})).toHaveTextContent("地下天文台"),await a(e.getByTestId("open-note-state")).toHaveTextContent("location-4")})}},v={name:"US-L07: Lorebookを圧縮コンテキストとして使いたい",play:async({canvasElement:t,step:n})=>{const e=c(t);await n("Lorebook Canon・Session State・ChapterSummary・Recent TurnsでContextを再構築する",async()=>{await s.click(o(e).getByRole("button",{name:"Context再構築"})),await a(o(e).getByTestId("context-stack")).toHaveTextContent("Recent Turns"),await a(e.getByTestId("session-notes-notice")).toHaveTextContent("再構築")})}},u={name:"US-L08: 章単位で要約を生成・更新したい",play:async({canvasElement:t,step:n})=>{const e=c(t);await n("次ターンContextの再構築で要約相当の圧縮Contextを更新する",async()=>{await s.click(o(e).getByRole("button",{name:"Context再構築"})),await a(o(e).getByTestId("context-stack")).toHaveTextContent("Session State")})}},w={name:"US-L09: 参照しているノートをUIで可視化したい",play:async({canvasElement:t,step:n})=>{const e=c(t);await n("ノート一覧から参照したいノートを編集ダイアログで開く",async()=>{await s.click(o(e).getByRole("button",{name:"水没した地下図書館を編集"})),await a(e.getByRole("dialog",{name:"ノート編集"})).toHaveTextContent("水没した地下図書館"),await a(e.getByTestId("app-db-summary")).toHaveTextContent("open location-library")})}},g={name:"US-L10: ノートと要約の整合性チェックをしたい",play:async({canvasElement:t,step:n})=>{const e=c(t);await n("整合性チェックで矛盾候補を提示し、修正確定はユーザーに委ねる",async()=>{await s.click(o(e).getByRole("button",{name:"整合性チェック"})),await a(o(e).getByTestId("consistency-issue")).toHaveTextContent("王都地下"),await a(e.getByTestId("session-notes-notice")).toHaveTextContent("ユーザーが行います")})}};var C,d,T;i.parameters={...i.parameters,docs:{...(C=i.parameters)==null?void 0:C.docs,source:{originalSource:`{
...
}`,...(U=(b=m.parameters)==null?void 0:b.docs)==null?void 0:U.source}}};var k,E,H;p.parameters={...p.parameters,docs:{...(k=p.parameters)==null?void 0:k.docs,source:{originalSource:`{
...
}`,...(H=(E=p.parameters)==null?void 0:E.docs)==null?void 0:H.source}}};var I,h,f;l.parameters={...l.parameters,docs:{...(I=l.parameters)==null?void 0:I.docs,source:{originalSource:`{
...
}`,...(f=(h=l.parameters)==null?void 0:h.docs)==null?void 0:f.source}}};var A,N,M;y.parameters={...y.parameters,docs:{...(A=y.parameters)==null?void 0:A.docs,source:{originalSource:`{
