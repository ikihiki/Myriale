import{j as O}from"./jsx-runtime-BO8uF4Og.js";import{w as l,e as n,u as a}from"./index-C4S39nCK.js";import{E as K,M as b}from"./MyrialeApp-Dj-vvZz7.js";import{c as z}from"./SessionPresentation-DMVNLh5r.js";import{r as J}from"./index-D4H_InIO.js";import{c as Q}from"./scenarioRegistrationFixtures-CK6CETnx.js";/* empty css               */import"./AdminAiProvidersPage-Bx_BHRQ9.js";import"./Surfaces-hfywbPiG.js";import"./AppChrome-BVHByNfO.js";import"./navigationRecipes-DkSbwkz5.js";import"./MyrialeToggle-CSioTFV0.js";import"./index-DzKAYa42.js";import"./MyrialeMenu-CZ4CxpT9.js";import"./ConditionTablePresentation-lAGcOeS6.js";import"./EditPane-CacH2v8L.js";import"./scenarioWizardStyles-CPcslTFI.js";import"./NarrativeBody-4Kg13oE8.js";import"./ModuleUiHost-CQPmid6l.js";import"./TurnInspectionPresentation-DFMLRMyi.js";import"./account-TPE_JDnL.js";import"./SessionListPresentation-DuKKik-D.js";import"./SessionIcons-yGOCmQwo.js";import"./SessionTurn-UcBTXClw.js";import"./SessionActivityFeed-B0l1fOng.js";const X={title:"目覚めの研究室",summary:`# シナリオ
閉鎖された地下研究施設から脱出します。
# 描写
- 緊張感のある静かな雰囲気を維持する`,genre:"SF,ミステリー,脱出劇",tone:"静謐で緊張感のあるSFミステリー",lore:"施設の過去は断片的に明かし、同じ手掛かりや所作を反復しない。各応答では新しい事実か状況変化を一つ進める。",aiFreedom:"低: 厳密に守る",heroMode:"free",heroFreeGenerationAllowed:!1,hero:"記憶を失った人物として自由に作成する。",opening:"あなたは閉鎖された地下研究施設で目を覚ます。",illustrationStyle:"冷たい研究施設のコンセプトアート",illustrationMood:"静かな緊張感",illustrationNegative:"明るい屋外、コミカルな表現",sampleScene:"非常灯だけが点滅する無人の実験室。",ruleData:structuredClone(Q)},Y={name:"霧野しおり",email:"author@myriale.example",initials:"霧野",role:"作者"};function $({scenarioId:s}){const[o,e]=J.useState(!1),t=async r=>(e(!0),await Promise.resolve(),e(!1),{ok:!0,message:`「${r.title}」の変更を保存しました。`,value:{scenarioId:s}}),i=async(r,c)=>({ok:!0,message:c==="summary"?"基本情報案を提示しました。":"挿絵設定の候補を提示しました。",value:{message:c==="summary"?"基本情報案を提示しました。":"挿絵設定の候補を提示しました。",suggestions:[{id:"edit-suggestion",body:`## 改稿案

研究施設の非常灯が、一定の間隔で明滅しています。`,rationale:"現在の設定を維持した案です。"}]}}),G=async(r,c)=>({ok:!0,message:"隔離されたルールエンジンで実行しました。",value:{snapshot:{schemaVersion:"rule-action-snapshot.v1",snapshotId:"EDIT-DEBUG",currentLocation:{id:c.currentLocationCode,code:c.currentLocationCode,name:c.currentLocationCode,description:""},objects:[],actions:[]},decision:null,selectedRuleCode:null,appliedEffects:[],postState:null,facts:[],events:[],hints:[],forbiddenFacts:[]}}),P=async(r,c)=>({ok:!0,message:`${r} / ${c} の状態と過去Turnを取り込みました。`,value:{sessionId:r,turnId:c,testCase:{recentTurns:[{playerInput:"館について教えて",narrative:"メイドは紅茶を注ぎ、庭のバラについて語った。"}],playerInput:"この館について、まだ知らないことを教えて",selectedObject:{id:"maid",code:"maid",name:"メイド",locationId:"salon",isGlobal:!1,revision:2,state:{trust:2}},selectedAction:{objectId:"maid",actionId:"talk",code:"talk",label:"会話する",description:"",argumentSchema:{},enabled:!0},postState:{schemaVersion:"rule-post-state.v1",currentLocation:{id:"salon",code:"salon",name:"応接間",description:"雨音の響く応接間。"},objects:[],sessionFlags:{},sessionStateRevision:4},facts:[],events:[],narrativeHints:["新しい情報を一つ明かす。"],forbiddenNarrativeFacts:[],entities:[{code:"maid",name:"メイド",profileMarkdown:"館に長く仕えるメイド。"}]}}}),_=async r=>({ok:!0,message:"同じ状態・過去Turn・AIで、公開版と未保存ドラフトを生成しました。",value:{publishedDefinitionVersionId:"DEF-PUBLISHED",aiProfileId:"runpod-recommended",published:{heading:"雨の応接間",body:"メイドは再び紅茶を注ぎ、庭のバラについて語った。",model:"demo",latencyMilliseconds:620},draft:{heading:"閉ざされた東棟",body:`「東棟の帳簿には、前の主人が最後に会った人物の名が残っています」

${r.tone}を保ちながら、彼女は鍵の所在を初めて明かした。`,model:"demo",latencyMilliseconds:640}}}),W=async()=>({ok:!0,message:"公開準備が完了しています。シナリオを公開できます。",value:{definitionVersionId:`demo-${s}`,ready:!0,errors:{}}}),q=async()=>({ok:!0,message:"シナリオを公開しました。公開版として利用できます。"});return O.jsx(K,{account:Y,scenarioId:s,initialValues:X,status:"ready",saving:o,aiWorking:!1,actions:{save:t,assist:i,debug:G,importNarrativeTest:P,compareNarrativeDraft:_,checkReadiness:W,publish:q},onRetry:()=>{},onLogout:()=>{}})}$.__docgenInfo={description:"",methods:[],displayName:"MockEditScenarioContainer",props:{scenarioId:{required:!0,tsType:{name:"string"},description:""}}};const Se={title:"ユーザーストーリー/Edit scenario",component:b,render:()=>O.jsx(b,{initialUrl:"/scenarios/SCN-AWAKENING-LAB/edit",initialDb:z("empty"),editScenarioContainer:$}),parameters:{notes:"シナリオ登録と同じ共通フォームを使い、保存済みの値を読み込んで編集します。"}},y=async(s,o)=>{await a.click(await s.findByRole("button",{name:`${o}へ`}))},u={name:"US-E01: 作成画面と同じフォームで既存シナリオを編集したい",play:async({canvasElement:s,step:o})=>{const e=l(s);await o("登録画面と同じ7ステップの編集ウィザードに保存済み内容を読み込む",async()=>{await n(e.getByRole("main",{name:"シナリオ編集ウィザード"})).toBeVisible(),await n(e.getByRole("complementary",{name:"契約の改稿"})).toBeVisible(),await n(e.getByLabelText("シナリオタイトル")).toHaveValue("目覚めの研究室"),await n(e.getByRole("group",{name:"登録済みジャンルタグ"})).toHaveTextContent("SF");for(const t of["基本情報","場所","主人公","エンティティ","開始状態","挿絵","テスト"])await n(e.getByRole("button",{name:`${t}へ`})).toBeVisible()})}},m={name:"US-E02: タイトル・タグ・基本情報を編集して保存したい",play:async({canvasElement:s,step:o})=>{const e=l(s);await o("タイトルと基本情報を変更する",async()=>{const t=e.getByLabelText("シナリオタイトル");await a.clear(t),await a.type(t,"目覚めの研究室・改");const i=e.getByLabelText("基本情報");await a.clear(i),await a.type(i,`# シナリオ
改稿した研究施設から脱出します。`)}),await o("変更を保存する",async()=>{await a.click(e.getByRole("button",{name:"変更を保存"})),await n(e.getByTestId("scenario-notice")).toHaveTextContent("変更を保存しました")})}},p={name:"US-E03: 主人公と第一場面を作成時と同じ操作で編集したい",play:async({canvasElement:s,step:o})=>{const e=l(s);await y(e,"主人公"),await o("主人公の前提を編集する",async()=>{const t=e.getByLabelText("主人公の設定");await a.clear(t),await a.type(t,"研究員または被験者として自由に作成する。")}),await y(e,"開始状態"),await o("保存済みの開始場所と初期ステートを確認する",async()=>{await n(e.getByRole("combobox",{name:"セッション開始場所"})).toHaveTextContent("水没した閲覧室"),await n(e.getByRole("combobox",{name:"北書庫の扉の開いている初期値"})).toHaveTextContent("false")}),await o("開始シーンを編集する",async()=>{const t=e.getByLabelText("開始シーン");await a.clear(t),await a.type(t,"非常灯が点滅する実験室で目を覚ます。"),await n(t).toHaveValue("非常灯が点滅する実験室で目を覚ます。")})}},v={name:"US-E04: 挿絵設定を作成時と同じ操作で編集したい",play:async({canvasElement:s,step:o})=>{const e=l(s);await y(e,"挿絵"),await o("画風・ムード・NG要素を編集できる",async()=>{await n(e.getByLabelText("挿絵の画風")).toHaveValue("冷たい研究施設のコンセプトアート"),await n(e.getByLabelText("挿絵のムード")).toHaveValue("静かな緊張感"),await n(e.getByLabelText("挿絵の禁止要素")).toHaveValue("明るい屋外、コミカルな表現")})}},w={name:"US-E05: 保存済み下書きの公開準備を確認して公開したい",play:async({canvasElement:s,step:o})=>{const e=l(s);await o("公開準備を確認するまで公開操作は無効になっている",async()=>{await n(e.getByRole("button",{name:"シナリオを公開"})).toBeDisabled(),await a.click(e.getByRole("button",{name:"公開準備を確認"})),await n(e.getByTestId("publish-readiness")).toHaveTextContent("公開できます。")}),await o("準備完了後にシナリオを公開する",async()=>{await a.click(e.getByRole("button",{name:"シナリオを公開"})),await n(e.getByTestId("publish-success")).toHaveTextContent("公開が完了しました。"),await n(e.getByTestId("scenario-notice")).toHaveTextContent("シナリオを公開しました。")})}},g={name:"US-E06: Sessionの状態を取り込み、公開版よりドラフトが改善したか反復確認したい",play:async({canvasElement:s,step:o})=>{const e=l(s);await o("基本情報のトーンと世界観を未保存のまま改稿する",async()=>{const t=e.getByLabelText("シナリオのトーン");await a.clear(t),await a.type(t,"静謐で、同じ所作を繰り返さず、新しい事実を一つずつ明かす");const i=e.getByLabelText("世界観・設定");await a.clear(i),await a.type(i,"館の東棟には前主人の帳簿があり、メイドは信頼が高まった時だけ存在を明かす。")}),await y(e,"テスト"),await o("SessionとTurnを指定して実際のテスト条件をインポートする",async()=>{await a.type(e.getByLabelText("インポートするSession ID"),"SES-MAID-001"),await a.type(e.getByLabelText("インポートするTurn ID"),"TRN-MAID-004"),await a.click(e.getByRole("button",{name:"インポート"})),await n(e.getByTestId("narrative-test-notice")).toHaveTextContent("取り込みました"),await n(e.getByLabelText("Turn 1 Narrative")).toHaveValue("メイドは紅茶を注ぎ、庭のバラについて語った。")}),await o("過去Turnと状態を編集し、公開版と未保存ドラフトを同じ条件で比較する",async()=>{const t=e.getByLabelText("Turn 1 Narrative");await a.clear(t),await a.type(t,"メイドは庭の由来を説明した。"),await a.click(e.getByRole("button",{name:"公開版と未保存ドラフトを比較"}));const i=await e.findByTestId("narrative-comparison");await n(i).toHaveTextContent("公開版"),await n(i).toHaveTextContent("未保存ドラフト"),await n(i).toHaveTextContent("東棟の帳簿"),await n(e.getByTestId("scenario-notice")).not.toHaveTextContent("変更を保存しました")})}},d={name:"US-E11: 既存ルールデータのstable codeを保って編集したい",play:async({canvasElement:s,step:o})=>{const e=l(s),t=l(s.ownerDocument.body);await y(e,"エンティティ"),await o("Object Typeの行から編集ペインを開き、stable codeを保って表示名を編集する",async()=>{await a.click(e.getByRole("button",{name:/^書庫の扉を編集$/})),await n(t.getByRole("dialog",{name:"書庫の扉"})).toBeVisible(),await n(t.getByLabelText("種類のstable code")).toHaveValue("archive-door"),await a.click(t.getByRole("button",{name:"開いているを編集"})),await n(t.getByRole("dialog",{name:"開いている"})).toHaveAttribute("data-layer","1"),await n(t.getByLabelText("状態1のstable code")).toHaveValue("open"),await a.click(t.getByRole("button",{name:"状態の編集を完了"})),await a.click(t.getByRole("button",{name:"扉を開けるを編集"})),await n(t.getByRole("dialog",{name:"扉を開ける"})).toHaveAttribute("data-layer","1"),await n(t.getByLabelText("アクション1のstable code")).toHaveValue("open"),await a.click(t.getByRole("button",{name:"アクションの編集を完了"})),await a.clear(t.getByLabelText("種類の表示名")),await a.type(t.getByLabelText("種類の表示名"),"封印書庫の扉"),await a.click(t.getByRole("button",{name:"編集を完了"}))}),await y(e,"場所"),await o("場所とエンティティの各ステップで編集ペインを開く",async()=>{await a.click(e.getByRole("button",{name:"水没した閲覧室を編集"})),await n(t.getByLabelText("場所のstable code")).toHaveValue("sunken-library"),await a.clear(t.getByLabelText("場所の表示名")),await a.type(t.getByLabelText("場所の表示名"),"水没した中央閲覧室"),await a.click(t.getByRole("button",{name:"編集を完了"})),await y(e,"エンティティ"),await a.click(e.getByRole("button",{name:"北書庫の扉を編集"})),await n(t.getByLabelText("エンティティのstable code")).toHaveValue("north-archive-door"),await a.click(t.getByRole("button",{name:"編集を完了"}))}),await o("Type generic ruleとObject adjust operationを維持したまま変更を保存する",async()=>{await a.click(e.getByRole("button",{name:/^封印書庫の扉を編集$/})),await n(t.getByRole("button",{name:"generic-openの実行ルールを編集"})).toBeVisible(),await a.click(t.getByRole("button",{name:"編集を完了"})),await a.click(e.getByRole("button",{name:"北書庫の扉を編集"})),await n(t.getByRole("table",{name:"Object states"})).toHaveTextContent("開いている"),await n(t.getByRole("table",{name:"Object actions"})).toHaveTextContent("扉を開ける"),await n(t.getByRole("button",{name:"archive-door:generic-openの実行ルールを確認"})).toBeVisible(),await a.click(t.getByRole("button",{name:"archive-door:generic-openの実行ルールを確認"})),await n(t.queryByLabelText("実行ルールの優先度")).not.toBeInTheDocument(),await a.click(t.getByRole("button",{name:"閉じる"})),await a.click(t.getByRole("button",{name:"編集を完了"})),await n(e.getByTestId("rule-readiness")).toHaveTextContent("決定的です"),await a.click(e.getByRole("button",{name:"変更を保存"})),await n(e.getByTestId("scenario-notice")).toHaveTextContent("変更を保存しました"),await n(e.queryByRole("button",{name:"アクション結果へ"})).not.toBeInTheDocument()})}};var B,x,T;u.parameters={...u.parameters,docs:{...(B=u.parameters)==null?void 0:B.docs,source:{originalSource:`{
...
}`,...(T=(x=u.parameters)==null?void 0:x.docs)==null?void 0:T.source}}};var E,R,S;m.parameters={...m.parameters,docs:{...(E=m.parameters)==null?void 0:E.docs,source:{originalSource:`{
...
}`,...(S=(R=m.parameters)==null?void 0:R.docs)==null?void 0:S.source}}};var k,H,L;p.parameters={...p.parameters,docs:{...(k=p.parameters)==null?void 0:k.docs,source:{originalSource:`{
...
}`,...(L=(H=p.parameters)==null?void 0:H.docs)==null?void 0:L.source}}};var h,C,I;v.parameters={...v.parameters,docs:{...(h=v.parameters)==null?void 0:h.docs,source:{originalSource:`{
...
}`,...(I=(C=v.parameters)==null?void 0:C.docs)==null?void 0:I.source}}};var V,f,U;w.parameters={...w.parameters,docs:{...(V=w.parameters)==null?void 0:V.docs,source:{originalSource:`{
...
}`,...(U=(f=w.parameters)==null?void 0:f.docs)==null?void 0:U.source}}};var D,N,A;g.parameters={...g.parameters,docs:{...(D=g.parameters)==null?void 0:D.docs,source:{originalSource:`{
...
}`,...(A=(N=g.parameters)==null?void 0:N.docs)==null?void 0:A.source}}};var j,M,F;d.parameters={...d.parameters,docs:{...(j=d.parameters)==null?void 0:j.docs,source:{originalSource:`{
...
}`,...(F=(M=d.parameters)==null?void 0:M.docs)==null?void 0:F.source}}};const ke=["USE01EditExistingScenario","USE02EditBasics","USE03EditHeroAndOpening","USE04EditIllustration","USE05CheckReadinessAndPublish","USE06CompareUnsavedDraftNarrative","USE11EditRuleDataWithStableCodes"];export{u as USE01EditExistingScenario,m as USE02EditBasics,p as USE03EditHeroAndOpening,v as USE04EditIllustration,w as USE05CheckReadinessAndPublish,g as USE06CompareUnsavedDraftNarrative,d as USE11EditRuleDataWithStableCodes,ke as __namedExportsOrder,Se as default};
