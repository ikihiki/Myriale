import{j as g}from"./jsx-runtime-BO8uF4Og.js";import{r as St}from"./index-D4H_InIO.js";import{w as c,e as n,u as t}from"./index-C4S39nCK.js";import{S as ft,e as Ht,M as B,c as ht}from"./MyrialeApp-Cx4qFg2Z.js";import{u as At,c as K}from"./SessionPresentation-Bk2Ois2k.js";import{w as Ut,c as Dt}from"./scenarioRegistrationFixtures-Bspt7UiO.js";/* empty css               */import"./ConditionTablePresentation-ybfbi74E.js";import"./Surfaces-xpIMDkG0.js";import"./EditPane-OsFMeo59.js";import"./MyrialeToggle-nBW4_8Wv.js";import"./navigationRecipes-DkSbwkz5.js";import"./index-DzKAYa42.js";import"./AppChrome-CqlUs9ri.js";import"./MyrialeMenu-CLGgTteF.js";import"./scenarioWizardStyles-DbrtSybi.js";import"./ModuleUiHost-CoZk1x5n.js";import"./account-CrOIROJF.js";import"./SessionListPresentation-Cou-SJ3F.js";import"./SessionIcons-yGOCmQwo.js";import"./SessionTurn-9KUaF1pl.js";import"./SessionActivityFeed-Cizm6efh.js";const jt={name:"霧野しおり",email:"author@myriale.example",initials:"霧野",role:"作者"};function Y({ruleData:o}){const i=At(),[e,a]=St.useState(o?"SCN-DRAFT-0427":"未発行"),s=async l=>{if(!l.title.trim())return{ok:!1,message:"タイトルを入力すると下書き保存できます。",fieldErrors:{title:["シナリオタイトルを入力してください。"]}};const y="SCN-DRAFT-0427";return a(y),i==null||i.dispatch({type:"SCENARIO_SAVED",scenario:{id:y,title:l.title.trim(),status:"draft",genre:l.genre,updatedAt:"2026-07-23",summary:l.summary,tone:"",lore:"",aiFreedom:l.aiFreedom,heroMode:l.heroMode,heroFreeGenerationAllowed:l.heroFreeGenerationAllowed,hero:l.hero,npcs:l.npcs,opening:l.opening,illustrationStyle:l.illustrationStyle,illustrationMood:l.illustrationMood,illustrationNegative:l.illustrationNegative,sampleScene:l.sampleScene}}),{ok:!0,message:`「${l.title.trim()}」をDraftとして保存しました。ScenarioIdを発行しました。`,value:{scenarioId:y}}},v=async(l,y)=>y==="summary"?{ok:!0,message:"基本情報案を3つ提示しました。採用、編集、破棄を選べます。",value:{message:"基本情報案を3つ提示しました。採用、編集、破棄を選べます。",suggestions:[{id:"summary-1",body:`## 物語の目的

地下に沈んだ王都で、禁書を読むたびに書き換わる星座の謎を追います。

- 水没した書庫を探索する
- 失われる記憶の代償を選ぶ`,rationale:"タイトル、ジャンル、基本情報からMarkdown案を生成しました。"}]}}:y==="illustration-style"?{ok:!0,message:"シナリオに合う画風候補を提示しました。",value:{message:"シナリオに合う画風候補を提示しました。",suggestions:[{id:"style-1",body:"銅版画風、影絵、水彩写本。低彩度で星図の金線だけを強調。",rationale:"既存のムードとNG要素に合わせました。"}]}}:y==="illustration-prompt"?{ok:!0,message:"画像生成用プロンプトとネガティブプロンプトを分離して生成しました。",value:{message:"画像生成用プロンプトとネガティブプロンプトを分離して生成しました。",suggestions:[{id:"prompt-1",body:"submerged archive, apprentice librarian, antique star map, copperplate engraving, muted palette",rationale:"プロンプトとNG要素を分離しました。"}],prompt:"submerged archive, apprentice librarian, antique star map, copperplate engraving, muted palette",negativePrompt:l.illustrationNegative}}:{ok:!0,message:"サンプルシーンのプレビューを生成しました。",value:{message:"サンプルシーンのプレビューを生成しました。",suggestions:[],previewText:`[Preview / 保存対象外] ${l.sampleScene} / ${l.illustrationStyle} / ${l.illustrationMood}`}},p=async(l,y)=>{var X,Z;const r=(o==null?void 0:o.objects.find(u=>u.code===y.objectCode))??(o==null?void 0:o.objects[0]),w=(o==null?void 0:o.locations.find(u=>u.code===y.currentLocationCode))??(o==null?void 0:o.locations[0]),b=r?[...r.actions,...r.mixinTypeCodes.flatMap(u=>{var q;return((q=o==null?void 0:o.objectTypes.find(Lt=>Lt.code===u))==null?void 0:q.actions)??[]})].find(u=>u.code===y.actionCode):void 0,J=((X=y.objects.find(u=>u.objectCode===(r==null?void 0:r.code)))==null?void 0:X.state)??{},Q=y.trigger==="enumerate"?null:{...J,open:!0};return{ok:!0,message:"隔離されたルールエンジンで実行しました。本番データは変更されていません。",value:{snapshot:{schemaVersion:"rule-action-snapshot.v1",snapshotId:"DEBUG-STORY",currentLocation:{id:(w==null?void 0:w.code)??"",code:(w==null?void 0:w.code)??"",name:(w==null?void 0:w.name)??"",description:(w==null?void 0:w.description)??""},objects:r?[{id:r.code,code:r.code,name:r.name,locationId:((Z=y.objects.find(u=>u.objectCode===r.code))==null?void 0:Z.locationCode)??r.initialLocationCode,isGlobal:r.global,revision:0,state:J}]:[],actions:r&&b?[{objectId:r.code,actionId:b.code,code:b.code,label:b.label,description:b.description,argumentSchema:{},enabled:!0}]:[]},decision:y.trigger==="enumerate"||!r||!b?null:{schemaVersion:"rule-action-decision.v1",objectId:r.code,actionId:b.code,arguments:y.arguments},selectedRuleCode:y.trigger==="enumerate"?null:"open-door-when-closed",appliedEffects:y.trigger==="enumerate"?[]:[{type:"set-state",targetId:r==null?void 0:r.code,path:"state.open",value:!0}],postState:Q&&r&&w?{schemaVersion:"rule-post-state.v1",currentLocation:{id:w.code,code:w.code,name:w.name,description:w.description},objects:[{id:r.code,code:r.code,name:r.name,locationId:r.initialLocationCode,isGlobal:r.global,revision:1,state:Q}],sessionFlags:y.flags,sessionStateRevision:1}:null,facts:y.trigger==="enumerate"?[]:["西扉が開いた。"],events:[],hints:y.playerInput?["入力から「扉を開ける」が選択されました。"]:[],forbiddenFacts:[]}}};return g.jsx(ft,{account:jt,scenarioId:e,initialValues:o?{...Ht,title:"星喰いの地下図書館",ruleData:structuredClone(o)}:void 0,saving:!1,aiWorking:!1,actions:{saveDraft:s,assist:v,debug:p},onLogout:()=>{}})}function z(){return g.jsx(Y,{})}function Et(){return g.jsx(Y,{ruleData:Dt})}function kt(){return g.jsx(Y,{ruleData:Ut})}z.__docgenInfo={description:"",methods:[],displayName:"MockScenarioRegistrationContainer"};Et.__docgenInfo={description:"",methods:[],displayName:"MockScenarioRegistrationWithRuleDataContainer"};kt.__docgenInfo={description:"",methods:[],displayName:"MockWestDoorAuthoringContainer"};const oa={title:"ユーザーストーリー/Scenario registration",component:B,render:()=>g.jsx(B,{initialUrl:"/scenarios/new",initialDb:K("registrationDraft"),scenarioRegistrationContainer:z}),parameters:{notes:"docs/user-stories/scenario-registration.md の各ユーザーストーリーを、Storybook Interactions の step と expect で操作説明できるアプリ画面にしたものです。"}};function It({initialUrl:o}){const i=St.useMemo(()=>{const e=ht();return e.logout(),e},[]);return g.jsx(B,{initialUrl:o,initialDb:K("registrationDraft"),accountApi:i,scenarioRegistrationContainer:z})}const m=async(o,i)=>{await t.click(await o.findByRole("button",{name:`${i}へ`}))},x={name:"認証: ログイン後にシナリオ作成へ戻る",render:()=>g.jsx(It,{initialUrl:"/scenarios/new"}),play:async({canvasElement:o,step:i})=>{const e=c(o);await i("未ログインではログイン画面へ移動し、元のURLを保持する",async()=>{await n(await e.findByRole("main",{name:"ログイン"})).toBeVisible(),await n(e.getByTestId("app-url")).toHaveTextContent("/account/login"),await n(e.getByTestId("app-url")).toHaveTextContent("redirect=%2Fscenarios%2Fnew")}),await i("ログインすると元のシナリオ作成画面へ戻る",async()=>{await t.clear(e.getByLabelText("メールアドレス")),await t.type(e.getByLabelText("メールアドレス"),"reader@myriale.example"),await t.type(e.getByTestId("login-password"),"a"),await t.click(e.getByRole("button",{name:"ログインする"})),await n(await e.findByRole("main",{name:"シナリオ登録ウィザード"})).toBeVisible(),await n(e.getByTestId("app-url")).toHaveTextContent("/scenarios/new")})}},T={name:"認証: 戻り先がなければホームへ進む",render:()=>g.jsx(It,{initialUrl:"/account/login"}),play:async({canvasElement:o,step:i})=>{const e=c(o);await i("戻り先なしでログインする",async()=>{await n(await e.findByRole("main",{name:"ログイン"})).toBeVisible(),await t.clear(e.getByLabelText("メールアドレス")),await t.type(e.getByLabelText("メールアドレス"),"reader@myriale.example"),await t.type(e.getByTestId("login-password"),"a"),await t.click(e.getByRole("button",{name:"ログインする"}))}),await i("デフォルトのホーム画面へ移動する",async()=>{await n(await e.findByRole("main",{name:"Myrialeトップページ"})).toBeVisible(),await n(e.getByTestId("app-url")).toHaveTextContent("/")})}},R={name:"US-01: 新しいシナリオを作成したい",play:async({canvasElement:o,step:i})=>{const e=c(o);await i("タイトル未入力では、下書き保存に必要な項目を説明する",async()=>{await t.click(e.getByRole("button",{name:"下書き保存"})),await n(e.getByTestId("scenario-notice")).toHaveTextContent("タイトルを入力すると下書き保存できます。")}),await i("タイトルだけ入力してDraft保存し、ScenarioIdを発行する",async()=>{await t.type(e.getByLabelText("シナリオタイトル"),"星喰いの地下図書館"),await t.click(e.getByRole("button",{name:"下書き保存"})),await n(e.getByTestId("scenario-notice")).toHaveTextContent("Draftとして保存しました"),await n(e.getByText("SCN-DRAFT-0427")).toBeVisible()})}},C={name:"US-02: シナリオのジャンルをタグで指定したい",play:async({canvasElement:o,step:i})=>{const e=c(o);await i("タイトル直下へ複数のジャンルタグを追加し、表紙サマリーへ反映する",async()=>{const a=e.getByLabelText("ジャンルタグを追加");await t.type(a,"ポストアポカリプス{Enter}"),await t.type(a,"巡礼譚"),await t.click(e.getByRole("button",{name:"タグを追加"})),await n(e.getByRole("group",{name:"登録済みジャンルタグ"})).toHaveTextContent("# ポストアポカリプス"),await n(e.getByRole("group",{name:"登録済みジャンルタグ"})).toHaveTextContent("# 巡礼譚"),await n(e.getByRole("complementary",{name:"入力サマリー"})).toHaveTextContent("# ポストアポカリプス # 巡礼譚")}),await i("不要なタグを個別に削除できる",async()=>{await t.click(e.getByRole("button",{name:"巡礼譚タグを削除"})),await n(e.getByRole("group",{name:"登録済みジャンルタグ"})).not.toHaveTextContent("# 巡礼譚")})}},S={name:"US-04: AIの裁量レベルを調整したい",play:async({canvasElement:o,step:i})=>{const e=c(o),a=c(o.ownerDocument.body);await m(e,"AI裁量"),await i("AI裁量を高へ変更し、生成時の挙動差を明示する",async()=>{const s=e.getAllByRole("combobox",{name:"AI裁量"})[0];await t.click(s),await t.click(await a.findByRole("option",{name:"高: 展開を広げる"})),await n(s).toHaveTextContent("高: 展開を広げる"),await n(e.getByRole("complementary",{name:"契約の背表紙"})).toHaveTextContent("高: 展開を広げる")})}},E={name:"US-05: 初期キャラクター条件を設定したい",play:async({canvasElement:o,step:i})=>{const e=c(o);await m(e,"主人公"),await i("主人公の扱いと自由生成時の前提を入力する",async()=>{await n(e.getByRole("combobox",{name:"主人公の扱い"})).toHaveTextContent("自由生成のみ"),await t.clear(e.getByLabelText("主人公の設定")),await t.type(e.getByLabelText("主人公の設定"),"主人公は失踪した師匠を追う新人地図師。名前と年齢はセッション側で自由に決められる。"),n(e.getByLabelText("主人公の設定").value).toContain("新人地図師"),await n(e.getByRole("complementary",{name:"契約の背表紙"})).toHaveTextContent("自由生成")})}},k={name:"US-06: シナリオの開始シーンを定義したい",play:async({canvasElement:o,step:i})=>{const e=c(o);await m(e,"第一場面"),await i("開始シーンを固定し、初回Narrativeの材料にする",async()=>{await t.clear(e.getByLabelText("開始シーン")),await t.type(e.getByLabelText("開始シーン"),"あなたは灰の降る駅で、宛名のない切符を握っている。"),n(e.getByLabelText("開始シーン").value).toContain("灰の降る駅"),await n(e.getByRole("complementary",{name:"契約の背表紙"})).toHaveTextContent("固定")})}},I={name:"US-11: 挿絵のテイストを指定したい",play:async({canvasElement:o,step:i})=>{const e=c(o);c(o.ownerDocument.body),await m(e,"挿絵"),await i("文章と視覚表現を揃える画風を指定する",async()=>{await t.clear(e.getByLabelText("挿絵の画風")),await t.type(e.getByLabelText("挿絵の画風"),"古い天文図の銅版画、インクの滲み、低彩度"),n(e.getByLabelText("挿絵の画風").value).toContain("銅版画")})}},L={name:"US-12: 挿絵の雰囲気を指定したい",play:async({canvasElement:o,step:i})=>{const e=c(o);c(o.ownerDocument.body),await m(e,"挿絵"),await i("挿絵生成に使う感情的トーンを複数指定する",async()=>{await t.clear(e.getByLabelText("挿絵のムード")),await t.type(e.getByLabelText("挿絵のムード"),"孤独、湿度、薄明、遠い鐘の音"),n(e.getByLabelText("挿絵のムード").value).toContain("薄明")})}},f={name:"US-13: 挿絵の禁止要素を指定したい",play:async({canvasElement:o,step:i})=>{const e=c(o);c(o.ownerDocument.body),await m(e,"挿絵"),await i("年齢制限や世界観を守るNG要素を入力する",async()=>{await t.clear(e.getByLabelText("挿絵の禁止要素")),await t.type(e.getByLabelText("挿絵の禁止要素"),"現代兵器、スマートフォン、過度な流血"),n(e.getByLabelText("挿絵の禁止要素").value).toContain("スマートフォン")})}},H={name:"US-14: 挿絵を事前にプレビューしたい",play:async({canvasElement:o,step:i})=>{const e=c(o);c(o.ownerDocument.body),await m(e,"挿絵"),await i("サンプルシーンを入力し、本番相当の挿絵を保存せず生成する",async()=>{await t.clear(e.getByLabelText("サンプルシーン")),await t.type(e.getByLabelText("サンプルシーン"),"地下書庫の水面に星座が反射している。"),await t.click(e.getByRole("button",{name:"サンプルシーンで生成"})),await n(e.getByTestId("illustration-preview")).toHaveTextContent("保存対象外"),await n(e.getByTestId("scenario-notice")).toHaveTextContent("まだ確定していません")})}},h={name:"US-15: プレビューを見ながら挿絵設定を調整したい",play:async({canvasElement:o,step:i})=>{const e=c(o);await m(e,"挿絵"),await i("設定を変更して再生成し、納得した設定のみ保存対象にする",async()=>{await t.clear(e.getByLabelText("挿絵の画風")),await t.type(e.getByLabelText("挿絵の画風"),"影絵、余白多め、灯火だけ金色"),await t.click(e.getByRole("button",{name:"サンプルシーンで生成"})),n(e.getByLabelText("挿絵の画風").value).toContain("影絵"),await n(e.getByTestId("scenario-notice")).toHaveTextContent("設定はまだ確定していません")})}},A={name:"US-17: 登録内容をAIに相談したい",play:async({canvasElement:o,step:i})=>{const e=c(o);await i("AIに相談しても、提案は自動確定しない",async()=>{await t.click(e.getByRole("button",{name:"AIに基本情報案を出してもらう"})),await n(e.getByTestId("ai-suggestion")).toHaveTextContent("基本情報案を3つ提示しました"),await n(e.getByTestId("scenario-notice")).toHaveTextContent("自動確定はしません")})}},U={name:"US-18: どのAIに聞くかを選択したい",play:async({canvasElement:o,step:i})=>{const e=c(o),a=c(o.ownerDocument.body);await m(e,"挿絵"),await i("用途に合わせて相談先AIを選び、選択したAIで提案を生成する",async()=>{await t.click(e.getByRole("combobox",{name:"相談先AI"})),await t.click(await a.findByRole("option",{name:"挿絵AI"})),await t.click(e.getByRole("button",{name:"画風を相談"})),await n(e.getByRole("combobox",{name:"相談先AI"})).toHaveTextContent("挿絵AI"),await n(e.getByTestId("scenario-notice")).toHaveTextContent("挿絵AIに挿絵テイストを相談しました")})}},D={name:"US-19: シナリオの基本情報をAIに補完してもらいたい",play:async({canvasElement:o,step:i})=>{const e=c(o);await i("基本情報候補を見て、採用してからMarkdown本文に入れる",async()=>{await t.click(e.getByRole("button",{name:"AIに基本情報案を出してもらう"})),await t.click(e.getByRole("button",{name:"採用して編集"})),n(e.getByLabelText("基本情報").value).toContain("## 物語の目的"),await n(e.getByTestId("scenario-notice")).toHaveTextContent("採用しました"),await t.click(e.getByRole("button",{name:"プレビュー"})),await n(e.getByRole("article",{name:"基本情報のMarkdownプレビュー"})).toHaveTextContent("水没した書庫を探索する")})}},j={name:"US-21: 挿絵テイストをAIに相談したい",play:async({canvasElement:o,step:i})=>{const e=c(o);await m(e,"挿絵"),await i("シナリオに合う画風候補をAIに提示してもらう",async()=>{await t.click(e.getByRole("button",{name:"画風を相談"})),await n(e.getByTestId("ai-suggestion")).toHaveTextContent("画風候補"),await n(e.getByTestId("ai-suggestion")).toHaveTextContent("銅版画風")})}},N={name:"US-22: 挿絵プロンプトをAIに生成させたい",play:async({canvasElement:o,step:i})=>{const e=c(o);await m(e,"挿絵"),await i("画像生成用プロンプトとネガティブを分離して出力する",async()=>{await t.click(e.getByRole("button",{name:"プロンプトを生成"})),await n(e.getByTestId("ai-suggestion")).toHaveTextContent("ネガティブプロンプト"),await n(e.getByTestId("scenario-notice")).toHaveTextContent("挿絵プロンプトを相談しました")})}},d=()=>g.jsx(B,{initialUrl:"/scenarios/new",initialDb:K("registrationDraft"),scenarioRegistrationContainer:Et}),P={name:"NPC: 役割・演技・知識を構造化して登録する",render:d,play:async({canvasElement:o,step:i})=>{const e=c(o),a=c(o.ownerDocument.body);await m(e,"NPC"),await i("NPCを追加して基本情報と初期Locationを設定する",async()=>{await t.click(e.getByRole("button",{name:"NPCを追加"})),await t.clear(a.getByLabelText("NPCのstable code")),await t.type(a.getByLabelText("NPCのstable code"),"archivist-mira"),await t.clear(a.getByLabelText("NPC名")),await t.type(a.getByLabelText("NPC名"),"司書ミラ"),await t.type(a.getByLabelText("NPCの役割"),"禁書庫の案内役"),await t.click(a.getByRole("combobox",{name:"NPCの初期Location"})),await t.click(await a.findByRole("option",{name:"星見の階段 / astral-stair"}))}),await i("演技指針、公開情報、秘密を設定する",async()=>{await t.type(a.getByLabelText("NPCの性格"),"慎重で観察力が高い。"),await t.type(a.getByLabelText("NPCの行動指針"),"答えを直接明かさず、星図を使って示唆する。"),await t.type(a.getByLabelText("NPCの一人称"),"私"),await t.type(a.getByLabelText("NPCの口調"),"静かで短い敬語"),await t.type(a.getByLabelText("NPCの公開情報"),"北書庫の扉は星図と連動している。"),await t.type(a.getByLabelText("NPCの秘密"),"王都が沈んだ本当の原因を知っている。"),await t.click(a.getByRole("button",{name:"編集を完了"}));const s=e.getByRole("table",{name:"NPC一覧"});await n(c(s).getByText("司書ミラ")).toBeVisible(),await n(c(s).getByText("星見の階段")).toBeVisible()})}},O={name:"第一場面: 世界データから開始場所と初期ステートを決める",render:d,play:async({canvasElement:o,step:i})=>{const e=c(o),a=c(o.ownerDocument.body);await i("世界データの次に第一場面が並ぶ",async()=>{const s=e.getByRole("list",{name:"登録ウィザードのステップ"}),v=c(s).getAllByRole("button").map(p=>p.textContent);n(v.findIndex(p=>p==null?void 0:p.includes("世界データ"))).toBeLessThan(v.findIndex(p=>p==null?void 0:p.includes("第一場面"))),await m(e,"第一場面"),await n(e.getByLabelText("ウィザード進捗")).toHaveTextContent("07第一場面")}),await i("開始場所を選び、Objectごとの初期ステートをテーブルで上書きする",async()=>{const s=e.getByRole("table",{name:"全オブジェクトの初期ステート一覧"});await n(c(s).getByRole("columnheader",{name:"オブジェクト"})).toBeVisible(),await n(c(s).getByRole("columnheader",{name:"基準値"})).toBeVisible(),await n(c(s).getByRole("columnheader",{name:"初期値"})).toBeVisible(),await t.click(e.getByRole("combobox",{name:"セッション開始場所"})),await t.click(await a.findByRole("option",{name:"星見の階段 / astral-stair"})),await n(e.getByRole("combobox",{name:"セッション開始場所"})).toHaveTextContent("星見の階段"),await t.click(e.getByRole("combobox",{name:"北書庫の扉の開いている初期値"})),await t.click(await a.findByRole("option",{name:"true"})),await n(c(s).getByText("上書き中")).toBeVisible()})}},V={name:"US-23: Object Typeの状態とアクションを定義したい",play:async({canvasElement:o,step:i})=>{const e=c(o),a=c(o.ownerDocument.body);await m(e,"世界データ"),await i("新しい種類へstable code、状態、公開範囲を登録する",async()=>{await t.click(e.getByRole("button",{name:"種類を追加"})),await t.clear(a.getByLabelText("種類のstable code")),await t.type(a.getByLabelText("種類のstable code"),"sealed-door"),await t.clear(a.getByLabelText("種類の表示名")),await t.type(a.getByLabelText("種類の表示名"),"隔壁扉"),await t.click(a.getByRole("button",{name:"状態を追加"})),await t.clear(a.getByLabelText("状態1のstable code")),await t.type(a.getByLabelText("状態1のstable code"),"open"),await n(a.getByRole("combobox",{name:"公開"})).toHaveTextContent("public"),await t.click(a.getByRole("button",{name:"状態の編集を完了"})),await n(a.getByRole("button",{name:"新しい状態を編集"})).toBeVisible()}),await i("AIへ列挙するアクションinterfaceを登録する",async()=>{await t.click(a.getByRole("button",{name:"アクションを追加"})),await t.clear(a.getByLabelText("アクション1のstable code")),await t.type(a.getByLabelText("アクション1のstable code"),"open"),await t.clear(a.getByLabelText("アクション1の表示名")),await t.type(a.getByLabelText("アクション1の表示名"),"扉を開ける"),await n(a.getByRole("combobox",{name:"visibility"})).toHaveTextContent("AI choice")})}},F={name:"US-24: Locationを作成してObjectを初期配置したい",render:d,play:async({canvasElement:o,step:i})=>{const e=c(o),a=c(o.ownerDocument.body);await m(e,"世界データ"),await i("場所を追加してstable codeを維持する",async()=>{await t.click(e.getByRole("button",{name:"場所を追加"})),await t.clear(a.getByLabelText("場所のstable code")),await t.type(a.getByLabelText("場所のstable code"),"sealed-vault"),await t.clear(a.getByLabelText("場所の表示名")),await t.type(a.getByLabelText("場所の表示名"),"封印書庫"),await t.click(a.getByRole("button",{name:"編集を完了"})),await n(e.getByRole("button",{name:"封印書庫を編集"})).toBeVisible()}),await i("Objectの状態を1つの表で確認し、受け継いだ状態は初期値だけ変更する",async()=>{await t.click(e.getByRole("button",{name:"北書庫の扉を編集"})),await n(a.getByRole("region",{name:"ordered Type mixins"})).toHaveTextContent("書庫の扉"),await n(a.getByRole("combobox",{name:"初期配置"})).toHaveTextContent("水没した閲覧室");const s=a.getByRole("table",{name:"Object states"});await n(s).toHaveTextContent("開いている"),await n(s).toHaveTextContent("封印名"),await n(s).not.toHaveTextContent("mixin由来"),await t.click(a.getByRole("button",{name:"openの状態を確認"})),await n(a.queryByLabelText("Object state code")).not.toBeInTheDocument(),await t.type(a.getByLabelText("openの初期値"),"true"),await n(a.getByRole("button",{name:"継承値へ戻す"})).toBeEnabled()})}},M={name:"US-25: 状態とアクションに決定的な結果を設定したい",render:d,play:async({canvasElement:o,step:i})=>{const e=c(o),a=c(o.ownerDocument.body);await m(e,"世界データ"),await i("Object paneの統合rule tableで既存adjustのeffective結果を開く",async()=>{await t.click(e.getByRole("button",{name:"北書庫の扉を編集"}));const s=a.getByRole("table",{name:"Object rules"});await n(s).toHaveTextContent("archive-door:generic-open"),await n(s).not.toHaveTextContent("mixin由来"),await t.click(a.getByRole("button",{name:"archive-door:generic-openの実行ルールを確認"}))}),await i("継承condition/priorityと調整済み結果をread-onlyで確認する",async()=>{await n(a.getByText(/override \/ delete \/ adjustを開始することはできません/)).toBeVisible(),await n(a.getAllByText("100")[0]).toBeVisible(),await n(a.getByText("set-state → emit-fact")).toBeVisible(),await n(a.queryByLabelText("実行ルールの優先度")).not.toBeInTheDocument()}),await i("世界データ末尾の公開準備チェックが決定性を確認する",async()=>{await n(e.getByTestId("rule-readiness")).toHaveTextContent("決定的です")})}},G={name:"US-26: 参照中の種類と場所を安全に削除したい",render:d,play:async({canvasElement:o,step:i})=>{const e=c(o),a=c(o.ownerDocument.body);await m(e,"世界データ"),await i("Objectが参照中の種類は削除を拒否する",async()=>{await t.click(e.getByRole("button",{name:/^書庫の扉を編集$/})),await t.click(a.getByRole("button",{name:"この種類を削除"})),await n(e.getByTestId("scenario-notice")).toHaveTextContent("先に種類を変更するかオブジェクトを削除"),await t.click(a.getByRole("button",{name:"編集ペインを閉じる"}))}),await i("同じページでObjectが配置中のLocationも削除を拒否する",async()=>{await t.click(e.getByRole("button",{name:"水没した閲覧室を編集"})),await t.click(a.getByRole("button",{name:"この場所を削除"})),await n(e.getByTestId("scenario-notice")).toHaveTextContent("開始場所に選ばれています")})}},W={name:"US-27: 既存mutationを保持してDraft保存したい",render:d,play:async({canvasElement:o,step:i})=>{const e=c(o),a=c(o.ownerDocument.body);await m(e,"世界データ"),await i("既存adjust operationはeffective結果だけをread-onlyで表示する",async()=>{await t.click(e.getByRole("button",{name:"北書庫の扉を編集"})),await t.click(a.getByRole("button",{name:"archive-door:generic-openの実行ルールを確認"})),await n(a.queryByLabelText("実行ルールの優先度")).not.toBeInTheDocument(),await n(a.getByText(/既存の変更内容は保存時もそのまま保持されます/)).toBeVisible(),await t.click(a.getByRole("button",{name:"閉じる"})),await t.click(a.getByRole("button",{name:"編集を完了"}))}),await i("既存mutationを変更せず下書き保存できる",async()=>{await t.click(e.getByRole("button",{name:"下書き保存"})),await n(e.getByTestId("scenario-notice")).toHaveTextContent("Draftとして保存しました")})}},_={name:"US-SR12: 任意状態からルールエンジンを動作確認する",render:d,play:async({canvasElement:o,step:i})=>{const e=c(o);await m(e,"動作確認"),await i("全状態を上書きして公開状態と利用可能アクションを確認する",async()=>{const a=e.getAllByLabelText(/のstate$/)[0];await t.clear(a),await t.click(a),await t.paste('{"open":false}'),await t.click(e.getByRole("button",{name:"公開状態とアクションを確認"})),await n(e.getByRole("complementary",{name:"デバッグ実行結果"})).toHaveTextContent("扉を開ける")}),await i("アクションを直接発動してselected ruleとpost-stateを確認する",async()=>{await t.click(e.getByRole("button",{name:"アクションを直接発動"})),await n(e.getByText(/open-door-when-closed/)).toBeVisible(),await n(e.getByTestId("debug-post-state")).toHaveTextContent('"open": true')}),await i("ユーザー入力から選ばれるアクションと物語材料を確認する",async()=>{await t.type(e.getByLabelText("デバッグ用ユーザー入力"),"扉をゆっくり開ける"),await t.click(e.getByRole("button",{name:"入力から起きることを確認"})),await n(e.getByRole("complementary",{name:"デバッグ実行結果"})).toHaveTextContent("入力から「扉を開ける」が選択されました。"),await n(e.getByTestId("debug-notice")).toHaveTextContent("本番データは変更されていません")})}},$={name:"西の扉seed: 統合テーブルで契約と結果を編集・保存する",render:()=>g.jsx(B,{initialUrl:"/scenarios/new",initialDb:K("registrationDraft"),scenarioRegistrationContainer:kt}),play:async({canvasElement:o,step:i})=>{const e=c(o),a=c(o.ownerDocument.body);await m(e,"世界データ"),await t.click(e.getByRole("button",{name:"西の扉を編集"})),await i("ordered mixinを維持しながら状態・アクション・ruleを各1つの表で表示する",async()=>{const s=a.getByRole("region",{name:"ordered Type mixins"});await n(s).toHaveTextContent("開閉可能"),await n(s).toHaveTextContent("出口の扉"),await n(a.getByRole("table",{name:"Object states"})).toHaveTextContent("開いている"),await n(a.getByRole("table",{name:"Object states"})).toHaveTextContent("方向"),await n(a.getByRole("table",{name:"Object actions"})).toHaveTextContent("出口を確認する"),await n(a.getByRole("table",{name:"Object rules"})).toHaveTextContent("exit-door:generic-open-and-exit"),await n(a.getByRole("table",{name:"Object rules"})).toHaveTextContent("local:west-inspect-exit")}),await i("受け継いだ状態は初期値だけ、Objectのアクションとadd ruleは編集できる",async()=>{await t.click(a.getByRole("button",{name:"openの状態を確認"})),await t.type(a.getByLabelText("openの初期値"),"true"),await t.click(a.getByRole("button",{name:"閉じる"})),await t.click(a.getByRole("button",{name:"inspect-exitのアクションを確認"})),await t.clear(a.getByLabelText("Object action label")),await t.type(a.getByLabelText("Object action label"),"出口を詳しく確認する"),await t.click(a.getByRole("button",{name:"閉じる"})),await t.click(a.getByRole("button",{name:"local:west-inspect-exitの実行ルールを確認"}));const s=a.getByRole("table",{name:"実行条件 table"});await n(s).toHaveTextContent("状態：direction ＝"),await t.click(c(s).getByRole("button",{name:"ルートの実行条件を編集"}));const v=a.getByRole("dialog",{name:"実行条件を編集"});await n(v).toHaveAttribute("data-layer","2"),await t.click(c(v).getByRole("combobox",{name:"実行条件の条件種別"})),await t.click(await a.findByRole("option",{name:"すべて成立（AND）"})),await t.click(c(v).getByRole("button",{name:"子条件を追加"})),await t.click(c(v).getByRole("button",{name:"実行条件の編集を完了"})),await n(s).toHaveTextContent("すべて成立（AND）"),await n(s).toHaveTextContent("AND 2"),await t.clear(a.getByLabelText("実行ルールの優先度")),await t.type(a.getByLabelText("実行ルールの優先度"),"95"),await t.click(a.getByRole("button",{name:"閉じる"}))}),await i("既存overrideはread-onlyのままeffective 8 effectを保持する",async()=>{await t.click(a.getByRole("button",{name:"exit-door:generic-open-and-exitの実行ルールを確認"})),await n(a.getByText("set-state → move-session → emit-fact → emit-fact → emit-event → add-narrative-hint → forbid-narrative-fact → forbid-narrative-fact")).toBeVisible(),await n(a.queryByLabelText("実行ルールの優先度")).not.toBeInTheDocument(),await t.click(a.getByRole("button",{name:"閉じる"}))}),await i("編集内容と既存mutationを下書き保存する",async()=>{await t.click(a.getByRole("button",{name:"編集を完了"})),await n(e.getByTestId("rule-readiness")).toHaveTextContent("決定的です"),await t.click(e.getByRole("button",{name:"下書き保存"})),await n(e.getByTestId("scenario-notice")).toHaveTextContent("Draftとして保存しました")})}};var ee,te,ae;x.parameters={...x.parameters,docs:{...(ee=x.parameters)==null?void 0:ee.docs,source:{originalSource:`{
...
}`,...(re=(se=R.parameters)==null?void 0:se.docs)==null?void 0:re.source}}};var le,ye,me;C.parameters={...C.parameters,docs:{...(le=C.parameters)==null?void 0:le.docs,source:{originalSource:`{
...
}`,...(me=(ye=C.parameters)==null?void 0:ye.docs)==null?void 0:me.source}}};var we,pe,ue;S.parameters={...S.parameters,docs:{...(we=S.parameters)==null?void 0:we.docs,source:{originalSource:`{
...
}`,...(be=(ve=E.parameters)==null?void 0:ve.docs)==null?void 0:be.source}}};var de,Be,xe;k.parameters={...k.parameters,docs:{...(de=k.parameters)==null?void 0:de.docs,source:{originalSource:`{
...
}`,...(xe=(Be=k.parameters)==null?void 0:Be.docs)==null?void 0:xe.source}}};var Te,Re,Ce;I.parameters={...I.parameters,docs:{...(Te=I.parameters)==null?void 0:Te.docs,source:{originalSource:`{
...
}`,...(Ce=(Re=I.parameters)==null?void 0:Re.docs)==null?void 0:Ce.source}}};var Se,Ee,ke;L.parameters={...L.parameters,docs:{...(Se=L.parameters)==null?void 0:Se.docs,source:{originalSource:`{
...
}`,...(ke=(Ee=L.parameters)==null?void 0:Ee.docs)==null?void 0:ke.source}}};var Ie,Le,fe;f.parameters={...f.parameters,docs:{...(Ie=f.parameters)==null?void 0:Ie.docs,source:{originalSource:`{
...
}`,...(fe=(Le=f.parameters)==null?void 0:Le.docs)==null?void 0:fe.source}}};var He,he,Ae;H.parameters={...H.parameters,docs:{...(He=H.parameters)==null?void 0:He.docs,source:{originalSource:`{
...
}`,...(Ae=(he=H.parameters)==null?void 0:he.docs)==null?void 0:Ae.source}}};var Ue,De,je;h.parameters={...h.parameters,docs:{...(Ue=h.parameters)==null?void 0:Ue.docs,source:{originalSource:`{
...
}`,...(je=(De=h.parameters)==null?void 0:De.docs)==null?void 0:je.source}}};var Ne,Pe,Oe;A.parameters={...A.parameters,docs:{...(Ne=A.parameters)==null?void 0:Ne.docs,source:{originalSource:`{
...
}`,...(Oe=(Pe=A.parameters)==null?void 0:Pe.docs)==null?void 0:Oe.source}}};var Ve,Fe,Me;U.parameters={...U.parameters,docs:{...(Ve=U.parameters)==null?void 0:Ve.docs,source:{originalSource:`{
...
}`,...(Me=(Fe=U.parameters)==null?void 0:Fe.docs)==null?void 0:Me.source}}};var Ge,We,_e;D.parameters={...D.parameters,docs:{...(Ge=D.parameters)==null?void 0:Ge.docs,source:{originalSource:`{
...
}`,...(Ye=(Ke=j.parameters)==null?void 0:Ke.docs)==null?void 0:Ye.source}}};var ze,Je,Qe;N.parameters={...N.parameters,docs:{...(ze=N.parameters)==null?void 0:ze.docs,source:{originalSource:`{
...
}`,...(Qe=(Je=N.parameters)==null?void 0:Je.docs)==null?void 0:Qe.source}}};var Xe,Ze,qe;P.parameters={...P.parameters,docs:{...(Xe=P.parameters)==null?void 0:Xe.docs,source:{originalSource:`{
...
}`,...(qe=(Ze=P.parameters)==null?void 0:Ze.docs)==null?void 0:qe.source}}};var et,tt,at;O.parameters={...O.parameters,docs:{...(et=O.parameters)==null?void 0:et.docs,source:{originalSource:`{
...
}`,...(at=(tt=O.parameters)==null?void 0:tt.docs)==null?void 0:at.source}}};var nt,ot,it;V.parameters={...V.parameters,docs:{...(nt=V.parameters)==null?void 0:nt.docs,source:{originalSource:`{
...
}`,...(it=(ot=V.parameters)==null?void 0:ot.docs)==null?void 0:it.source}}};var ct,st,rt;F.parameters={...F.parameters,docs:{...(ct=F.parameters)==null?void 0:ct.docs,source:{originalSource:`{
...
}`,...(rt=(st=F.parameters)==null?void 0:st.docs)==null?void 0:rt.source}}};var lt,yt,mt;M.parameters={...M.parameters,docs:{...(lt=M.parameters)==null?void 0:lt.docs,source:{originalSource:`{
...
}`,...(mt=(yt=M.parameters)==null?void 0:yt.docs)==null?void 0:mt.source}}};var wt,pt,ut;G.parameters={...G.parameters,docs:{...(wt=G.parameters)==null?void 0:wt.docs,source:{originalSource:`{
...
}`,...(ut=(pt=G.parameters)==null?void 0:pt.docs)==null?void 0:ut.source}}};var gt,vt,bt;W.parameters={...W.parameters,docs:{...(gt=W.parameters)==null?void 0:gt.docs,source:{originalSource:`{
...
}`,...(bt=(vt=W.parameters)==null?void 0:vt.docs)==null?void 0:bt.source}}};var dt,Bt,xt;_.parameters={..._.parameters,docs:{...(dt=_.parameters)==null?void 0:dt.docs,source:{originalSource:`{
...
}`,...(xt=(Bt=_.parameters)==null?void 0:Bt.docs)==null?void 0:xt.source}}};var Tt,Rt,Ct;$.parameters={...$.parameters,docs:{...(Tt=$.parameters)==null?void 0:Tt.docs,source:{originalSource:`{
...
}`,...(Ct=(Rt=$.parameters)==null?void 0:Rt.docs)==null?void 0:Ct.source}}};const ia=["AuthenticationReturnsToScenarioCreation","AuthenticationDefaultsToHome","US01CreateDraftScenario","US02SpecifyGenreTag","US04TuneAiFreedom","US05SetInitialCharacter","US06DefineOpeningScene","US11SpecifyIllustrationStyle","US12SpecifyIllustrationMood","US13SpecifyNegativeElements","US14PreviewIllustration","US15IterateIllustrationSettings","US17ConsultAiAboutRegistration","US18SelectAiByPurpose","US19AiCompletesSummary","US21ConsultIllustrationTaste","US22GenerateIllustrationPrompt","ConfigureNpcSettings","ConfigureInitialSceneFromWorldData","US23DefineObjectTypeStatesAndActions","US24CreateLocationsAndPlaceObjects","US25AuthorDeterministicActionResults","US26KeepDependenciesSafe","US27SaveIncompleteRuleDataAsDraft","US12DebugRuleEngineFromArbitraryState","AuthorWestDoorSeedWithEightOrderedEffects"];export{T as AuthenticationDefaultsToHome,x as AuthenticationReturnsToScenarioCreation,$ as AuthorWestDoorSeedWithEightOrderedEffects,O as ConfigureInitialSceneFromWorldData,P as ConfigureNpcSettings,R as US01CreateDraftScenario,C as US02SpecifyGenreTag,S as US04TuneAiFreedom,E as US05SetInitialCharacter,k as US06DefineOpeningScene,I as US11SpecifyIllustrationStyle,_ as US12DebugRuleEngineFromArbitraryState,L as US12SpecifyIllustrationMood,f as US13SpecifyNegativeElements,H as US14PreviewIllustration,h as US15IterateIllustrationSettings,A as US17ConsultAiAboutRegistration,U as US18SelectAiByPurpose,D as US19AiCompletesSummary,j as US21ConsultIllustrationTaste,N as US22GenerateIllustrationPrompt,V as US23DefineObjectTypeStatesAndActions,F as US24CreateLocationsAndPlaceObjects,M as US25AuthorDeterministicActionResults,G as US26KeepDependenciesSafe,W as US27SaveIncompleteRuleDataAsDraft,ia as __namedExportsOrder,oa as default};
