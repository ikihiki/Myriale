import{j as u}from"./jsx-runtime-BO8uF4Og.js";import{r as Ct}from"./index-D4H_InIO.js";import{w as c,e as a,u as t}from"./index-C4S39nCK.js";import{S as ft,e as Ht,M as d,c as ht}from"./MyrialeApp-gzSRz5kS.js";import{u as At,c as $}from"./SessionPresentation-Buj7txJp.js";import{w as Ut,c as Dt}from"./scenarioRegistrationFixtures-Bspt7UiO.js";/* empty css               */import"./ConditionTablePresentation-ybfbi74E.js";import"./Surfaces-xpIMDkG0.js";import"./EditPane-OsFMeo59.js";import"./MyrialeToggle-nBW4_8Wv.js";import"./navigationRecipes-DkSbwkz5.js";import"./index-DzKAYa42.js";import"./AppChrome-CqlUs9ri.js";import"./MyrialeMenu-CLGgTteF.js";import"./scenarioWizardStyles-DbrtSybi.js";import"./ModuleUiHost-CoZk1x5n.js";import"./TurnInspectionPresentation-CcW_7p87.js";import"./account-CrOIROJF.js";import"./SessionListPresentation-Cou-SJ3F.js";import"./SessionIcons-yGOCmQwo.js";import"./SessionTurn-9KUaF1pl.js";import"./SessionActivityFeed-COgkAg7K.js";const jt={name:"霧野しおり",email:"author@myriale.example",initials:"霧野",role:"作者"};function K({ruleData:o}){const i=At(),[e,n]=Ct.useState(o?"SCN-DRAFT-0427":"未発行"),s=async y=>{if(!y.title.trim())return{ok:!1,message:"タイトルを入力すると下書き保存できます。",fieldErrors:{title:["シナリオタイトルを入力してください。"]}};const m="SCN-DRAFT-0427";return n(m),i==null||i.dispatch({type:"SCENARIO_SAVED",scenario:{id:m,title:y.title.trim(),status:"draft",genre:y.genre,updatedAt:"2026-07-23",summary:y.summary,tone:"",lore:"",aiFreedom:y.aiFreedom,heroMode:y.heroMode,heroFreeGenerationAllowed:y.heroFreeGenerationAllowed,hero:y.hero,npcs:y.npcs,opening:y.opening,illustrationStyle:y.illustrationStyle,illustrationMood:y.illustrationMood,illustrationNegative:y.illustrationNegative,sampleScene:y.sampleScene}}),{ok:!0,message:`「${y.title.trim()}」をDraftとして保存しました。ScenarioIdを発行しました。`,value:{scenarioId:m}}},g=async(y,m)=>m==="summary"?{ok:!0,message:"基本情報案を3つ提示しました。採用、編集、破棄を選べます。",value:{message:"基本情報案を3つ提示しました。採用、編集、破棄を選べます。",suggestions:[{id:"summary-1",body:`## 物語の目的

地下に沈んだ王都で、禁書を読むたびに書き換わる星座の謎を追います。

- 水没した書庫を探索する
- 失われる記憶の代償を選ぶ`,rationale:"タイトル、ジャンル、基本情報からMarkdown案を生成しました。"}]}}:m==="illustration-style"?{ok:!0,message:"シナリオに合う画風候補を提示しました。",value:{message:"シナリオに合う画風候補を提示しました。",suggestions:[{id:"style-1",body:"銅版画風、影絵、水彩写本。低彩度で星図の金線だけを強調。",rationale:"既存のムードとNG要素に合わせました。"}]}}:m==="illustration-prompt"?{ok:!0,message:"画像生成用プロンプトとネガティブプロンプトを分離して生成しました。",value:{message:"画像生成用プロンプトとネガティブプロンプトを分離して生成しました。",suggestions:[{id:"prompt-1",body:"submerged archive, apprentice librarian, antique star map, copperplate engraving, muted palette",rationale:"プロンプトとNG要素を分離しました。"}],prompt:"submerged archive, apprentice librarian, antique star map, copperplate engraving, muted palette",negativePrompt:y.illustrationNegative}}:{ok:!0,message:"サンプルシーンのプレビューを生成しました。",value:{message:"サンプルシーンのプレビューを生成しました。",suggestions:[],previewText:`[Preview / 保存対象外] ${y.sampleScene} / ${y.illustrationStyle} / ${y.illustrationMood}`}},q=async(y,m)=>{var Q,X;const r=(o==null?void 0:o.objects.find(p=>p.code===m.objectCode))??(o==null?void 0:o.objects[0]),w=(o==null?void 0:o.locations.find(p=>p.code===m.currentLocationCode))??(o==null?void 0:o.locations[0]),v=r?[...r.actions,...r.mixinTypeCodes.flatMap(p=>{var Z;return((Z=o==null?void 0:o.objectTypes.find(Lt=>Lt.code===p))==null?void 0:Z.actions)??[]})].find(p=>p.code===m.actionCode):void 0,z=((Q=m.objects.find(p=>p.objectCode===(r==null?void 0:r.code)))==null?void 0:Q.state)??{},J=m.trigger==="enumerate"?null:{...z,open:!0};return{ok:!0,message:"隔離されたルールエンジンで実行しました。本番データは変更されていません。",value:{snapshot:{schemaVersion:"rule-action-snapshot.v1",snapshotId:"DEBUG-STORY",currentLocation:{id:(w==null?void 0:w.code)??"",code:(w==null?void 0:w.code)??"",name:(w==null?void 0:w.name)??"",description:(w==null?void 0:w.description)??""},objects:r?[{id:r.code,code:r.code,name:r.name,locationId:((X=m.objects.find(p=>p.objectCode===r.code))==null?void 0:X.locationCode)??r.initialLocationCode,isGlobal:r.global,revision:0,state:z}]:[],actions:r&&v?[{objectId:r.code,actionId:v.code,code:v.code,label:v.label,description:v.description,argumentSchema:{},enabled:!0}]:[]},decision:m.trigger==="enumerate"||!r||!v?null:{schemaVersion:"rule-action-decision.v1",objectId:r.code,actionId:v.code,arguments:m.arguments},selectedRuleCode:m.trigger==="enumerate"?null:"open-door-when-closed",appliedEffects:m.trigger==="enumerate"?[]:[{type:"set-state",targetId:r==null?void 0:r.code,path:"state.open",value:!0}],postState:J&&r&&w?{schemaVersion:"rule-post-state.v1",currentLocation:{id:w.code,code:w.code,name:w.name,description:w.description},objects:[{id:r.code,code:r.code,name:r.name,locationId:r.initialLocationCode,isGlobal:r.global,revision:1,state:J}],sessionFlags:m.flags,sessionStateRevision:1}:null,facts:m.trigger==="enumerate"?[]:["西扉が開いた。"],events:[],hints:m.playerInput?["入力から「扉を開ける」が選択されました。"]:[],forbiddenFacts:[]}}};return u.jsx(ft,{account:jt,scenarioId:e,initialValues:o?{...Ht,title:"星喰いの地下図書館",ruleData:structuredClone(o)}:void 0,saving:!1,aiWorking:!1,actions:{saveDraft:s,assist:g,debug:q},onLogout:()=>{}})}function Y(){return u.jsx(K,{})}function Et(){return u.jsx(K,{ruleData:Dt})}function kt(){return u.jsx(K,{ruleData:Ut})}Y.__docgenInfo={description:"",methods:[],displayName:"MockScenarioRegistrationContainer"};Et.__docgenInfo={description:"",methods:[],displayName:"MockScenarioRegistrationWithRuleDataContainer"};kt.__docgenInfo={description:"",methods:[],displayName:"MockWestDoorAuthoringContainer"};const ia={title:"ユーザーストーリー/Scenario registration",component:d,render:()=>u.jsx(d,{initialUrl:"/scenarios/new",initialDb:$("registrationDraft"),scenarioRegistrationContainer:Y}),parameters:{notes:"docs/user-stories/scenario-registration.md の各ユーザーストーリーを、Storybook Interactions の step と expect で操作説明できるアプリ画面にしたものです。"}};function It({initialUrl:o}){const i=Ct.useMemo(()=>{const e=ht();return e.logout(),e},[]);return u.jsx(d,{initialUrl:o,initialDb:$("registrationDraft"),accountApi:i,scenarioRegistrationContainer:Y})}const l=async(o,i)=>{await t.click(await o.findByRole("button",{name:`${i}へ`}))},B={name:"認証: ログイン後にシナリオ作成へ戻る",render:()=>u.jsx(It,{initialUrl:"/scenarios/new"}),play:async({canvasElement:o,step:i})=>{const e=c(o);await i("未ログインではログイン画面へ移動し、元のURLを保持する",async()=>{await a(await e.findByRole("main",{name:"ログイン"})).toBeVisible(),await a(e.getByTestId("app-url")).toHaveTextContent("/account/login"),await a(e.getByTestId("app-url")).toHaveTextContent("redirect=%2Fscenarios%2Fnew")}),await i("ログインすると元のシナリオ作成画面へ戻る",async()=>{await t.clear(e.getByLabelText("メールアドレス")),await t.type(e.getByLabelText("メールアドレス"),"reader@myriale.example"),await t.type(e.getByTestId("login-password"),"a"),await t.click(e.getByRole("button",{name:"ログインする"})),await a(await e.findByRole("main",{name:"シナリオ登録ウィザード"})).toBeVisible(),await a(e.getByTestId("app-url")).toHaveTextContent("/scenarios/new")})}},x={name:"認証: 戻り先がなければホームへ進む",render:()=>u.jsx(It,{initialUrl:"/account/login"}),play:async({canvasElement:o,step:i})=>{const e=c(o);await i("戻り先なしでログインする",async()=>{await a(await e.findByRole("main",{name:"ログイン"})).toBeVisible(),await t.clear(e.getByLabelText("メールアドレス")),await t.type(e.getByLabelText("メールアドレス"),"reader@myriale.example"),await t.type(e.getByTestId("login-password"),"a"),await t.click(e.getByRole("button",{name:"ログインする"}))}),await i("デフォルトのホーム画面へ移動する",async()=>{await a(await e.findByRole("main",{name:"Myrialeトップページ"})).toBeVisible(),await a(e.getByTestId("app-url")).toHaveTextContent("/")})}},T={name:"US-01: 新しいシナリオを作成したい",play:async({canvasElement:o,step:i})=>{const e=c(o);await i("タイトル未入力では、下書き保存に必要な項目を説明する",async()=>{await t.click(e.getByRole("button",{name:"下書き保存"})),await a(e.getByTestId("scenario-notice")).toHaveTextContent("タイトルを入力すると下書き保存できます。")}),await i("タイトルだけ入力してDraft保存し、ScenarioIdを発行する",async()=>{await t.type(e.getByLabelText("シナリオタイトル"),"星喰いの地下図書館"),await t.click(e.getByRole("button",{name:"下書き保存"})),await a(e.getByTestId("scenario-notice")).toHaveTextContent("Draftとして保存しました"),await a(e.getByText("SCN-DRAFT-0427")).toBeVisible()})}},R={name:"US-02: シナリオのジャンルをタグで指定したい",play:async({canvasElement:o,step:i})=>{const e=c(o);await i("タイトル直下へ複数のジャンルタグを追加し、表紙サマリーへ反映する",async()=>{const n=e.getByLabelText("ジャンルタグを追加");await t.type(n,"ポストアポカリプス{Enter}"),await t.type(n,"巡礼譚"),await t.click(e.getByRole("button",{name:"タグを追加"})),await a(e.getByRole("group",{name:"登録済みジャンルタグ"})).toHaveTextContent("# ポストアポカリプス"),await a(e.getByRole("group",{name:"登録済みジャンルタグ"})).toHaveTextContent("# 巡礼譚"),await a(e.getByRole("complementary",{name:"入力サマリー"})).toHaveTextContent("# ポストアポカリプス # 巡礼譚")}),await i("不要なタグを個別に削除できる",async()=>{await t.click(e.getByRole("button",{name:"巡礼譚タグを削除"})),await a(e.getByRole("group",{name:"登録済みジャンルタグ"})).not.toHaveTextContent("# 巡礼譚")})}},S={name:"US-04: AIの裁量レベルを調整したい",play:async({canvasElement:o,step:i})=>{const e=c(o),n=c(o.ownerDocument.body);await l(e,"基本情報"),await i("AI裁量を高へ変更し、生成時の挙動差を明示する",async()=>{const s=e.getAllByRole("combobox",{name:"AI裁量"})[0];await t.click(s),await t.click(await n.findByRole("option",{name:"高: 展開を広げる"})),await a(s).toHaveTextContent("高: 展開を広げる"),await a(e.getByRole("complementary",{name:"入力サマリー"})).toHaveTextContent("高: 展開を広げる")})}},C={name:"US-05: 初期キャラクター条件を設定したい",play:async({canvasElement:o,step:i})=>{const e=c(o);await l(e,"人物"),await i("主人公の扱いと自由生成時の前提を入力する",async()=>{await a(e.getByRole("combobox",{name:"主人公の扱い"})).toHaveTextContent("自由生成のみ"),await t.clear(e.getByLabelText("主人公の設定")),await t.type(e.getByLabelText("主人公の設定"),"主人公は失踪した師匠を追う新人地図師。名前と年齢はセッション側で自由に決められる。"),a(e.getByLabelText("主人公の設定").value).toContain("新人地図師"),await a(e.getByRole("complementary",{name:"契約の背表紙"})).toHaveTextContent("自由生成")})}},E={name:"US-06: シナリオの開始シーンを定義したい",play:async({canvasElement:o,step:i})=>{const e=c(o);await l(e,"開始状態"),await i("開始シーンを固定し、初回Narrativeの材料にする",async()=>{await t.clear(e.getByLabelText("開始シーン")),await t.type(e.getByLabelText("開始シーン"),"あなたは灰の降る駅で、宛名のない切符を握っている。"),a(e.getByLabelText("開始シーン").value).toContain("灰の降る駅"),await a(e.getByRole("complementary",{name:"契約の背表紙"})).toHaveTextContent("固定")})}},k={name:"US-11: 挿絵のテイストを指定したい",play:async({canvasElement:o,step:i})=>{const e=c(o);c(o.ownerDocument.body),await l(e,"挿絵"),await i("文章と視覚表現を揃える画風を指定する",async()=>{await t.clear(e.getByLabelText("挿絵の画風")),await t.type(e.getByLabelText("挿絵の画風"),"古い天文図の銅版画、インクの滲み、低彩度"),a(e.getByLabelText("挿絵の画風").value).toContain("銅版画")})}},I={name:"US-12: 挿絵の雰囲気を指定したい",play:async({canvasElement:o,step:i})=>{const e=c(o);c(o.ownerDocument.body),await l(e,"挿絵"),await i("挿絵生成に使う感情的トーンを複数指定する",async()=>{await t.clear(e.getByLabelText("挿絵のムード")),await t.type(e.getByLabelText("挿絵のムード"),"孤独、湿度、薄明、遠い鐘の音"),a(e.getByLabelText("挿絵のムード").value).toContain("薄明")})}},L={name:"US-13: 挿絵の禁止要素を指定したい",play:async({canvasElement:o,step:i})=>{const e=c(o);c(o.ownerDocument.body),await l(e,"挿絵"),await i("年齢制限や世界観を守るNG要素を入力する",async()=>{await t.clear(e.getByLabelText("挿絵の禁止要素")),await t.type(e.getByLabelText("挿絵の禁止要素"),"現代兵器、スマートフォン、過度な流血"),a(e.getByLabelText("挿絵の禁止要素").value).toContain("スマートフォン")})}},f={name:"US-14: 挿絵を事前にプレビューしたい",play:async({canvasElement:o,step:i})=>{const e=c(o);c(o.ownerDocument.body),await l(e,"挿絵"),await i("サンプルシーンを入力し、本番相当の挿絵を保存せず生成する",async()=>{await t.clear(e.getByLabelText("サンプルシーン")),await t.type(e.getByLabelText("サンプルシーン"),"地下書庫の水面に星座が反射している。"),await t.click(e.getByRole("button",{name:"サンプルシーンで生成"})),await a(e.getByTestId("illustration-preview")).toHaveTextContent("保存対象外"),await a(e.getByTestId("scenario-notice")).toHaveTextContent("まだ確定していません")})}},H={name:"US-15: プレビューを見ながら挿絵設定を調整したい",play:async({canvasElement:o,step:i})=>{const e=c(o);await l(e,"挿絵"),await i("設定を変更して再生成し、納得した設定のみ保存対象にする",async()=>{await t.clear(e.getByLabelText("挿絵の画風")),await t.type(e.getByLabelText("挿絵の画風"),"影絵、余白多め、灯火だけ金色"),await t.click(e.getByRole("button",{name:"サンプルシーンで生成"})),a(e.getByLabelText("挿絵の画風").value).toContain("影絵"),await a(e.getByTestId("scenario-notice")).toHaveTextContent("設定はまだ確定していません")})}},h={name:"US-17: 登録内容をAIに相談したい",play:async({canvasElement:o,step:i})=>{const e=c(o);await i("AIに相談しても、提案は自動確定しない",async()=>{await t.click(e.getByRole("button",{name:"AIに基本情報案を出してもらう"})),await a(e.getByTestId("ai-suggestion")).toHaveTextContent("基本情報案を3つ提示しました"),await a(e.getByTestId("scenario-notice")).toHaveTextContent("自動確定はしません")})}},A={name:"US-18: どのAIに聞くかを選択したい",play:async({canvasElement:o,step:i})=>{const e=c(o),n=c(o.ownerDocument.body);await l(e,"挿絵"),await i("用途に合わせて相談先AIを選び、選択したAIで提案を生成する",async()=>{await t.click(e.getByRole("combobox",{name:"相談先AI"})),await t.click(await n.findByRole("option",{name:"挿絵AI"})),await t.click(e.getByRole("button",{name:"画風を相談"})),await a(e.getByRole("combobox",{name:"相談先AI"})).toHaveTextContent("挿絵AI"),await a(e.getByTestId("scenario-notice")).toHaveTextContent("挿絵AIに挿絵テイストを相談しました")})}},U={name:"US-19: シナリオの基本情報をAIに補完してもらいたい",play:async({canvasElement:o,step:i})=>{const e=c(o);await i("基本情報候補を見て、採用してからMarkdown本文に入れる",async()=>{await t.click(e.getByRole("button",{name:"AIに基本情報案を出してもらう"})),await t.click(e.getByRole("button",{name:"採用して編集"})),a(e.getByLabelText("基本情報").value).toContain("## 物語の目的"),await a(e.getByTestId("scenario-notice")).toHaveTextContent("採用しました"),await t.click(e.getByRole("button",{name:"プレビュー"})),await a(e.getByRole("article",{name:"基本情報のMarkdownプレビュー"})).toHaveTextContent("水没した書庫を探索する")})}},D={name:"US-21: 挿絵テイストをAIに相談したい",play:async({canvasElement:o,step:i})=>{const e=c(o);await l(e,"挿絵"),await i("シナリオに合う画風候補をAIに提示してもらう",async()=>{await t.click(e.getByRole("button",{name:"画風を相談"})),await a(e.getByTestId("ai-suggestion")).toHaveTextContent("画風候補"),await a(e.getByTestId("ai-suggestion")).toHaveTextContent("銅版画風")})}},j={name:"US-22: 挿絵プロンプトをAIに生成させたい",play:async({canvasElement:o,step:i})=>{const e=c(o);await l(e,"挿絵"),await i("画像生成用プロンプトとネガティブを分離して出力する",async()=>{await t.click(e.getByRole("button",{name:"プロンプトを生成"})),await a(e.getByTestId("ai-suggestion")).toHaveTextContent("ネガティブプロンプト"),await a(e.getByTestId("scenario-notice")).toHaveTextContent("挿絵プロンプトを相談しました")})}},b=()=>u.jsx(d,{initialUrl:"/scenarios/new",initialDb:$("registrationDraft"),scenarioRegistrationContainer:Et}),N={name:"NPC: 人物設定をMarkdownで柔軟に登録する",render:b,play:async({canvasElement:o,step:i})=>{const e=c(o),n=c(o.ownerDocument.body);await l(e,"人物"),await i("NPCを追加して基本情報と初期Locationを設定する",async()=>{await t.click(e.getByRole("button",{name:"NPCを追加"})),await t.clear(n.getByLabelText("NPCのstable code")),await t.type(n.getByLabelText("NPCのstable code"),"archivist-mira"),await t.clear(n.getByLabelText("NPC名")),await t.type(n.getByLabelText("NPC名"),"司書ミラ"),await t.click(n.getByRole("combobox",{name:"NPCの初期Location"})),await t.click(await n.findByRole("option",{name:"星見の階段 / astral-stair"}))}),await i("シナリオ固有の演技指針、知識、秘密をMarkdownで設定する",async()=>{await t.clear(n.getByLabelText("NPCプロフィール")),await t.type(n.getByLabelText("NPCプロフィール"),`## 役割
...
王都が沈んだ本当の原因を知っている。`),await t.click(n.getByRole("button",{name:"編集を完了"}));const s=e.getByRole("table",{name:"NPC一覧"});await a(c(s).getByText("司書ミラ")).toBeVisible(),await a(c(s).getByText("星見の階段")).toBeVisible()})}},V={name:"US-SR16: 作成手順を制作順に把握する",render:b,play:async({canvasElement:o,step:i})=>{const e=c(o),n=c(o.ownerDocument.body);await i("7ステップが制作順に並ぶことを確認する",async()=>{const s=e.getByRole("list",{name:"登録ウィザードのステップ"}),g=c(s).getAllByRole("button").map(q=>q.getAttribute("aria-label"));a(g).toEqual(["基本情報へ","場所へ","人物へ","オブジェクトへ","開始状態へ","挿絵へ","動作確認へ"])}),await i("人物で主人公とNPCを編集できることを確認する",async()=>{await l(e,"人物"),await a(e.getByRole("combobox",{name:"主人公の扱い"})).toBeVisible(),await a(e.getByRole("button",{name:"NPCを追加"})).toBeVisible()}),await i("場所とオブジェクトを別々に編集できることを確認する",async()=>{await l(e,"場所"),await a(e.getByRole("button",{name:"場所を追加"})).toBeVisible(),await a(e.queryByRole("button",{name:"オブジェクトを追加"})).not.toBeInTheDocument(),await l(e,"オブジェクト"),await a(e.getByRole("button",{name:"オブジェクトを追加"})).toBeVisible(),await a(e.queryByRole("button",{name:"場所を追加"})).not.toBeInTheDocument()}),await i("開始状態で開始条件を編集できることを確認する",async()=>{await l(e,"開始状態"),await a(e.getByLabelText("ウィザード進捗")).toHaveTextContent("05開始状態");const s=e.getByRole("table",{name:"全オブジェクトの初期ステート一覧"});await a(c(s).getByRole("columnheader",{name:"オブジェクト"})).toBeVisible(),await a(c(s).getByRole("columnheader",{name:"基準値"})).toBeVisible(),await a(c(s).getByRole("columnheader",{name:"初期値"})).toBeVisible(),await t.click(e.getByRole("combobox",{name:"セッション開始場所"})),await t.click(await n.findByRole("option",{name:"星見の階段 / astral-stair"})),await a(e.getByRole("combobox",{name:"セッション開始場所"})).toHaveTextContent("星見の階段"),await t.click(e.getByRole("combobox",{name:"北書庫の扉の開いている初期値"})),await t.click(await n.findByRole("option",{name:"true"})),await a(c(s).getByText("上書き中")).toBeVisible()})}},O={name:"US-23: Object Typeの状態とアクションを定義したい",play:async({canvasElement:o,step:i})=>{const e=c(o),n=c(o.ownerDocument.body);await l(e,"オブジェクト"),await i("新しい種類へstable code、状態、公開範囲を登録する",async()=>{await t.click(e.getByRole("button",{name:"種類を追加"})),await t.clear(n.getByLabelText("種類のstable code")),await t.type(n.getByLabelText("種類のstable code"),"sealed-door"),await t.clear(n.getByLabelText("種類の表示名")),await t.type(n.getByLabelText("種類の表示名"),"隔壁扉"),await t.click(n.getByRole("button",{name:"状態を追加"})),await t.clear(n.getByLabelText("状態1のstable code")),await t.type(n.getByLabelText("状態1のstable code"),"open"),await a(n.getByRole("combobox",{name:"公開"})).toHaveTextContent("public"),await t.click(n.getByRole("button",{name:"状態の編集を完了"})),await a(n.getByRole("button",{name:"新しい状態を編集"})).toBeVisible()}),await i("AIへ列挙するアクションinterfaceを登録する",async()=>{await t.click(n.getByRole("button",{name:"アクションを追加"})),await t.clear(n.getByLabelText("アクション1のstable code")),await t.type(n.getByLabelText("アクション1のstable code"),"open"),await t.clear(n.getByLabelText("アクション1の表示名")),await t.type(n.getByLabelText("アクション1の表示名"),"扉を開ける"),await a(n.getByRole("combobox",{name:"visibility"})).toHaveTextContent("AI choice")})}},P={name:"US-24: Locationを作成してObjectを初期配置したい",render:b,play:async({canvasElement:o,step:i})=>{const e=c(o),n=c(o.ownerDocument.body);await l(e,"場所"),await i("場所を追加してstable codeを維持する",async()=>{await t.click(e.getByRole("button",{name:"場所を追加"})),await t.clear(n.getByLabelText("場所のstable code")),await t.type(n.getByLabelText("場所のstable code"),"sealed-vault"),await t.clear(n.getByLabelText("場所の表示名")),await t.type(n.getByLabelText("場所の表示名"),"封印書庫"),await t.click(n.getByRole("button",{name:"編集を完了"})),await a(e.getByRole("button",{name:"封印書庫を編集"})).toBeVisible()}),await l(e,"オブジェクト"),await i("Objectの状態を1つの表で確認し、受け継いだ状態は初期値だけ変更する",async()=>{await t.click(e.getByRole("button",{name:"北書庫の扉を編集"})),await a(n.getByRole("region",{name:"ordered Type mixins"})).toHaveTextContent("書庫の扉"),await a(n.getByRole("combobox",{name:"初期配置"})).toHaveTextContent("水没した閲覧室");const s=n.getByRole("table",{name:"Object states"});await a(s).toHaveTextContent("開いている"),await a(s).toHaveTextContent("封印名"),await a(s).not.toHaveTextContent("mixin由来"),await t.click(n.getByRole("button",{name:"openの状態を確認"})),await a(n.queryByLabelText("Object state code")).not.toBeInTheDocument(),await t.type(n.getByLabelText("openの初期値"),"true"),await a(n.getByRole("button",{name:"継承値へ戻す"})).toBeEnabled()})}},F={name:"US-25: 状態とアクションに決定的な結果を設定したい",render:b,play:async({canvasElement:o,step:i})=>{const e=c(o),n=c(o.ownerDocument.body);await l(e,"オブジェクト"),await i("Object paneの統合rule tableで既存adjustのeffective結果を開く",async()=>{await t.click(e.getByRole("button",{name:"北書庫の扉を編集"}));const s=n.getByRole("table",{name:"Object rules"});await a(s).toHaveTextContent("archive-door:generic-open"),await a(s).not.toHaveTextContent("mixin由来"),await t.click(n.getByRole("button",{name:"archive-door:generic-openの実行ルールを確認"}))}),await i("継承condition/priorityと調整済み結果をread-onlyで確認する",async()=>{await a(n.getByText(/override \/ delete \/ adjustを開始することはできません/)).toBeVisible(),await a(n.getAllByText("100")[0]).toBeVisible(),await a(n.getByText("set-state → emit-fact")).toBeVisible(),await a(n.queryByLabelText("実行ルールの優先度")).not.toBeInTheDocument()}),await i("オブジェクト末尾の公開準備チェックが決定性を確認する",async()=>{await a(e.getByTestId("rule-readiness")).toHaveTextContent("決定的です")})}},M={name:"US-26: 参照中の種類と場所を安全に削除したい",render:b,play:async({canvasElement:o,step:i})=>{const e=c(o),n=c(o.ownerDocument.body);await l(e,"オブジェクト"),await i("Objectが参照中の種類は削除を拒否する",async()=>{await t.click(e.getByRole("button",{name:/^書庫の扉を編集$/})),await t.click(n.getByRole("button",{name:"この種類を削除"})),await a(e.getByTestId("scenario-notice")).toHaveTextContent("先に種類を変更するかオブジェクトを削除"),await t.click(n.getByRole("button",{name:"編集ペインを閉じる"}))}),await l(e,"場所"),await i("場所ステップでObjectが配置中のLocationも削除を拒否する",async()=>{await t.click(e.getByRole("button",{name:"水没した閲覧室を編集"})),await t.click(n.getByRole("button",{name:"この場所を削除"})),await a(e.getByTestId("scenario-notice")).toHaveTextContent("開始場所に選ばれています")})}},G={name:"US-27: 既存mutationを保持してDraft保存したい",render:b,play:async({canvasElement:o,step:i})=>{const e=c(o),n=c(o.ownerDocument.body);await l(e,"オブジェクト"),await i("既存adjust operationはeffective結果だけをread-onlyで表示する",async()=>{await t.click(e.getByRole("button",{name:"北書庫の扉を編集"})),await t.click(n.getByRole("button",{name:"archive-door:generic-openの実行ルールを確認"})),await a(n.queryByLabelText("実行ルールの優先度")).not.toBeInTheDocument(),await a(n.getByText(/既存の変更内容は保存時もそのまま保持されます/)).toBeVisible(),await t.click(n.getByRole("button",{name:"閉じる"})),await t.click(n.getByRole("button",{name:"編集を完了"}))}),await i("既存mutationを変更せず下書き保存できる",async()=>{await t.click(e.getByRole("button",{name:"下書き保存"})),await a(e.getByTestId("scenario-notice")).toHaveTextContent("Draftとして保存しました")})}},W={name:"US-SR12: 任意状態からルールエンジンを動作確認する",render:b,play:async({canvasElement:o,step:i})=>{const e=c(o);await l(e,"動作確認"),await i("全状態を上書きして公開状態と利用可能アクションを確認する",async()=>{const n=e.getAllByLabelText(/のstate$/)[0];await t.clear(n),await t.click(n),await t.paste('{"open":false}'),await t.click(e.getByRole("button",{name:"公開状態とアクションを確認"})),await a(e.getByRole("complementary",{name:"デバッグ実行結果"})).toHaveTextContent("扉を開ける")}),await i("アクションを直接発動してselected ruleとpost-stateを確認する",async()=>{await t.click(e.getByRole("button",{name:"アクションを直接発動"})),await a(e.getByText(/open-door-when-closed/)).toBeVisible(),await a(e.getByTestId("debug-post-state")).toHaveTextContent('"open": true')}),await i("ユーザー入力から選ばれるアクションと物語材料を確認する",async()=>{await t.type(e.getByLabelText("デバッグ用ユーザー入力"),"扉をゆっくり開ける"),await t.click(e.getByRole("button",{name:"入力から起きることを確認"})),await a(e.getByRole("complementary",{name:"デバッグ実行結果"})).toHaveTextContent("入力から「扉を開ける」が選択されました。"),await a(e.getByTestId("debug-notice")).toHaveTextContent("本番データは変更されていません")})}},_={name:"西の扉seed: 統合テーブルで契約と結果を編集・保存する",render:()=>u.jsx(d,{initialUrl:"/scenarios/new",initialDb:$("registrationDraft"),scenarioRegistrationContainer:kt}),play:async({canvasElement:o,step:i})=>{const e=c(o),n=c(o.ownerDocument.body);await l(e,"オブジェクト"),await t.click(e.getByRole("button",{name:"西の扉を編集"})),await i("ordered mixinを維持しながら状態・アクション・ruleを各1つの表で表示する",async()=>{const s=n.getByRole("region",{name:"ordered Type mixins"});await a(s).toHaveTextContent("開閉可能"),await a(s).toHaveTextContent("出口の扉"),await a(n.getByRole("table",{name:"Object states"})).toHaveTextContent("開いている"),await a(n.getByRole("table",{name:"Object states"})).toHaveTextContent("方向"),await a(n.getByRole("table",{name:"Object actions"})).toHaveTextContent("出口を確認する"),await a(n.getByRole("table",{name:"Object rules"})).toHaveTextContent("exit-door:generic-open-and-exit"),await a(n.getByRole("table",{name:"Object rules"})).toHaveTextContent("local:west-inspect-exit")}),await i("受け継いだ状態は初期値だけ、Objectのアクションとadd ruleは編集できる",async()=>{await t.click(n.getByRole("button",{name:"openの状態を確認"})),await t.type(n.getByLabelText("openの初期値"),"true"),await t.click(n.getByRole("button",{name:"閉じる"})),await t.click(n.getByRole("button",{name:"inspect-exitのアクションを確認"})),await t.clear(n.getByLabelText("Object action label")),await t.type(n.getByLabelText("Object action label"),"出口を詳しく確認する"),await t.click(n.getByRole("button",{name:"閉じる"})),await t.click(n.getByRole("button",{name:"local:west-inspect-exitの実行ルールを確認"}));const s=n.getByRole("table",{name:"実行条件 table"});await a(s).toHaveTextContent("状態：direction ＝"),await t.click(c(s).getByRole("button",{name:"ルートの実行条件を編集"}));const g=n.getByRole("dialog",{name:"実行条件を編集"});await a(g).toHaveAttribute("data-layer","2"),await t.click(c(g).getByRole("combobox",{name:"実行条件の条件種別"})),await t.click(await n.findByRole("option",{name:"すべて成立（AND）"})),await t.click(c(g).getByRole("button",{name:"子条件を追加"})),await t.click(c(g).getByRole("button",{name:"実行条件の編集を完了"})),await a(s).toHaveTextContent("すべて成立（AND）"),await a(s).toHaveTextContent("AND 2"),await t.clear(n.getByLabelText("実行ルールの優先度")),await t.type(n.getByLabelText("実行ルールの優先度"),"95"),await t.click(n.getByRole("button",{name:"閉じる"}))}),await i("既存overrideはread-onlyのままeffective 8 effectを保持する",async()=>{await t.click(n.getByRole("button",{name:"exit-door:generic-open-and-exitの実行ルールを確認"})),await a(n.getByText("set-state → move-session → emit-fact → emit-fact → emit-event → add-narrative-hint → forbid-narrative-fact → forbid-narrative-fact")).toBeVisible(),await a(n.queryByLabelText("実行ルールの優先度")).not.toBeInTheDocument(),await t.click(n.getByRole("button",{name:"閉じる"}))}),await i("編集内容と既存mutationを下書き保存する",async()=>{await t.click(n.getByRole("button",{name:"編集を完了"})),await a(e.getByTestId("rule-readiness")).toHaveTextContent("決定的です"),await t.click(e.getByRole("button",{name:"下書き保存"})),await a(e.getByTestId("scenario-notice")).toHaveTextContent("Draftとして保存しました")})}};var ee,te,ae;B.parameters={...B.parameters,docs:{...(ee=B.parameters)==null?void 0:ee.docs,source:{originalSource:`{
...
}`,...(ue=(pe=S.parameters)==null?void 0:pe.docs)==null?void 0:ue.source}}};var ge,ve,be;C.parameters={...C.parameters,docs:{...(ge=C.parameters)==null?void 0:ge.docs,source:{originalSource:`{
...
}`,...(be=(ve=C.parameters)==null?void 0:ve.docs)==null?void 0:be.source}}};var de,Be,xe;E.parameters={...E.parameters,docs:{...(de=E.parameters)==null?void 0:de.docs,source:{originalSource:`{
...
}`,...(xe=(Be=E.parameters)==null?void 0:Be.docs)==null?void 0:xe.source}}};var Te,Re,Se;k.parameters={...k.parameters,docs:{...(Te=k.parameters)==null?void 0:Te.docs,source:{originalSource:`{
...
}`,...(Se=(Re=k.parameters)==null?void 0:Re.docs)==null?void 0:Se.source}}};var Ce,Ee,ke;I.parameters={...I.parameters,docs:{...(Ce=I.parameters)==null?void 0:Ce.docs,source:{originalSource:`{
...
}`,...(ke=(Ee=I.parameters)==null?void 0:Ee.docs)==null?void 0:ke.source}}};var Ie,Le,fe;L.parameters={...L.parameters,docs:{...(Ie=L.parameters)==null?void 0:Ie.docs,source:{originalSource:`{
...
}`,...(fe=(Le=L.parameters)==null?void 0:Le.docs)==null?void 0:fe.source}}};var He,he,Ae;f.parameters={...f.parameters,docs:{...(He=f.parameters)==null?void 0:He.docs,source:{originalSource:`{
...
}`,...(Ae=(he=f.parameters)==null?void 0:he.docs)==null?void 0:Ae.source}}};var Ue,De,je;H.parameters={...H.parameters,docs:{...(Ue=H.parameters)==null?void 0:Ue.docs,source:{originalSource:`{
...
}`,...(je=(De=H.parameters)==null?void 0:De.docs)==null?void 0:je.source}}};var Ne,Ve,Oe;h.parameters={...h.parameters,docs:{...(Ne=h.parameters)==null?void 0:Ne.docs,source:{originalSource:`{
...
}`,...(Oe=(Ve=h.parameters)==null?void 0:Ve.docs)==null?void 0:Oe.source}}};var Pe,Fe,Me;A.parameters={...A.parameters,docs:{...(Pe=A.parameters)==null?void 0:Pe.docs,source:{originalSource:`{
...
}`,...(Me=(Fe=A.parameters)==null?void 0:Fe.docs)==null?void 0:Me.source}}};var Ge,We,_e;U.parameters={...U.parameters,docs:{...(Ge=U.parameters)==null?void 0:Ge.docs,source:{originalSource:`{
...
}`,...(Je=(ze=j.parameters)==null?void 0:ze.docs)==null?void 0:Je.source}}};var Qe,Xe,Ze;N.parameters={...N.parameters,docs:{...(Qe=N.parameters)==null?void 0:Qe.docs,source:{originalSource:`{
...
}`,...(Ze=(Xe=N.parameters)==null?void 0:Xe.docs)==null?void 0:Ze.source}}};var et,tt,at;V.parameters={...V.parameters,docs:{...(et=V.parameters)==null?void 0:et.docs,source:{originalSource:`{
...
}`,...(at=(tt=V.parameters)==null?void 0:tt.docs)==null?void 0:at.source}}};var nt,ot,it;O.parameters={...O.parameters,docs:{...(nt=O.parameters)==null?void 0:nt.docs,source:{originalSource:`{
...
}`,...(it=(ot=O.parameters)==null?void 0:ot.docs)==null?void 0:it.source}}};var ct,st,rt;P.parameters={...P.parameters,docs:{...(ct=P.parameters)==null?void 0:ct.docs,source:{originalSource:`{
...
}`,...(rt=(st=P.parameters)==null?void 0:st.docs)==null?void 0:rt.source}}};var lt,yt,mt;F.parameters={...F.parameters,docs:{...(lt=F.parameters)==null?void 0:lt.docs,source:{originalSource:`{
...
}`,...(mt=(yt=F.parameters)==null?void 0:yt.docs)==null?void 0:mt.source}}};var wt,pt,ut;M.parameters={...M.parameters,docs:{...(wt=M.parameters)==null?void 0:wt.docs,source:{originalSource:`{
...
}`,...(ut=(pt=M.parameters)==null?void 0:pt.docs)==null?void 0:ut.source}}};var gt,vt,bt;G.parameters={...G.parameters,docs:{...(gt=G.parameters)==null?void 0:gt.docs,source:{originalSource:`{
...
}`,...(St=(Rt=_.parameters)==null?void 0:Rt.docs)==null?void 0:St.source}}};const ca=["AuthenticationReturnsToScenarioCreation","AuthenticationDefaultsToHome","US01CreateDraftScenario","US02SpecifyGenreTag","US04TuneAiFreedom","US05SetInitialCharacter","US06DefineOpeningScene","US11SpecifyIllustrationStyle","US12SpecifyIllustrationMood","US13SpecifyNegativeElements","US14PreviewIllustration","US15IterateIllustrationSettings","US17ConsultAiAboutRegistration","US18SelectAiByPurpose","US19AiCompletesSummary","US21ConsultIllustrationTaste","US22GenerateIllustrationPrompt","ConfigureNpcSettings","ConfigureInitialSceneFromWorldData","US23DefineObjectTypeStatesAndActions","US24CreateLocationsAndPlaceObjects","US25AuthorDeterministicActionResults","US26KeepDependenciesSafe","US27SaveIncompleteRuleDataAsDraft","US12DebugRuleEngineFromArbitraryState","AuthorWestDoorSeedWithEightOrderedEffects"];export{x as AuthenticationDefaultsToHome,B as AuthenticationReturnsToScenarioCreation,_ as AuthorWestDoorSeedWithEightOrderedEffects,V as ConfigureInitialSceneFromWorldData,N as ConfigureNpcSettings,T as US01CreateDraftScenario,R as US02SpecifyGenreTag,S as US04TuneAiFreedom,C as US05SetInitialCharacter,E as US06DefineOpeningScene,k as US11SpecifyIllustrationStyle,W as US12DebugRuleEngineFromArbitraryState,I as US12SpecifyIllustrationMood,L as US13SpecifyNegativeElements,f as US14PreviewIllustration,H as US15IterateIllustrationSettings,h as US17ConsultAiAboutRegistration,A as US18SelectAiByPurpose,U as US19AiCompletesSummary,D as US21ConsultIllustrationTaste,j as US22GenerateIllustrationPrompt,O as US23DefineObjectTypeStatesAndActions,P as US24CreateLocationsAndPlaceObjects,F as US25AuthorDeterministicActionResults,M as US26KeepDependenciesSafe,G as US27SaveIncompleteRuleDataAsDraft,ca as __namedExportsOrder,ia as default};
