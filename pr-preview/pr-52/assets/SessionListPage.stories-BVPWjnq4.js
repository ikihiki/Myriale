...
}`,...(L=(f=m.parameters)==null?void 0:f.docs)==null?void 0:L.source}}};const Q=["進行中の物語を開く","完了済みの物語を表示する","完了済みだけでも新規開始できる","セッションがない","読み込み失敗から再試行する"];export{Q as __namedExportsOrder,M as default,l as セッションがない,r as 完了済みだけでも新規開始できる,c as 完了済みの物語を表示する,m as 読み込み失敗から再試行する,i as 進行中の物語を開く};
