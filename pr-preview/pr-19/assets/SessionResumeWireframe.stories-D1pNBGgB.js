import{j as $}from"./jsx-runtime-BO8uF4Og.js";import{w as s,e as t,u as R}from"./index-C3Z0PGzo.js";import{M as T,c as M}from"./MyrialeApp-CV5q6ybp.js";import{S}from"./AppChrome-BUEzUgbw.js";/* empty css               */import"./index-D4H_InIO.js";import"./MyrialeToggle-Cwz5lpBR.js";import"./index-DzKAYa42.js";import"./WizardNavigation-_WVmaYVB.js";import"./SessionTurn-CnU6KSUh.js";import"./account-DB4a6SL9.js";import"./MyrialeMenu-Ck7b4kC6.js";const se={title:"ユーザーストーリー/Session resume",component:T,render:()=>$.jsx(T,{initialUrl:"/sessions/SES-PREP-1098/resume",initialDb:M("resumableSession")}),parameters:{notes:"docs/user-stories/session-resume.md の各ユーザーストーリー（US-R01〜R08）を、Storybook Interactions の step と expect で操作説明できるワイヤーフレームにしたものです。"}},o="星喰いの地下図書館",q="灰の駅と宛名のない切符",i=async(n,a)=>{await R.click(n.getByRole("button",{name:`${a}を再開`}))},r={name:"US-R01: 中断したセッションを再開したい",play:async({canvasElement:n,step:a})=>{const e=s(n);await a("中断中のSession一覧が表示され、Suspended状態であることが分かる",async()=>{await t(e.getByRole("region",{name:"中断中のセッション"})).toBeVisible(),await t(e.getByTestId("session-list")).toHaveTextContent(o),await t(e.getByTestId("session-state")).toHaveTextContent("Suspended")}),await a("Sessionを選ぶと、最終状態から再開できることが示される",async()=>{await i(e,o),await t(e.getByTestId("resume-notice")).toHaveTextContent("最終状態（Turn 6）から続きを遊べます"),await t(e.getByRole("region",{name:"再開前の確認"})).toBeVisible(),await t(e.getByTestId("summary-scenario")).toHaveTextContent(o)})}},y={name:"US-R02: 再開前に前回のあらすじを確認したい",play:async({canvasElement:n,step:a})=>{const e=s(n);await i(e,o),await a("AI要約された「これまでのあらすじ」が表示される",async()=>{await t(e.getByTestId("recap")).toHaveTextContent("これまでのあらすじ（AI要約）"),await t(e.getByTestId("recap")).toHaveTextContent("水没した閲覧室で目覚め、銀の鍵")})}},p={name:"US-R03: セッションの進行度を確認したい",play:async({canvasElement:n,step:a})=>{const e=s(n);await i(e,o),await a("ターン数とプレイ時間が進行度として表示される",async()=>{await t(e.getByTestId("progress")).toHaveTextContent("Turn 6"),await t(e.getByTestId("progress")).toHaveTextContent("3時間12分"),await t(e.getByTestId("summary-progress")).toHaveTextContent("Turn 6 / 3時間12分")})}},l={name:"US-R04: AIが文脈を理解した状態で再開したい",play:async({canvasElement:n,step:a})=>{const e=s(n);await i(e,o),await a("再開時に復元されるAIコンテキストの内訳が示される",async()=>{await t(e.getByTestId("context")).toHaveTextContent("復元されるAIコンテキスト"),await t(e.getByTestId("context")).toHaveTextContent("Lorebook Canon"),await t(e.getByTestId("context")).toHaveTextContent("Session State（現在地: 螺旋階段の踊り場")})}},m={name:"US-R05: 再開前に注意点を確認したい",play:async({canvasElement:n,step:a})=>{const e=s(n);await i(e,o),await a("中断中に起きたScenario / AI設定の変更点が明示される",async()=>{await t(e.getByTestId("changes")).toHaveTextContent("Scenario変更"),await t(e.getByTestId("changes")).toHaveTextContent("AI設定変更")}),await a("変更がないSessionでは「変更はありません」と示される",async()=>{await R.click(e.getByRole("button",{name:`${q} を選択`})),await t(e.getByTestId("changes")).toHaveTextContent("変更はありません")})}},d={name:"US-R06: 確認後にセッションを再開したい",play:async({canvasElement:n,step:a})=>{const e=s(n);await i(e,o),await a("確認後の再開は、Session play dialogue（プレイ画面）への導線として用意される",async()=>{const c=e.getByRole("button",{name:"確認したので再開する（プレイ画面へ）"});await t(c).toBeVisible(),await t(S.playSession).toContain("session-play-dialogue")})}},w={name:"US-R07: 再開直後に直前の内容を確認したい",play:async({canvasElement:n,step:a})=>{const e=s(n);await i(e,o),await a("再開前確認で、復元される全Turnのうち直前のNarrativeが何かを把握できる",async()=>{await t(e.getByTestId("recap")).toHaveTextContent("螺旋階段の先で星図灯の在処を探している")}),await a("再開直後の直前ターンの続きは、遷移先の Session play dialogue で確認できる",async()=>{await t(e.getByRole("button",{name:"確認したので再開する（プレイ画面へ）"})).toBeVisible(),await t(S.playSession).toContain("session-play-dialogue")})}},v={name:"US-R08: 再開せずに閲覧だけしたい",play:async({canvasElement:n,step:a})=>{const e=s(n);await i(e,o),await a("「再開せずに読み返す」でReadOnlyモードに入り、状態はSuspendedのまま",async()=>{await R.click(e.getByRole("button",{name:"再開せずに読み返す（ReadOnly）"})),await t(e.getByRole("region",{name:"ReadOnly閲覧"})).toBeVisible(),await t(e.getByTestId("session-state")).toHaveTextContent("Suspended (ReadOnly)"),await t(e.getByTestId("readonly-note")).toHaveTextContent("選択肢や入力は無効")}),await a("ReadOnlyでも全Turn（最初から直前まで）を読み返せる",async()=>{const c=e.getByTestId("restored-log");await t(s(c).getByTestId("restored-turn-1")).toHaveTextContent("水没した閲覧室で目を覚ます"),await t(s(c).getByTestId("restored-turn-6")).toHaveTextContent("螺旋階段の踊り場で星図灯がひとつ灯り")}),await a("ReadOnlyからでも、あらためてプレイ画面へ再開できる",async()=>{await t(e.getByRole("button",{name:"読み返したので再開する（プレイ画面へ）"})).toBeVisible(),await t(S.playSession).toContain("session-play-dialogue")})}};var g,u,B;r.parameters={...r.parameters,docs:{...(g=r.parameters)==null?void 0:g.docs,source:{originalSource:`{
...
}`,...(B=(u=r.parameters)==null?void 0:u.docs)==null?void 0:B.source}}};var x,I,C;y.parameters={...y.parameters,docs:{...(x=y.parameters)==null?void 0:x.docs,source:{originalSource:`{
...
}`,...(C=(I=y.parameters)==null?void 0:I.docs)==null?void 0:C.source}}};var A,H,U;p.parameters={...p.parameters,docs:{...(A=p.parameters)==null?void 0:A.docs,source:{originalSource:`{
...
}`,...(U=(H=p.parameters)==null?void 0:H.docs)==null?void 0:U.source}}};var b,L,h;l.parameters={...l.parameters,docs:{...(b=l.parameters)==null?void 0:b.docs,source:{originalSource:`{
...
}`,...(h=(L=l.parameters)==null?void 0:L.docs)==null?void 0:h.source}}};var E,O,_;m.parameters={...m.parameters,docs:{...(E=m.parameters)==null?void 0:E.docs,source:{originalSource:`{
...
}`,...(_=(O=m.parameters)==null?void 0:O.docs)==null?void 0:_.source}}};var Y,V,f;d.parameters={...d.parameters,docs:{...(Y=d.parameters)==null?void 0:Y.docs,source:{originalSource:`{
...
}`,...(f=(V=d.parameters)==null?void 0:V.docs)==null?void 0:f.source}}};var F,N,k;w.parameters={...w.parameters,docs:{...(F=w.parameters)==null?void 0:F.docs,source:{originalSource:`{
...
}`,...(j=(P=v.parameters)==null?void 0:P.docs)==null?void 0:j.source}}};const oe=["USR01ResumeFromLastState","USR02ReviewRecapBeforeResume","USR03ShowProgress","USR04RestoreAiContext","USR05ShowChangeNotices","USR06ConfirmAndResume","USR07ReviewLastNarrativeAfterResume","USR08ReadOnlyReview"];export{r as USR01ResumeFromLastState,y as USR02ReviewRecapBeforeResume,p as USR03ShowProgress,l as USR04RestoreAiContext,m as USR05ShowChangeNotices,d as USR06ConfirmAndResume,w as USR07ReviewLastNarrativeAfterResume,v as USR08ReadOnlyReview,oe as __namedExportsOrder,se as default};
