import{j as I}from"./jsx-runtime-BO8uF4Og.js";import{w as o,u as s,e as t}from"./index-C4S39nCK.js";import{M as C,c as ue}from"./MyrialeApp-CMgHBGj0.js";import{M as re}from"./MockSessionContainer-Bi67SG8k.js";/* empty css               */import"./index-D4H_InIO.js";import"./AppChrome-Cb-Bi4JU.js";import"./Surfaces-CQIJcDfy.js";import"./navigationRecipes-DkSbwkz5.js";import"./MyrialeToggle-BLjquTkO.js";import"./index-DzKAYa42.js";import"./MyrialeMenu-C73OeBTK.js";import"./SessionIcons-yGOCmQwo.js";import"./SessionTurn-E1lLWSiL.js";import"./scenarioWizardStyles-BLXZEqRf.js";import"./SessionActivityFeed-k-tuuoLr.js";import"./account-D2w1pibX.js";import"./ModuleUiHost-Dq6FqUxM.js";const le=()=>{const n=ue("activeSession");return{...n,playSessions:{...n.playSessions,"SES-PREP-1098":{...n.playSessions["SES-PREP-1098"],turn:12,summary:"複数ターン経過後のアプリ画面確認用ログ。"}}}},ke={title:"ユーザーストーリー/Session play dialogue",component:C,render:()=>I.jsx(C,{initialUrl:"/sessions/SES-PREP-1098",initialDb:le(),sessionContainer:re}),parameters:{notes:"docs/user-stories/session-play-dialogue-user-stories.md の各ユーザーストーリーを、Storybook Interactions の step と expect で操作説明できるアプリ画面にしたものです。"}},c=async(n,a)=>{const e=n.getByLabelText("自由に行動や会話を入力");await s.clear(e),await s.type(e,a),await s.click(n.getByRole("button",{name:"行動を送る"}))},r={name:"US-P01: AIが現在の状況を語ってほしい",play:async({canvasElement:n,step:a})=>{const e=o(n);await a("ActiveなSessionの開始時に、現在地・周囲・直近の出来事をNarrativeとして表示する",async()=>{await t(e.getByTestId("session-state")).toHaveTextContent("Active"),await t(e.getByTestId("turn-1-narrative")).toHaveTextContent("水没した閲覧室"),await t(e.getByTestId("turn-1-narrative")).toHaveTextContent("銀の鍵"),await t(e.getByTestId("dialogue-notice")).toHaveTextContent("現在地、周囲、直近の出来事")})}},l={name:"US-P02/P03: 自然言語で行動を入力し、結果を物語として受け取る",play:async({canvasElement:n,step:a})=>{const e=o(n);await a("自由入力欄に自然な文章で行動を書く",async()=>{await s.type(e.getByLabelText("自由に行動や会話を入力"),"周囲を警戒しながら閲覧室を出る"),await t(e.getByLabelText("自由に行動や会話を入力")).toHaveValue("周囲を警戒しながら閲覧室を出る")}),await a("送信すると行動として解釈され、成功・想定外の展開を含むNarrativeが生成される",async()=>{await s.click(e.getByRole("button",{name:"行動を送る"})),await t(e.getByTestId("dialogue-log")).toHaveTextContent("プレイヤーの入力: 周囲を警戒しながら閲覧室を出る"),await t(e.getByTestId("dialogue-log")).toHaveTextContent("想定外の痕跡"),await t(e.getByTestId("dialogue-notice")).toHaveTextContent("結果をNarrativeとして生成")})}},y={name:"Composer: Shift+Enterで改行し、Enterで送信する",play:async({canvasElement:n,step:a})=>{const e=o(n),i=e.getByLabelText("自由に行動や会話を入力");await a("Shift+Enterは送信せず改行する",async()=>{await s.type(i,"一行目"),await s.keyboard("{Shift>}{Enter}{/Shift}二行目"),await t(i).toHaveValue(`一行目
二行目`),await t(e.getByTestId("dialogue-log")).not.toHaveTextContent("プレイヤーの入力: 一行目")}),await a("Enterは入力を送信し、composerを空に戻す",async()=>{await s.keyboard("{Enter}"),await t(e.getByTestId("dialogue-log")).toHaveTextContent("プレイヤーの入力: 一行目 二行目"),await t(i).toHaveValue("")})}},u={name:"Composer: 送信ボタンの二重clickでTurnを重複作成しない",render:()=>I.jsx(C,{initialUrl:"/sessions/SES-PREP-1098",initialDb:le(),sessionContainer:({sessionId:n})=>I.jsx(re,{sessionId:n,submissionDelayMs:25})}),play:async({canvasElement:n,step:a})=>{const e=o(n),i=e.getByLabelText("自由に行動や会話を入力");await s.type(i,"二重送信されないことを確認する"),await a("送信ボタンを素早く二重clickしても、最初の送信中に再送しない",async()=>{await s.dblClick(e.getByRole("button",{name:"行動を送る"}));const ye=await e.findByRole("article",{name:"Turn 13"});await t(ye).toHaveTextContent("プレイヤーの入力: 二重送信されないことを確認する"),await t(e.queryByRole("article",{name:"Turn 14"})).not.toBeInTheDocument()})}},v={name:"US-P04: NPCと自然に会話したい",play:async({canvasElement:n,step:a})=>{const e=o(n);await a("NPCへの発話を自由入力で送る",async()=>{await c(e,"書架の奥にいる人物に「あなたは誰？」と尋ねる")}),await a("NPCの立場・関係性に沿った返答がNarrativeに入り、会話内容が文脈に残る",async()=>{await t(e.getByTestId("dialogue-log")).toHaveTextContent("書架の奥の人物"),await t(e.getByTestId("dialogue-log")).toHaveTextContent("会話内容はセッション文脈に記録")})}},p={name:"US-P05: AIに補足説明や再説明を求めたい",play:async({canvasElement:n,step:a})=>{const e=o(n);await a("補足説明ボタンから「今の状況を簡単にまとめて」を送る",async()=>{await s.click(e.getByRole("button",{name:"状況を簡単にまとめて聞く"})),await t(e.getByTestId("dialogue-log")).toHaveTextContent("補足説明")}),await a("補足要求は行動扱いにせず、物語進行やSession状態を変化させない",async()=>{await t(e.getByTestId("dialogue-notice")).toHaveTextContent("行動ではない"),await t(e.getByTestId("session-state")).toHaveTextContent("Active"),await t(e.getByTestId("active-turn-summary")).toHaveTextContent("物語状態は変化しない")})}},m={name:"US-P05B: AIに次の行動案を推薦してほしい",play:async({canvasElement:n,step:a})=>{const e=o(n);await a("AI推薦ボタンを押すと、現在の状況に沿った行動案が入力欄へ入る",async()=>{await s.click(e.getByRole("button",{name:"AIに次の行動を提案してもらう"})),await t(e.getByLabelText("自由に行動や会話を入力")).toHaveValue("銀の鍵を扉にかざし、刻まれた星座との対応を確かめる"),await t(e.getByTestId("dialogue-notice")).toHaveTextContent("内容を編集してから送信できます")})}},w={name:"US-P06: 自分の入力がどう解釈されたか知りたい",play:async({canvasElement:n,step:a})=>{const e=o(n);await c(e,"酒場の奥にいる人物に話しかける"),await a("解釈トグルはPlayer Inputの直下にあり、押すと内部解釈を表示する",async()=>{await s.click(e.getByRole("button",{name:"Turn 13の入力解釈を見る"})),await t(e.getByTestId("turn-13-interpretation")).toHaveTextContent("NPCへの会話として解釈"),await t(e.queryByText("入力直下に内部解釈を表示しました。意図とのズレがあれば、削除・やり直しできます。")).not.toBeInTheDocument()}),await a("もう一度押すと解釈を隠せる",async()=>{await s.click(e.getByRole("button",{name:"Turn 13の入力解釈を隠す"})),await t(e.queryByTestId("turn-13-interpretation")).not.toBeInTheDocument()})}},T={name:"US-P07: 未送信の入力を取り消したい",play:async({canvasElement:n,step:a})=>{const e=o(n);await a("未送信の入力は削除ボタンで取り消せる",async()=>{await s.type(e.getByLabelText("自由に行動や会話を入力"),"入力ミス"),await s.click(e.getByRole("button",{name:"入力を消去"})),await t(e.getByLabelText("自由に行動や会話を入力")).toHaveValue(""),await t(e.getByTestId("dialogue-notice")).toHaveTextContent("入力欄の未送信テキストを無効化"),await t(e.queryByRole("button",{name:"直前のターンに戻る"})).not.toBeInTheDocument()})}},g={name:"US-P08/P10: 対話だけで進み、AIは入力を待つ",play:async({canvasElement:n,step:a})=>{const e=o(n);await a("Narrative → Input → Narrativeのループが、明示的な「次へ」なしで続く",async()=>{await c(e,"銀の鍵を掲げて反応を見る"),await c(e,"反応した書架へ近づく"),await t(e.getByTestId("dialogue-log")).toHaveTextContent("プレイヤーの入力: 反応した書架へ近づく")}),await a("AIは重要な進行を勝手に進めず、次のPlayer Inputを待つ",async()=>{await t(e.getByTestId("dialogue-notice")).toHaveTextContent("次の重要な進行は入力待ち")})}},d={name:"US-P09: 見出しリンク（TOC）から対話ログを振り返りたい",play:async({canvasElement:n,step:a})=>{const e=o(n);await a("多数のTurnに対して、TOCはTurn一覧ではなくAIが考えた場面見出しを表示する",async()=>{await t(e.getByRole("complementary",{name:"AI見出しリンクTOC"})).toHaveTextContent("目覚めと銀の鍵"),await t(e.getByRole("complementary",{name:"AI見出しリンクTOC"})).toHaveTextContent("濡れた書架の声"),await t(e.getByRole("complementary",{name:"AI見出しリンクTOC"})).toHaveTextContent("螺旋階段と星図灯"),await t(e.getByRole("complementary",{name:"AI見出しリンクTOC"})).toHaveTextContent("閉じた星座の扉"),await t(e.getByRole("article",{name:"Turn 12"})).toBeVisible()}),await a("TOCの末尾は常に最後のTurn（Turn 12）を指す見出しになっている",async()=>{await t(e.getByTestId("heading-link-12")).toHaveTextContent("Turn 12から")}),await a("AI見出しを選ぶと、その見出しが始まる切り替わりTurnへジャンプする",async()=>{await s.click(e.getByRole("button",{name:"見出し「螺旋階段と星図灯」へ（Turn 08から）"})),await t(e.getByTestId("dialogue-notice")).toHaveTextContent("場面の切り替わりTurn 08へジャンプ"),await t(e.getByTestId("active-turn-summary")).toHaveTextContent("08 / 螺旋階段へ向かう"),await t(e.getByTestId("active-heading-summary")).toHaveTextContent("螺旋階段と星図灯（Turn 08から）"),await t(e.getByTestId("session-state")).toHaveTextContent("Active")}),await a("末尾の見出しを選ぶと、最後のTurnへジャンプして選択表示される",async()=>{await s.click(e.getByTestId("heading-link-12")),await t(e.getByTestId("active-turn-summary")).toHaveTextContent("12 / 入力待ちの静止点"),await t(e.getByRole("article",{name:"Turn 12"})).toHaveClass("session-turn selected")})}},B={name:"US-P10/Notes: セッション中いつでもノートを参照・編集したい",play:async({canvasElement:n,step:a})=>{const e=o(n);await a("プレイ画面のサイドでノートを素早く確認・編集できる",async()=>{await t(e.getByRole("button",{name:/^全画面表示$/})).toBeVisible(),await t(e.getByRole("slider",{name:"ノート表示比率"})).toBeVisible(),await t(e.getByTestId("session-notes-side")).toHaveTextContent("月読ミナト"),await s.click(o(e.getByTestId("session-notes-side")).getByRole("button",{name:"月読ミナトを編集"})),await t(e.getByRole("dialog",{name:"ノート編集"})).toBeVisible(),await t(e.getByTestId("note-edit-dialog")).toHaveAttribute("data-size","editor"),await t(e.getByTestId("app-db-summary")).toHaveTextContent("open person-minato"),await s.clear(e.getByLabelText("別名")),await s.type(e.getByLabelText("別名"),"水際の案内人"),await s.click(e.getAllByRole("button",{name:"閉じる"})[0]),await t(e.queryByRole("dialog",{name:"ノート編集"})).not.toBeInTheDocument()}),await a("全画面で集中編集に切り替えても、一覧・編集・Context・整合性を1画面で操作できる",async()=>{await s.click(e.getByRole("button",{name:/^全画面表示$/})),await t(e.getByTestId("session-notes-focus")).toBeVisible(),await t(e.getByTestId("session-notes-full")).toHaveTextContent("月読ミナト"),await t(e.getByTestId("app-db-summary")).toHaveTextContent("notes full"),await s.click(o(e.getByTestId("session-notes-full")).getByRole("button",{name:"場所追加"})),await t(e.getByRole("dialog",{name:"ノート編集"})).toHaveTextContent("地下天文台"),await s.click(e.getByRole("button",{name:"閉じる"})),await s.click(o(e.getByTestId("session-notes-full")).getByRole("button",{name:"Context再構築"})),await t(o(e.getByTestId("session-notes-full")).getByTestId("context-stack")).toHaveTextContent("次ターンContext")})}},x={name:"US-P11: 「ここまで戻る」で任意の過去ターンまで巻き戻したい",play:async({canvasElement:n,step:a})=>{const e=o(n);await c(e,"書架の奥にいる人物に話しかける"),await c(e,"銀の鍵を水面に沈めてみる"),await a("過去Turnの「ここまで戻る」を押すと確認ダイアログを表示する",async()=>{const i=o(e.getByRole("article",{name:"Turn 01"}));await s.click(i.getByRole("button",{name:"ここまで戻る"})),await t(e.getByRole("dialog",{name:"巻き戻し確認"})).toBeVisible(),await t(e.getByTestId("rewind-dialog")).toHaveTextContent("非同期処理を無効化"),await t(e.getByTestId("rewind-dialog")).toHaveAttribute("data-tone","warning")}),await a("確定すると指定ターン以降を無効化し、巻き戻し地点から再入力できる",async()=>{await s.click(e.getByRole("button",{name:"巻き戻しを確定"})),await t(e.getByTestId("dialogue-log")).not.toHaveTextContent("銀の鍵を水面に沈めてみる"),await t(e.getByTestId("dialogue-notice")).toHaveTextContent("AIコンテキストを再構築"),await t(e.getByLabelText("自由に行動や会話を入力")).toBeVisible()})}};var b,H,S;r.parameters={...r.parameters,docs:{...(b=r.parameters)==null?void 0:b.docs,source:{originalSource:`{
...
}`,...(S=(H=r.parameters)==null?void 0:H.docs)==null?void 0:S.source}}};var P,R,E;l.parameters={...l.parameters,docs:{...(P=l.parameters)==null?void 0:P.docs,source:{originalSource:`{
...
}`,...(h=(k=y.parameters)==null?void 0:k.docs)==null?void 0:h.source}}};var U,N,f;u.parameters={...u.parameters,docs:{...(U=u.parameters)==null?void 0:U.docs,source:{originalSource:`{
...
}`,...(f=(N=u.parameters)==null?void 0:N.docs)==null?void 0:f.source}}};var D,L,V;v.parameters={...v.parameters,docs:{...(D=v.parameters)==null?void 0:D.docs,source:{originalSource:`{
...
}`,...(M=(q=p.parameters)==null?void 0:q.docs)==null?void 0:M.source}}};var F,W,j;m.parameters={...m.parameters,docs:{...(F=m.parameters)==null?void 0:F.docs,source:{originalSource:`{
...
}`,...(j=(W=m.parameters)==null?void 0:W.docs)==null?void 0:j.source}}};var $,z,K;w.parameters={...w.parameters,docs:{...($=w.parameters)==null?void 0:$.docs,source:{originalSource:`{
...
}`,...(K=(z=w.parameters)==null?void 0:z.docs)==null?void 0:K.source}}};var _,G,J;T.parameters={...T.parameters,docs:{...(_=T.parameters)==null?void 0:_.docs,source:{originalSource:`{
...
}`,...(J=(G=T.parameters)==null?void 0:G.docs)==null?void 0:J.source}}};var Q,X,Y;g.parameters={...g.parameters,docs:{...(Q=g.parameters)==null?void 0:Q.docs,source:{originalSource:`{
...
}`,...(Y=(X=g.parameters)==null?void 0:X.docs)==null?void 0:Y.source}}};var Z,ee,te;d.parameters={...d.parameters,docs:{...(Z=d.parameters)==null?void 0:Z.docs,source:{originalSource:`{
...
}`,...(te=(ee=d.parameters)==null?void 0:ee.docs)==null?void 0:te.source}}};var ae,ne,se;B.parameters={...B.parameters,docs:{...(ae=B.parameters)==null?void 0:ae.docs,source:{originalSource:`{
...
}`,...(ce=(ie=x.parameters)==null?void 0:ie.docs)==null?void 0:ce.source}}};const he=["USP01CurrentSituationNarrative","USP02AndP03NaturalInputToNarrativeResult","ComposerKeyboardBehavior","ComposerDoubleClickCreatesOneTurn","USP04TalkWithNpcNaturally","USP05AskClarificationWithoutProgress","USP05BRecommendNextAction","USP06ShowInputInterpretation","USP07DeleteDraftInput","USP08AndP10ContinuousLoopWaitsForInput","USP09ReviewLogFromToc","USP10NotesAlwaysAvailableSideAndFull","USP11RewindToAnyPastTurn"];export{u as ComposerDoubleClickCreatesOneTurn,y as ComposerKeyboardBehavior,r as USP01CurrentSituationNarrative,l as USP02AndP03NaturalInputToNarrativeResult,v as USP04TalkWithNpcNaturally,p as USP05AskClarificationWithoutProgress,m as USP05BRecommendNextAction,w as USP06ShowInputInterpretation,T as USP07DeleteDraftInput,g as USP08AndP10ContinuousLoopWaitsForInput,d as USP09ReviewLogFromToc,B as USP10NotesAlwaysAvailableSideAndFull,x as USP11RewindToAnyPastTurn,he as __namedExportsOrder,ke as default};
