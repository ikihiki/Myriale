import{j as Ve}from"./jsx-runtime-BO8uF4Og.js";import{w as s,u as a,e as n}from"./index-DwFX8Wt9.js";import{M as x,c as he}from"./MyrialeApp-CjxqFrI0.js";import"./account-BfLs3ao6.js";import"./index-D4H_InIO.js";import"./MyrialeToggle-Cu4mkWU9.js";import"./index-DzKAYa42.js";import"./AppChrome-BVb5UrEk.js";import"./MyrialeMenu-FzkaUt8s.js";import"./ModuleUiHost-Bo0AQgho.js";import"./WizardNavigation-_WVmaYVB.js";import"./SessionTurn-Cr0_jd5t.js";const xe={register:"/account/register","verify-email":"/account/register?view=verify-email",login:"/account/login",reset:"/account/reset-password",oauth:"/account/oauth",profile:"/account/profile","profile-edit":"/account/profile/edit",security:"/account/security",export:"/account/export",withdraw:"/account/withdraw","admin-list":"/account/admin/users","admin-detail":"/account/admin/users/USR-1088","admin-ai-keys":"/account/admin/ai-keys",audit:"/account/admin/audit-log"},De={title:"ユーザーストーリー/User management",component:x,render:t=>Ve.jsx(x,{initialUrl:xe[t.initialView??"register"],initialDb:he("adminUsers")}),parameters:{layout:"fullscreen",notes:"ユーザー管理Markdown要件は変更せず、Storybook story/play function としてユーザー導線を表現します。"}},r={name:"US-UM01: 新規登録したい（メール/パスワード）",args:{initialView:"register"},play:async({canvasElement:t,step:i})=>{const e=s(t);await i("要件未満のパスワードは拒否される",async()=>{await a.type(e.getByLabelText("表示名"),"新しい旅人"),await a.type(e.getByLabelText("メールアドレス"),"new-reader@example.com"),await a.type(e.getByTestId("register-password"),"short"),await a.click(e.getByRole("button",{name:"登録する"})),await n(e.getByTestId("um-notice")).toHaveTextContent("要件を満たしていません")}),await i("要件を満たすとUserIdが発行されプロフィールへ進む",async()=>{await a.clear(e.getByTestId("register-password")),await a.type(e.getByTestId("register-password"),"letters1"),await a.type(e.getByLabelText("パスワード（確認）"),"letters1"),await a.click(e.getByRole("button",{name:"登録する"})),await n(e.getByRole("region",{name:"プロフィール"})).toBeVisible(),await n(e.getByTestId("issued-user-id")).toHaveTextContent("USR-2F9A")})}},o={name:"US-UM02: メール確認をしたい（Phase 2）",args:{initialView:"verify-email"}},c={name:"US-UM03: ログインしたい（メール/パスワード）",args:{initialView:"login"},play:async({canvasElement:t,step:i})=>{const e=s(t);await i("Identity cookieセッションを開始しプロフィールへ進む",async()=>{await a.clear(e.getByLabelText("メールアドレス")),await a.type(e.getByLabelText("メールアドレス"),"reader@myriale.example"),await a.type(e.getByTestId("login-password"),"mist-library-2026"),await a.click(e.getByRole("button",{name:"ログインする"})),await n(e.getByRole("region",{name:"プロフィール"})).toBeVisible()})}},m={name:"US-UM04: ログアウトしたい",args:{initialView:"profile"},play:async({canvasElement:t,step:i})=>{const e=s(t);await i("ログアウトでログイン画面へ戻る",async()=>{await a.click(await e.findByRole("button",{name:"ログアウト"})),await n(e.getByRole("main",{name:"ログイン"})).toBeVisible()})}},l={name:"US-UM05: パスワードを再設定したい",args:{initialView:"reset"}},p={name:"US-UM06: OAuthでサインインしたい（Phase 2）",args:{initialView:"oauth"}},d={name:"US-UM07: 外部アカウントを連携したい（Phase 2）",args:{initialView:"security"}},u={name:"US-UM08: プロフィールを確認したい",args:{initialView:"profile"}},w={name:"US-UM09: プロフィールを編集したい",args:{initialView:"profile-edit"}},g={name:"US-UM10: データを書き出したい（Phase 3）",args:{initialView:"export"}},y={name:"US-UM11: 退会したい",args:{initialView:"withdraw"}},U={name:"US-UM12: セキュリティ設定を管理したい（Phase 3）",args:{initialView:"security"}},v={name:"US-UM13: 管理者としてユーザー一覧を見たい（Phase 2）",args:{initialView:"admin-list"}},M={name:"US-UM14: 管理者としてユーザー詳細を操作したい（Phase 2）",args:{initialView:"admin-detail"}},S={name:"US-UM15: サポート調査したい（Phase 3）",args:{initialView:"admin-list"}},B={name:"US-UM16: 監査ログを確認したい（Phase 3）",args:{initialView:"audit"}},V={name:"Admin: AI Provider管理",args:{initialView:"admin-ai-keys"},play:async({canvasElement:t,step:i})=>{const e=s(t);await i("Vault設定済みのRunpodを確認し、接続テストを行う",async()=>{await n(await e.findByRole("region",{name:"AIキー管理"})).toBeVisible();const h=await e.findByTestId("ai-key-row-runpod");await n(h).toHaveTextContent("Vault / 環境変数"),await n(h).toHaveTextContent("使用中"),await a.click(s(h).getByRole("button",{name:"接続テスト"})),await n(await e.findByTestId("ai-key-notice")).toHaveTextContent("接続テストに成功")})}};var T,E,f;r.parameters={...r.parameters,docs:{...(T=r.parameters)==null?void 0:T.docs,source:{originalSource:`{
...
}`,...(f=(E=r.parameters)==null?void 0:E.docs)==null?void 0:f.source}}};var b,R,k;o.parameters={...o.parameters,docs:{...(b=o.parameters)==null?void 0:b.docs,source:{originalSource:`{
  name: 'US-UM02: メール確認をしたい（Phase 2）',
  args: {
    initialView: 'verify-email'
  }
}`,...(k=(R=o.parameters)==null?void 0:R.docs)==null?void 0:k.source}}};var I,P,A;c.parameters={...c.parameters,docs:{...(I=c.parameters)==null?void 0:I.docs,source:{originalSource:`{
...
}`,...(A=(P=c.parameters)==null?void 0:P.docs)==null?void 0:A.source}}};var L,C,H;m.parameters={...m.parameters,docs:{...(L=m.parameters)==null?void 0:L.docs,source:{originalSource:`{
