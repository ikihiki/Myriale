import{j as i}from"./jsx-runtime-BO8uF4Og.js";import{w as s,u as a,e as t,a as _}from"./index-C4S39nCK.js";import{A as G,M as d}from"./MyrialeApp-n7SBJ_aq.js";import{c as B}from"./SessionPresentation-BBjAi6R_.js";import{r as Y}from"./index-D4H_InIO.js";/* empty css               */import"./AdminAiProvidersPage-CGqZLbiA.js";import"./Surfaces-hfywbPiG.js";import"./AppChrome-CaJxHzCb.js";import"./navigationRecipes-DkSbwkz5.js";import"./MyrialeToggle-DBs-w9aD.js";import"./index-DzKAYa42.js";import"./MyrialeMenu-d7jVExt_.js";import"./ConditionTablePresentation-JmdLPG0b.js";import"./EditPane-DyZaeiBP.js";import"./scenarioWizardStyles-CPcslTFI.js";import"./NarrativeBody-4Kg13oE8.js";import"./ModuleUiHost-CQPmid6l.js";import"./TurnInspectionPresentation-CerC6ryl.js";import"./account-Bdcpq1bL.js";import"./SessionListPresentation-CV3LYKA6.js";import"./SessionIcons-yGOCmQwo.js";import"./SessionTurn-UcBTXClw.js";import"./SessionActivityFeed-B0l1fOng.js";const g=[{id:"story-openai",displayName:"Story OpenAI",model:"gpt-story-mini",revision:4,credentialRevision:2},{id:"story-local",displayName:"Story Local",model:"qwen-story-8b",revision:7,credentialRevision:5},{id:"runpod-llm",displayName:"LLM（Deckard 40B GGUF）",model:"DavidAU/Qwen3.6-40B-Claude-4.6-Opus-Deckard-Heretic-Uncensored-Thinking-NEO-CODE-Di-IMatrix-MAX-GGUF",revision:0,credentialRevision:0}],$={"story-openai":"扉の向こうには、止まった星時計と青い観測記録が静かに並んでいます。","story-local":"古いドームの隙間から月光が差し、中央の望遠鏡だけがゆっくり北を向きます。","runpod-llm":"星時計の針が淡く発光し、閉ざされていた観測窓がゆっくりと夜空へ開きます。"};function R(o){const n=g.find(e=>e.id===o);return{provider:o,model:n.model,responseId:`response-${o}`,requestId:`request-${o}`,inputTokens:48,outputTokens:24,latencyMilliseconds:o==="story-openai"?180:o==="story-local"?320:640,attemptCount:1,finishReason:"stop"}}function F({scenario:o="success"}){const n=Y.useRef(0),e=async c=>{if(n.current+=1,o==="provider-error-once"&&n.current===2)return{ok:!1,message:"Providerが一時的に利用できません。すべての会話と生成済み応答を保持したまま再試行できます。"};if(o==="revision-conflict")return{ok:!1,message:"AI ProfileまたはCredentialが更新されました。最新情報を再読み込みしたため、内容を確認して再実行してください。",action:"reload"};const m=c;return{ok:!0,message:"次のassistant応答を生成しました。",value:{message:{role:"assistant",content:$[m]},metadata:R(m)}}},J=async(c,m,T)=>{g.find(U=>U.id===c);const b=`# Scenario
...
状態変更を描写する前に \`preview_rule_action\` を呼び出す。`;return{ok:!0,message:"本番Session由来のchatで応答を生成しました。Rule tool preview: 1件。",value:{message:{role:"assistant",content:`西の扉のルールを確認しました。${T}`},metadata:R(c),sentMessages:[{role:"system",content:b},{role:"user",content:"西の扉を調べる"},{role:"assistant",content:"扉には星形の鍵穴があります。"},{role:"user",content:T}],systemMarkdown:b,toolPreviews:[{toolCallId:"tool-story-1",selectionCode:"object:west-door/open",arguments:{},status:"valid",appliedEffects:[{type:"set",targetId:"west-door",path:"open",value:!0}],postState:{currentLocation:"observatory",objects:[]},facts:["西の扉が開いた"],events:[],narrativeHints:["星時計の光を描写する"],forbiddenNarrativeFacts:[],extensionRequested:!1}]}}};return i.jsx(G,{account:{name:"運用管理者",email:"admin@myriale.example",initials:"運管",role:"AI管理者"},state:{status:"ready",profiles:g,defaultProfileId:g[0].id,document:null,documentRevision:null,sessions:[{id:"SES-STORY-1",label:"星喰いの図書館 · 旅人 · 12 turns",status:"active"}]},actions:{generate:e,generateSessionChat:J,save:async()=>({ok:!0,message:"PlaygroundをDBへ保存しました。"}),retry:()=>{},logout:()=>{}}})}F.__docgenInfo={description:"",methods:[],displayName:"MockAiPlaygroundContainer",props:{scenario:{required:!1,tsType:{name:"union",raw:"'success' | 'provider-error-once' | 'revision-conflict'",elements:[{name:"literal",value:"'success'"},{name:"literal",value:"'provider-error-once'"},{name:"literal",value:"'revision-conflict'"}]},description:"",defaultValue:{value:"'success'",computed:!1}}}};const x=o=>()=>i.jsx(F,{scenario:o}),Be={title:"ユーザーストーリー/AI Conversation Playground",component:d,render:()=>i.jsx(d,{initialUrl:"/admin/ai-playground",initialDb:B("empty"),aiPlaygroundContainer:x("success")})};async function w(o,n){const e=o.getByLabelText("選択中の会話名");await a.clear(e),await a.type(e,n)}const r={name:"複数の会話コンテキストと応答を独立して管理する",play:async({canvasElement:o,step:n})=>{const e=s(o);await n("最初の会話を命名し、OpenAI Profileで応答を生成する",async()=>{await t(e.getByRole("main",{name:"AI Conversation Playground"})).toBeVisible(),await w(e,"天文台"),await _(()=>t(e.getByTestId("ai-playground-save-status")).toHaveTextContent("DBへ保存済み")),await a.click(e.getByRole("button",{name:"次のassistant応答を生成"})),await t(e.getByTestId("ai-playground-response-count")).toHaveTextContent("1件の応答"),await t(e.getByTestId("ai-playground-response-detail")).toHaveTextContent("扉の向こうには")}),await n("2つ目の会話を作り、別Profileから異なる応答セットを生成する",async()=>{await a.click(e.getByRole("button",{name:"新しい会話"})),await w(e,"月面基地"),await a.selectOptions(e.getByLabelText("AI Profile"),"story-local"),await a.click(e.getByRole("button",{name:"次のassistant応答を生成"})),await a.selectOptions(e.getByLabelText("AI Profile"),"runpod-llm"),await a.click(e.getByRole("button",{name:"次のassistant応答を生成"})),await t(e.getByTestId("ai-playground-response-count")).toHaveTextContent("2件の応答"),await t(e.getByTestId("ai-playground-response-detail")).toHaveTextContent("星時計の針")}),await n("切り替えると最初の会話のProfile・応答・選択が復元される",async()=>{await a.click(e.getByRole("button",{name:"天文台を選択"})),await t(e.getByLabelText("AI Profile")).toHaveValue("story-openai"),await t(e.getByTestId("ai-playground-response-count")).toHaveTextContent("1件の応答"),await t(e.getByTestId("ai-playground-response-detail")).toHaveTextContent("扉の向こうには")}),await n("選択した応答だけを現在の会話へ追加する",async()=>{await a.click(e.getByRole("button",{name:"選択した応答を会話へ追加"})),await t(e.getByLabelText("3番目のmessage content")).toHaveValue("扉の向こうには、止まった星時計と青い観測記録が静かに並んでいます。"),await a.click(e.getByRole("button",{name:"月面基地を選択"})),await t(e.queryByLabelText("3番目のmessage content")).not.toBeInTheDocument(),await t(e.getByTestId("ai-playground-response-count")).toHaveTextContent("2件の応答")}),await n("複製後の応答削除は元の会話へ影響しない",async()=>{await a.click(e.getByRole("button",{name:"天文台を選択"})),await a.click(e.getByRole("button",{name:"現在の会話を複製"})),await t(e.getByLabelText("選択中の会話名")).toHaveValue("天文台 copy"),await t(e.getByTestId("ai-playground-response-count")).toHaveTextContent("1件の応答"),await a.click(e.getByRole("button",{name:"応答 1を削除"})),await t(e.getByTestId("ai-playground-response-count")).toHaveTextContent("0件の応答"),await a.click(e.getByRole("button",{name:"天文台を選択"})),await t(e.getByTestId("ai-playground-response-count")).toHaveTextContent("1件の応答"),await t(e.getByLabelText("3番目のmessage content")).toBeVisible()}),await n("現在の会話を削除すると隣の会話へ安全にフォールバックする",async()=>{await a.click(e.getByRole("button",{name:"天文台を削除"})),await t(e.getByLabelText("選択中の会話名")).toHaveValue("月面基地"),await t(e.getByTestId("ai-playground-response-count")).toHaveTextContent("2件の応答")})}},l={name:"本番Sessionをchat形式とrule tool previewで検証する",play:async({canvasElement:o,step:n})=>{const e=s(o);await n("Session由来のchat + toolsモードを選ぶ",async()=>{await a.click(e.getByRole("button",{name:"Session + tools"})),await t(e.getByLabelText("Source Session")).toHaveValue("SES-STORY-1"),await a.type(e.getByLabelText("Session chat user message"),"西の扉を開ける")}),await n("system Markdownと直近chatを使ってtool previewを実行する",async()=>{await a.click(e.getByRole("button",{name:"次のassistant応答を生成"})),await t(e.getByTestId("ai-playground-response-detail")).toHaveTextContent("西の扉のルールを確認しました。"),await a.click(e.getByText("Session chat payload / rule tool previews")),await t(e.getByText("Sent chat messages (4)")).toBeVisible(),await t(e.getByText("System Markdown")).toBeVisible(),await t(e.getByText("object:west-door/open")).toBeVisible()})}},y={name:"会話内で応答の選択・個別削除・全消去を管理する",play:async({canvasElement:o,step:n})=>{const e=s(o);await n("3つのProfileから応答候補を生成する",async()=>{await a.click(e.getByRole("button",{name:"次のassistant応答を生成"})),await a.selectOptions(e.getByLabelText("AI Profile"),"story-local"),await a.click(e.getByRole("button",{name:"次のassistant応答を生成"})),await a.selectOptions(e.getByLabelText("AI Profile"),"runpod-llm"),await a.click(e.getByRole("button",{name:"次のassistant応答を生成"})),await t(e.getByTestId("ai-playground-response-count")).toHaveTextContent("3件の応答")}),await n("古い応答を選ぶと本文とmetadataが切り替わる",async()=>{await a.click(e.getByRole("button",{name:"応答 1を選択"})),await t(e.getByTestId("ai-playground-response-detail")).toHaveTextContent("扉の向こうには"),await t(e.getByTestId("ai-playground-response-detail")).toHaveTextContent("gpt-story-mini")}),await n("個別削除と全消去は現在の会話だけに適用される",async()=>{await a.click(e.getByRole("button",{name:"応答 2を削除"})),await t(e.getByTestId("ai-playground-response-count")).toHaveTextContent("2件の応答"),await a.click(e.getByRole("button",{name:"応答をすべて消去"})),await t(e.getByTestId("ai-playground-response-count")).toHaveTextContent("0件の応答"),await t(e.getByLabelText("2番目のmessage content")).toBeVisible()})}},p={render:()=>i.jsx(d,{initialUrl:"/admin/ai-playground",initialDb:B("empty"),aiPlaygroundContainer:x("provider-error-once")}),play:async({canvasElement:o,step:n})=>{const e=s(o);await n("最初の会話に成功した応答を保持する",async()=>{await w(e,"成功済み"),await a.click(e.getByRole("button",{name:"次のassistant応答を生成"})),await t(e.getByTestId("ai-playground-response-count")).toHaveTextContent("1件の応答")}),await n("別会話のProvider errorでも両方の会話が残る",async()=>{await a.click(e.getByRole("button",{name:"新しい会話"})),await w(e,"再試行対象"),await a.selectOptions(e.getByLabelText("AI Profile"),"story-local"),await a.click(e.getByRole("button",{name:"次のassistant応答を生成"})),await t(e.getByRole("alert")).toHaveTextContent("すべての会話"),await t(e.getByTestId("ai-playground-response-count")).toHaveTextContent("0件の応答"),await t(e.getByLabelText("2番目のmessage content")).toHaveValue("古い天文台の扉を開けます。中の様子を教えてください。"),await a.click(e.getByRole("button",{name:"成功済みを選択"})),await t(e.getByTestId("ai-playground-response-count")).toHaveTextContent("1件の応答"),await t(e.getByTestId("ai-playground-response-detail")).toHaveTextContent("扉の向こうには")}),await n("失敗した会話へ戻って再試行できる",async()=>{await a.click(e.getByRole("button",{name:"再試行対象を選択"})),await t(e.getByLabelText("AI Profile")).toHaveValue("story-local"),await a.click(e.getByRole("button",{name:"次のassistant応答を生成"})),await t(e.getByTestId("ai-playground-response-count")).toHaveTextContent("1件の応答"),await t(e.getByTestId("ai-playground-response-detail")).toHaveTextContent("古いドーム")})}},u={play:async({canvasElement:o,step:n})=>{const e=s(o);await n("壊れたJSONを拒否して現在の履歴を残す",async()=>{await a.click(e.getByText("JSON import / export")),await a.click(e.getByLabelText("会話履歴import JSON")),await a.paste("{broken"),await a.click(e.getByRole("button",{name:"JSONを読み込む"})),await t(e.getByRole("alert")).toHaveTextContent("変更されていません"),await t(e.getByLabelText("2番目のmessage content")).toHaveValue("古い天文台の扉を開けます。中の様子を教えてください。")}),await n("空履歴では生成できない",async()=>{await a.click(e.getByRole("button",{name:"会話を全消去"})),await t(e.getByRole("button",{name:"次のassistant応答を生成"})).toBeDisabled(),await t(e.getByText(/会話履歴は空です/)).toBeVisible()})}},v={render:()=>i.jsx(d,{initialUrl:"/admin/ai-playground",initialDb:B("empty"),aiPlaygroundContainer:x("revision-conflict")}),play:async({canvasElement:o,step:n})=>{const e=s(o);await n("revision conflictを安全な再読込案内として表示する",async()=>{await a.click(e.getByRole("button",{name:"次のassistant応答を生成"})),await t(e.getByRole("alert")).toHaveTextContent("最新情報を再読み込み"),await t(e.getByLabelText("2番目のmessage content")).toHaveValue("古い天文台の扉を開けます。中の様子を教えてください。")})}};var C,k,I;r.parameters={...r.parameters,docs:{...(C=r.parameters)==null?void 0:C.docs,source:{originalSource:`{
...
}`,...(I=(k=r.parameters)==null?void 0:k.docs)==null?void 0:I.source}}};var H,E,f;l.parameters={...l.parameters,docs:{...(H=l.parameters)==null?void 0:H.docs,source:{originalSource:`{
  ...
  play: async ({
    ...
    await step('Session由来のchat + toolsモードを選ぶ', async () => {
      ...
      await expect(canvas.getByLabelText('Source Session')).toHaveValue('SES-STORY-1');
      await userEvent.type(canvas.getByLabelText('Session chat user message'), '西の扉を開ける');
    });
...
}`,...(f=(E=l.parameters)==null?void 0:E.docs)==null?void 0:f.source}}};var S,P,L;y.parameters={...y.parameters,docs:{...(S=y.parameters)==null?void 0:S.docs,source:{originalSource:`{
...
}`,...(L=(P=y.parameters)==null?void 0:P.docs)==null?void 0:L.source}}};var A,V,h;p.parameters={...p.parameters,docs:{...(A=p.parameters)==null?void 0:A.docs,source:{originalSource:`{
...
}`,...(h=(V=p.parameters)==null?void 0:V.docs)==null?void 0:h.source}}};var O,D,M;u.parameters={...u.parameters,docs:{...(O=u.parameters)==null?void 0:O.docs,source:{originalSource:`{
  play: async ({
    canvasElement,
    step
  }) => {
...
}`,...(M=(D=u.parameters)==null?void 0:D.docs)==null?void 0:M.source}}};var N,j,q;v.parameters={...v.parameters,docs:{...(N=v.parameters)==null?void 0:N.docs,source:{originalSource:`{
...
}`,...(q=(j=v.parameters)==null?void 0:j.docs)==null?void 0:q.source}}};const xe=["ManageIndependentConversations","SessionChatWithRuleTools","ResponseSelectionAndClearing","ProviderErrorPreservesAllConversations","InvalidImportAndEmptyHistory","RevisionConflictRequestsReview"];export{u as InvalidImportAndEmptyHistory,r as ManageIndependentConversations,p as ProviderErrorPreservesAllConversations,y as ResponseSelectionAndClearing,v as RevisionConflictRequestsReview,l as SessionChatWithRuleTools,xe as __namedExportsOrder,Be as default};
