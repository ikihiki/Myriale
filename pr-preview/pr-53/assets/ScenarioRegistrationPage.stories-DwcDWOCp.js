import{j as y}from"./jsx-runtime-BO8uF4Og.js";import{r as tt}from"./index-D4H_InIO.js";import{w as c,e as n,u as t}from"./index-C4S39nCK.js";import{S as ct,e as st,M as p,c as rt}from"./MyrialeApp-DN4FiUYH.js";import{u as lt,c as O}from"./SessionPresentation-BW1NmtPe.js";import{w as yt,c as mt}from"./scenarioRegistrationFixtures-N_446tyL.js";/* empty css               */import"./AppChrome-DR5p-0yD.js";import"./Surfaces-xpIMDkG0.js";import"./navigationRecipes-DkSbwkz5.js";import"./MyrialeToggle-DCXJQOk6.js";import"./index-DzKAYa42.js";import"./MyrialeMenu-Bp2y9ciA.js";import"./scenarioWizardStyles-DbrtSybi.js";import"./EditPane-BQJklamt.js";import"./ModuleUiHost-CoZk1x5n.js";import"./account-BBd-Y9vp.js";import"./SessionListPresentation-CnxO8zIR.js";import"./SessionIcons-yGOCmQwo.js";import"./SessionTurn-9KUaF1pl.js";import"./SessionActivityFeed-Cizm6efh.js";const pt={name:"霧野しおり",email:"author@myriale.example",initials:"霧野",role:"作者"};function F({ruleData:i}){const o=lt(),[e,a]=tt.useState("未発行"),l=async s=>{if(!s.title.trim())return{ok:!1,message:"タイトルを入力すると下書き保存できます。",fieldErrors:{title:["シナリオタイトルを入力してください。"]}};const m="SCN-DRAFT-0427";return a(m),o==null||o.dispatch({type:"SCENARIO_SAVED",scenario:{id:m,title:s.title.trim(),status:"draft",genre:s.genre,updatedAt:"2026-07-23",summary:s.summary,tone:"",lore:"",aiFreedom:s.aiFreedom,heroMode:s.heroMode,heroFreeGenerationAllowed:s.heroFreeGenerationAllowed,hero:s.hero,opening:s.opening,illustrationStyle:s.illustrationStyle,illustrationMood:s.illustrationMood,illustrationNegative:s.illustrationNegative,sampleScene:s.sampleScene}}),{ok:!0,message:`「${s.title.trim()}」をDraftとして保存しました。ScenarioIdを発行しました。`,value:{scenarioId:m}}},it=async(s,m)=>m==="summary"?{ok:!0,message:"基本情報案を3つ提示しました。採用、編集、破棄を選べます。",value:{message:"基本情報案を3つ提示しました。採用、編集、破棄を選べます。",suggestions:[{id:"summary-1",body:`## 物語の目的

地下に沈んだ王都で、禁書を読むたびに書き換わる星座の謎を追います。

- 水没した書庫を探索する
- 失われる記憶の代償を選ぶ`,rationale:"タイトル、ジャンル、基本情報からMarkdown案を生成しました。"}]}}:m==="illustration-style"?{ok:!0,message:"シナリオに合う画風候補を提示しました。",value:{message:"シナリオに合う画風候補を提示しました。",suggestions:[{id:"style-1",body:"銅版画風、影絵、水彩写本。低彩度で星図の金線だけを強調。",rationale:"既存のムードとNG要素に合わせました。"}]}}:m==="illustration-prompt"?{ok:!0,message:"画像生成用プロンプトとネガティブプロンプトを分離して生成しました。",value:{message:"画像生成用プロンプトとネガティブプロンプトを分離して生成しました。",suggestions:[{id:"prompt-1",body:"submerged archive, apprentice librarian, antique star map, copperplate engraving, muted palette",rationale:"プロンプトとNG要素を分離しました。"}],prompt:"submerged archive, apprentice librarian, antique star map, copperplate engraving, muted palette",negativePrompt:s.illustrationNegative}}:{ok:!0,message:"サンプルシーンのプレビューを生成しました。",value:{message:"サンプルシーンのプレビューを生成しました。",suggestions:[],previewText:`[Preview / 保存対象外] ${s.sampleScene} / ${s.illustrationStyle} / ${s.illustrationMood}`}};return y.jsx(ct,{account:pt,scenarioId:e,initialValues:i?{...st,title:"星喰いの地下図書館",ruleData:structuredClone(i)}:void 0,saving:!1,aiWorking:!1,actions:{saveDraft:l,assist:it},onLogout:()=>{}})}function V(){return y.jsx(F,{})}function at(){return y.jsx(F,{ruleData:mt})}function nt(){return y.jsx(F,{ruleData:yt})}V.__docgenInfo={description:"",methods:[],displayName:"MockScenarioRegistrationContainer"};at.__docgenInfo={description:"",methods:[],displayName:"MockScenarioRegistrationWithRuleDataContainer"};nt.__docgenInfo={description:"",methods:[],displayName:"MockWestDoorAuthoringContainer"};const ht={title:"ユーザーストーリー/Scenario registration",component:p,render:()=>y.jsx(p,{initialUrl:"/scenarios/new",initialDb:O("registrationDraft"),scenarioRegistrationContainer:V}),parameters:{notes:"docs/user-stories/scenario-registration.md の各ユーザーストーリーを、Storybook Interactions の step と expect で操作説明できるアプリ画面にしたものです。"}};function ot({initialUrl:i}){const o=tt.useMemo(()=>{const e=rt();return e.logout(),e},[]);return y.jsx(p,{initialUrl:i,initialDb:O("registrationDraft"),accountApi:o,scenarioRegistrationContainer:V})}const r=async(i,o)=>{await t.click(await i.findByRole("button",{name:`${o}へ`}))},w={name:"認証: ログイン後にシナリオ作成へ戻る",render:()=>y.jsx(ot,{initialUrl:"/scenarios/new"}),play:async({canvasElement:i,step:o})=>{const e=c(i);await o("未ログインではログイン画面へ移動し、元のURLを保持する",async()=>{await n(await e.findByRole("main",{name:"ログイン"})).toBeVisible(),await n(e.getByTestId("app-url")).toHaveTextContent("/account/login"),await n(e.getByTestId("app-url")).toHaveTextContent("redirect=%2Fscenarios%2Fnew")}),await o("ログインすると元のシナリオ作成画面へ戻る",async()=>{await t.clear(e.getByLabelText("メールアドレス")),await t.type(e.getByLabelText("メールアドレス"),"reader@myriale.example"),await t.type(e.getByTestId("login-password"),"a"),await t.click(e.getByRole("button",{name:"ログインする"})),await n(await e.findByRole("main",{name:"シナリオ登録ウィザード"})).toBeVisible(),await n(e.getByTestId("app-url")).toHaveTextContent("/scenarios/new")})}},u={name:"認証: 戻り先がなければホームへ進む",render:()=>y.jsx(ot,{initialUrl:"/account/login"}),play:async({canvasElement:i,step:o})=>{const e=c(i);await o("戻り先なしでログインする",async()=>{await n(await e.findByRole("main",{name:"ログイン"})).toBeVisible(),await t.clear(e.getByLabelText("メールアドレス")),await t.type(e.getByLabelText("メールアドレス"),"reader@myriale.example"),await t.type(e.getByTestId("login-password"),"a"),await t.click(e.getByRole("button",{name:"ログインする"}))}),await o("デフォルトのホーム画面へ移動する",async()=>{await n(await e.findByRole("main",{name:"Myrialeトップページ"})).toBeVisible(),await n(e.getByTestId("app-url")).toHaveTextContent("/")})}},g={name:"US-01: 新しいシナリオを作成したい",play:async({canvasElement:i,step:o})=>{const e=c(i);await o("タイトル未入力では、下書き保存に必要な項目を説明する",async()=>{await t.click(e.getByRole("button",{name:"下書き保存"})),await n(e.getByTestId("scenario-notice")).toHaveTextContent("タイトルを入力すると下書き保存できます。")}),await o("タイトルだけ入力してDraft保存し、ScenarioIdを発行する",async()=>{await t.type(e.getByLabelText("シナリオタイトル"),"星喰いの地下図書館"),await t.click(e.getByRole("button",{name:"下書き保存"})),await n(e.getByTestId("scenario-notice")).toHaveTextContent("Draftとして保存しました"),await n(e.getByText("SCN-DRAFT-0427")).toBeVisible()})}},v={name:"US-02: シナリオのジャンルをタグで指定したい",play:async({canvasElement:i,step:o})=>{const e=c(i);await o("タイトル直下へ複数のジャンルタグを追加し、表紙サマリーへ反映する",async()=>{const a=e.getByLabelText("ジャンルタグを追加");await t.type(a,"ポストアポカリプス{Enter}"),await t.type(a,"巡礼譚"),await t.click(e.getByRole("button",{name:"タグを追加"})),await n(e.getByRole("group",{name:"登録済みジャンルタグ"})).toHaveTextContent("# ポストアポカリプス"),await n(e.getByRole("group",{name:"登録済みジャンルタグ"})).toHaveTextContent("# 巡礼譚"),await n(e.getByRole("complementary",{name:"入力サマリー"})).toHaveTextContent("# ポストアポカリプス # 巡礼譚")}),await o("不要なタグを個別に削除できる",async()=>{await t.click(e.getByRole("button",{name:"巡礼譚タグを削除"})),await n(e.getByRole("group",{name:"登録済みジャンルタグ"})).not.toHaveTextContent("# 巡礼譚")})}},b={name:"US-04: AIの裁量レベルを調整したい",play:async({canvasElement:i,step:o})=>{const e=c(i),a=c(i.ownerDocument.body);await r(e,"AI裁量"),await o("AI裁量を高へ変更し、生成時の挙動差を明示する",async()=>{const l=e.getAllByRole("combobox",{name:"AI裁量"})[0];await t.click(l),await t.click(await a.findByRole("option",{name:"高: 展開を広げる"})),await n(l).toHaveTextContent("高: 展開を広げる"),await n(e.getByRole("complementary",{name:"契約の背表紙"})).toHaveTextContent("高: 展開を広げる")})}},x={name:"US-05: 初期キャラクター条件を設定したい",play:async({canvasElement:i,step:o})=>{const e=c(i);await r(e,"主人公"),await o("主人公の扱いと自由生成時の前提を入力する",async()=>{await n(e.getByRole("combobox",{name:"主人公の扱い"})).toHaveTextContent("自由生成のみ"),await t.clear(e.getByLabelText("主人公の設定")),await t.type(e.getByLabelText("主人公の設定"),"主人公は失踪した師匠を追う新人地図師。名前と年齢はセッション側で自由に決められる。"),n(e.getByLabelText("主人公の設定").value).toContain("新人地図師"),await n(e.getByRole("complementary",{name:"契約の背表紙"})).toHaveTextContent("自由生成")})}},d={name:"US-06: シナリオの開始シーンを定義したい",play:async({canvasElement:i,step:o})=>{const e=c(i);await r(e,"第一場面"),await o("開始シーンを固定し、初回Narrativeの材料にする",async()=>{await t.clear(e.getByLabelText("開始シーン")),await t.type(e.getByLabelText("開始シーン"),"あなたは灰の降る駅で、宛名のない切符を握っている。"),n(e.getByLabelText("開始シーン").value).toContain("灰の降る駅"),await n(e.getByRole("complementary",{name:"契約の背表紙"})).toHaveTextContent("固定")})}},B={name:"US-11: 挿絵のテイストを指定したい",play:async({canvasElement:i,step:o})=>{const e=c(i);c(i.ownerDocument.body),await r(e,"挿絵"),await o("文章と視覚表現を揃える画風を指定する",async()=>{await t.clear(e.getByLabelText("挿絵の画風")),await t.type(e.getByLabelText("挿絵の画風"),"古い天文図の銅版画、インクの滲み、低彩度"),n(e.getByLabelText("挿絵の画風").value).toContain("銅版画")})}},T={name:"US-12: 挿絵の雰囲気を指定したい",play:async({canvasElement:i,step:o})=>{const e=c(i);c(i.ownerDocument.body),await r(e,"挿絵"),await o("挿絵生成に使う感情的トーンを複数指定する",async()=>{await t.clear(e.getByLabelText("挿絵のムード")),await t.type(e.getByLabelText("挿絵のムード"),"孤独、湿度、薄明、遠い鐘の音"),n(e.getByLabelText("挿絵のムード").value).toContain("薄明")})}},R={name:"US-13: 挿絵の禁止要素を指定したい",play:async({canvasElement:i,step:o})=>{const e=c(i);c(i.ownerDocument.body),await r(e,"挿絵"),await o("年齢制限や世界観を守るNG要素を入力する",async()=>{await t.clear(e.getByLabelText("挿絵の禁止要素")),await t.type(e.getByLabelText("挿絵の禁止要素"),"現代兵器、スマートフォン、過度な流血"),n(e.getByLabelText("挿絵の禁止要素").value).toContain("スマートフォン")})}},S={name:"US-14: 挿絵を事前にプレビューしたい",play:async({canvasElement:i,step:o})=>{const e=c(i);c(i.ownerDocument.body),await r(e,"挿絵"),await o("サンプルシーンを入力し、本番相当の挿絵を保存せず生成する",async()=>{await t.clear(e.getByLabelText("サンプルシーン")),await t.type(e.getByLabelText("サンプルシーン"),"地下書庫の水面に星座が反射している。"),await t.click(e.getByRole("button",{name:"サンプルシーンで生成"})),await n(e.getByTestId("illustration-preview")).toHaveTextContent("保存対象外"),await n(e.getByTestId("scenario-notice")).toHaveTextContent("まだ確定していません")})}},E={name:"US-15: プレビューを見ながら挿絵設定を調整したい",play:async({canvasElement:i,step:o})=>{const e=c(i);await r(e,"挿絵"),await o("設定を変更して再生成し、納得した設定のみ保存対象にする",async()=>{await t.clear(e.getByLabelText("挿絵の画風")),await t.type(e.getByLabelText("挿絵の画風"),"影絵、余白多め、灯火だけ金色"),await t.click(e.getByRole("button",{name:"サンプルシーンで生成"})),n(e.getByLabelText("挿絵の画風").value).toContain("影絵"),await n(e.getByTestId("scenario-notice")).toHaveTextContent("設定はまだ確定していません")})}},C={name:"US-17: 登録内容をAIに相談したい",play:async({canvasElement:i,step:o})=>{const e=c(i);await o("AIに相談しても、提案は自動確定しない",async()=>{await t.click(e.getByRole("button",{name:"AIに基本情報案を出してもらう"})),await n(e.getByTestId("ai-suggestion")).toHaveTextContent("基本情報案を3つ提示しました"),await n(e.getByTestId("scenario-notice")).toHaveTextContent("自動確定はしません")})}},I={name:"US-18: どのAIに聞くかを選択したい",play:async({canvasElement:i,step:o})=>{const e=c(i),a=c(i.ownerDocument.body);await r(e,"挿絵"),await o("用途に合わせて相談先AIを選び、選択したAIで提案を生成する",async()=>{await t.click(e.getByRole("combobox",{name:"相談先AI"})),await t.click(await a.findByRole("option",{name:"挿絵AI"})),await t.click(e.getByRole("button",{name:"画風を相談"})),await n(e.getByRole("combobox",{name:"相談先AI"})).toHaveTextContent("挿絵AI"),await n(e.getByTestId("scenario-notice")).toHaveTextContent("挿絵AIに挿絵テイストを相談しました")})}},f={name:"US-19: シナリオの基本情報をAIに補完してもらいたい",play:async({canvasElement:i,step:o})=>{const e=c(i);await o("基本情報候補を見て、採用してからMarkdown本文に入れる",async()=>{await t.click(e.getByRole("button",{name:"AIに基本情報案を出してもらう"})),await t.click(e.getByRole("button",{name:"採用して編集"})),n(e.getByLabelText("基本情報").value).toContain("## 物語の目的"),await n(e.getByTestId("scenario-notice")).toHaveTextContent("採用しました"),await t.click(e.getByRole("button",{name:"プレビュー"})),await n(e.getByRole("article",{name:"基本情報のMarkdownプレビュー"})).toHaveTextContent("水没した書庫を探索する")})}},k={name:"US-21: 挿絵テイストをAIに相談したい",play:async({canvasElement:i,step:o})=>{const e=c(i);await r(e,"挿絵"),await o("シナリオに合う画風候補をAIに提示してもらう",async()=>{await t.click(e.getByRole("button",{name:"画風を相談"})),await n(e.getByTestId("ai-suggestion")).toHaveTextContent("画風候補"),await n(e.getByTestId("ai-suggestion")).toHaveTextContent("銅版画風")})}},L={name:"US-22: 挿絵プロンプトをAIに生成させたい",play:async({canvasElement:i,step:o})=>{const e=c(i);await r(e,"挿絵"),await o("画像生成用プロンプトとネガティブを分離して出力する",async()=>{await t.click(e.getByRole("button",{name:"プロンプトを生成"})),await n(e.getByTestId("ai-suggestion")).toHaveTextContent("ネガティブプロンプト"),await n(e.getByTestId("scenario-notice")).toHaveTextContent("挿絵プロンプトを相談しました")})}},M=()=>y.jsx(p,{initialUrl:"/scenarios/new",initialDb:O("registrationDraft"),scenarioRegistrationContainer:at}),H={name:"US-23: Object Typeの状態とアクションを定義したい",play:async({canvasElement:i,step:o})=>{const e=c(i),a=c(i.ownerDocument.body);await r(e,"世界データ"),await o("新しい種類へstable code、状態、公開範囲を登録する",async()=>{await t.click(e.getByRole("button",{name:"種類を追加"})),await t.clear(a.getByLabelText("種類のstable code")),await t.type(a.getByLabelText("種類のstable code"),"sealed-door"),await t.clear(a.getByLabelText("種類の表示名")),await t.type(a.getByLabelText("種類の表示名"),"隔壁扉"),await t.click(a.getByRole("button",{name:"Type generic configurationへ状態を追加"})),await t.clear(a.getByLabelText("Type generic configuration state code 1")),await t.type(a.getByLabelText("Type generic configuration state code 1"),"open"),await n(a.getByRole("combobox",{name:"公開"})).toHaveTextContent("public"),await t.click(a.getByRole("button",{name:"状態の編集を完了"})),await n(a.getByRole("button",{name:"新しい状態を編集"})).toBeVisible()}),await o("AIへ列挙するアクションinterfaceを登録する",async()=>{await t.click(a.getByRole("button",{name:"Type generic configurationへActionを追加"})),await t.clear(a.getByLabelText("Type generic configuration action code 1")),await t.type(a.getByLabelText("Type generic configuration action code 1"),"open"),await t.clear(a.getByLabelText("Type generic configuration action label 1")),await t.type(a.getByLabelText("Type generic configuration action label 1"),"扉を開ける"),await n(a.getByRole("combobox",{name:"visibility"})).toHaveTextContent("AI choice")})}},A={name:"US-24: Locationを作成してObjectを初期配置したい",render:M,play:async({canvasElement:i,step:o})=>{const e=c(i),a=c(i.ownerDocument.body);await r(e,"世界データ"),await o("場所を追加してstable codeを維持する",async()=>{await t.click(e.getByRole("button",{name:"場所を追加"})),await t.clear(a.getByLabelText("場所のstable code")),await t.type(a.getByLabelText("場所のstable code"),"sealed-vault"),await t.clear(a.getByLabelText("場所の表示名")),await t.type(a.getByLabelText("場所の表示名"),"封印書庫"),await t.click(a.getByRole("button",{name:"編集を完了"})),await n(e.getByRole("button",{name:"封印書庫を編集"})).toBeVisible()}),await o("Objectの状態を1つの表で確認し、受け継いだ状態は初期値だけ変更する",async()=>{await t.click(e.getByRole("button",{name:"北書庫の扉を編集"})),await n(a.getByRole("region",{name:"ordered Type mixins"})).toHaveTextContent("書庫の扉"),await n(a.getByRole("combobox",{name:"初期配置"})).toHaveTextContent("水没した閲覧室");const l=a.getByRole("table",{name:"Object states"});await n(l).toHaveTextContent("開いている"),await n(l).toHaveTextContent("封印名"),await n(l).not.toHaveTextContent("mixin由来"),await t.click(a.getByRole("button",{name:"openの状態を確認"})),await n(a.queryByLabelText("Object state code")).not.toBeInTheDocument(),await t.type(a.getByLabelText("openの初期値"),"true"),await n(a.getByRole("button",{name:"継承値へ戻す"})).toBeEnabled()})}},D={name:"US-25: 状態とアクションに決定的な結果を設定したい",render:M,play:async({canvasElement:i,step:o})=>{const e=c(i),a=c(i.ownerDocument.body);await r(e,"世界データ"),await o("Object paneの統合rule tableで既存adjustのeffective結果を開く",async()=>{await t.click(e.getByRole("button",{name:"北書庫の扉を編集"}));const l=a.getByRole("table",{name:"Object rules"});await n(l).toHaveTextContent("archive-door:generic-open"),await n(l).not.toHaveTextContent("mixin由来"),await t.click(a.getByRole("button",{name:"archive-door:generic-openの実行ルールを確認"}))}),await o("継承condition/priorityと調整済み結果をread-onlyで確認する",async()=>{await n(a.getByText(/override \/ delete \/ adjustを開始することはできません/)).toBeVisible(),await n(a.getAllByText("100")[0]).toBeVisible(),await n(a.getByText("set-state → emit-fact")).toBeVisible(),await n(a.queryByLabelText("実行ルールの優先度")).not.toBeInTheDocument()}),await o("世界データ末尾の公開準備チェックが決定性を確認する",async()=>{await n(e.getByTestId("rule-readiness")).toHaveTextContent("決定的です")})}},U={name:"US-26: 参照中の種類と場所を安全に削除したい",render:M,play:async({canvasElement:i,step:o})=>{const e=c(i),a=c(i.ownerDocument.body);await r(e,"世界データ"),await o("Objectが参照中の種類は削除を拒否する",async()=>{await t.click(e.getByRole("button",{name:/^書庫の扉を編集$/})),await t.click(a.getByRole("button",{name:"この種類を削除"})),await n(e.getByTestId("scenario-notice")).toHaveTextContent("先に種類を変更するかオブジェクトを削除"),await t.click(a.getByRole("button",{name:"編集ペインを閉じる"}))}),await o("同じページでObjectが配置中のLocationも削除を拒否する",async()=>{await t.click(e.getByRole("button",{name:"水没した閲覧室を編集"})),await t.click(a.getByRole("button",{name:"この場所を削除"})),await n(e.getByTestId("scenario-notice")).toHaveTextContent("先に配置先を変更するかオブジェクトを削除")})}},h={name:"US-27: 既存mutationを保持してDraft保存したい",render:M,play:async({canvasElement:i,step:o})=>{const e=c(i),a=c(i.ownerDocument.body);await r(e,"世界データ"),await o("既存adjust operationはeffective結果だけをread-onlyで表示する",async()=>{await t.click(e.getByRole("button",{name:"北書庫の扉を編集"})),await t.click(a.getByRole("button",{name:"archive-door:generic-openの実行ルールを確認"})),await n(a.queryByLabelText("実行ルールの優先度")).not.toBeInTheDocument(),await n(a.getByText(/既存の変更内容は保存時もそのまま保持されます/)).toBeVisible(),await t.click(a.getByRole("button",{name:"閉じる"})),await t.click(a.getByRole("button",{name:"編集を完了"}))}),await o("既存mutationを変更せず下書き保存できる",async()=>{await t.click(e.getByRole("button",{name:"下書き保存"})),await n(e.getByTestId("scenario-notice")).toHaveTextContent("Draftとして保存しました")})}},j={name:"西の扉seed: 統合テーブルで契約と結果を編集・保存する",render:()=>y.jsx(p,{initialUrl:"/scenarios/new",initialDb:O("registrationDraft"),scenarioRegistrationContainer:nt}),play:async({canvasElement:i,step:o})=>{const e=c(i),a=c(i.ownerDocument.body);await r(e,"世界データ"),await t.click(e.getByRole("button",{name:"西の扉を編集"})),await o("ordered mixinを維持しながら状態・アクション・ruleを各1つの表で表示する",async()=>{const l=a.getByRole("region",{name:"ordered Type mixins"});await n(l).toHaveTextContent("開閉可能"),await n(l).toHaveTextContent("出口の扉"),await n(a.getByRole("table",{name:"Object states"})).toHaveTextContent("開いている"),await n(a.getByRole("table",{name:"Object states"})).toHaveTextContent("方向"),await n(a.getByRole("table",{name:"Object actions"})).toHaveTextContent("出口を確認する"),await n(a.getByRole("table",{name:"Object rules"})).toHaveTextContent("exit-door:generic-open-and-exit"),await n(a.getByRole("table",{name:"Object rules"})).toHaveTextContent("local:west-inspect-exit")}),await o("受け継いだ状態は初期値だけ、Objectのアクションとadd ruleは編集できる",async()=>{await t.click(a.getByRole("button",{name:"openの状態を確認"})),await t.type(a.getByLabelText("openの初期値"),"true"),await t.click(a.getByRole("button",{name:"閉じる"})),await t.click(a.getByRole("button",{name:"inspect-exitのアクションを確認"})),await t.clear(a.getByLabelText("Object action label")),await t.type(a.getByLabelText("Object action label"),"出口を詳しく確認する"),await t.click(a.getByRole("button",{name:"閉じる"})),await t.click(a.getByRole("button",{name:"local:west-inspect-exitの実行ルールを確認"})),await t.clear(a.getByLabelText("実行ルールの優先度")),await t.type(a.getByLabelText("実行ルールの優先度"),"95"),await t.click(a.getByRole("button",{name:"閉じる"}))}),await o("既存overrideはread-onlyのままeffective 8 effectを保持する",async()=>{await t.click(a.getByRole("button",{name:"exit-door:generic-open-and-exitの実行ルールを確認"})),await n(a.getByText("set-state → move-session → emit-fact → emit-fact → emit-event → add-narrative-hint → forbid-narrative-fact → forbid-narrative-fact")).toBeVisible(),await n(a.queryByLabelText("実行ルールの優先度")).not.toBeInTheDocument(),await t.click(a.getByRole("button",{name:"閉じる"}))}),await o("編集内容と既存mutationを下書き保存する",async()=>{await t.click(a.getByRole("button",{name:"編集を完了"})),await n(e.getByTestId("rule-readiness")).toHaveTextContent("決定的です"),await t.click(e.getByRole("button",{name:"下書き保存"})),await n(e.getByTestId("scenario-notice")).toHaveTextContent("Draftとして保存しました")})}};var N,P,q;w.parameters={...w.parameters,docs:{...(N=w.parameters)==null?void 0:N.docs,source:{originalSource:`{
...
}`,...(q=(P=w.parameters)==null?void 0:P.docs)==null?void 0:q.source}}};var G,W,_;u.parameters={...u.parameters,docs:{...(G=u.parameters)==null?void 0:G.docs,source:{originalSource:`{
...
}`,...(_=(W=u.parameters)==null?void 0:W.docs)==null?void 0:_.source}}};var $,K,z;g.parameters={...g.parameters,docs:{...($=g.parameters)==null?void 0:$.docs,source:{originalSource:`{
...
}`,...(ee=(Z=b.parameters)==null?void 0:Z.docs)==null?void 0:ee.source}}};var te,ae,ne;x.parameters={...x.parameters,docs:{...(te=x.parameters)==null?void 0:te.docs,source:{originalSource:`{
...
}`,...(ne=(ae=x.parameters)==null?void 0:ae.docs)==null?void 0:ne.source}}};var oe,ie,ce;d.parameters={...d.parameters,docs:{...(oe=d.parameters)==null?void 0:oe.docs,source:{originalSource:`{
...
}`,...(ce=(ie=d.parameters)==null?void 0:ie.docs)==null?void 0:ce.source}}};var se,re,le;B.parameters={...B.parameters,docs:{...(se=B.parameters)==null?void 0:se.docs,source:{originalSource:`{
...
}`,...(le=(re=B.parameters)==null?void 0:re.docs)==null?void 0:le.source}}};var ye,me,pe;T.parameters={...T.parameters,docs:{...(ye=T.parameters)==null?void 0:ye.docs,source:{originalSource:`{
...
}`,...(pe=(me=T.parameters)==null?void 0:me.docs)==null?void 0:pe.source}}};var we,ue,ge;R.parameters={...R.parameters,docs:{...(we=R.parameters)==null?void 0:we.docs,source:{originalSource:`{
...
}`,...(ge=(ue=R.parameters)==null?void 0:ue.docs)==null?void 0:ge.source}}};var ve,be,xe;S.parameters={...S.parameters,docs:{...(ve=S.parameters)==null?void 0:ve.docs,source:{originalSource:`{
...
}`,...(xe=(be=S.parameters)==null?void 0:be.docs)==null?void 0:xe.source}}};var de,Be,Te;E.parameters={...E.parameters,docs:{...(de=E.parameters)==null?void 0:de.docs,source:{originalSource:`{
...
}`,...(Te=(Be=E.parameters)==null?void 0:Be.docs)==null?void 0:Te.source}}};var Re,Se,Ee;C.parameters={...C.parameters,docs:{...(Re=C.parameters)==null?void 0:Re.docs,source:{originalSource:`{
...
}`,...(Ee=(Se=C.parameters)==null?void 0:Se.docs)==null?void 0:Ee.source}}};var Ce,Ie,fe;I.parameters={...I.parameters,docs:{...(Ce=I.parameters)==null?void 0:Ce.docs,source:{originalSource:`{
...
}`,...(fe=(Ie=I.parameters)==null?void 0:Ie.docs)==null?void 0:fe.source}}};var ke,Le,He;f.parameters={...f.parameters,docs:{...(ke=f.parameters)==null?void 0:ke.docs,source:{originalSource:`{
...
}`,...(He=(Le=f.parameters)==null?void 0:Le.docs)==null?void 0:He.source}}};var Ae,De,Ue;k.parameters={...k.parameters,docs:{...(Ae=k.parameters)==null?void 0:Ae.docs,source:{originalSource:`{
...
}`,...(Ue=(De=k.parameters)==null?void 0:De.docs)==null?void 0:Ue.source}}};var he,je,Oe;L.parameters={...L.parameters,docs:{...(he=L.parameters)==null?void 0:he.docs,source:{originalSource:`{
...
}`,...(Oe=(je=L.parameters)==null?void 0:je.docs)==null?void 0:Oe.source}}};var Me,Fe,Ve;H.parameters={...H.parameters,docs:{...(Me=H.parameters)==null?void 0:Me.docs,source:{originalSource:`{
...
}`,...(Ve=(Fe=H.parameters)==null?void 0:Fe.docs)==null?void 0:Ve.source}}};var Ne,Pe,qe;A.parameters={...A.parameters,docs:{...(Ne=A.parameters)==null?void 0:Ne.docs,source:{originalSource:`{
...
}`,...(qe=(Pe=A.parameters)==null?void 0:Pe.docs)==null?void 0:qe.source}}};var Ge,We,_e;D.parameters={...D.parameters,docs:{...(Ge=D.parameters)==null?void 0:Ge.docs,source:{originalSource:`{
...
}`,...(_e=(We=D.parameters)==null?void 0:We.docs)==null?void 0:_e.source}}};var $e,Ke,ze;U.parameters={...U.parameters,docs:{...($e=U.parameters)==null?void 0:$e.docs,source:{originalSource:`{
...
}`,...(Xe=(Qe=h.parameters)==null?void 0:Qe.docs)==null?void 0:Xe.source}}};var Ye,Ze,et;j.parameters={...j.parameters,docs:{...(Ye=j.parameters)==null?void 0:Ye.docs,source:{originalSource:`{
...
}`,...(et=(Ze=j.parameters)==null?void 0:Ze.docs)==null?void 0:et.source}}};const jt=["AuthenticationReturnsToScenarioCreation","AuthenticationDefaultsToHome","US01CreateDraftScenario","US02SpecifyGenreTag","US04TuneAiFreedom","US05SetInitialCharacter","US06DefineOpeningScene","US11SpecifyIllustrationStyle","US12SpecifyIllustrationMood","US13SpecifyNegativeElements","US14PreviewIllustration","US15IterateIllustrationSettings","US17ConsultAiAboutRegistration","US18SelectAiByPurpose","US19AiCompletesSummary","US21ConsultIllustrationTaste","US22GenerateIllustrationPrompt","US23DefineObjectTypeStatesAndActions","US24CreateLocationsAndPlaceObjects","US25AuthorDeterministicActionResults","US26KeepDependenciesSafe","US27SaveIncompleteRuleDataAsDraft","AuthorWestDoorSeedWithEightOrderedEffects"];export{u as AuthenticationDefaultsToHome,w as AuthenticationReturnsToScenarioCreation,j as AuthorWestDoorSeedWithEightOrderedEffects,g as US01CreateDraftScenario,v as US02SpecifyGenreTag,b as US04TuneAiFreedom,x as US05SetInitialCharacter,d as US06DefineOpeningScene,B as US11SpecifyIllustrationStyle,T as US12SpecifyIllustrationMood,R as US13SpecifyNegativeElements,S as US14PreviewIllustration,E as US15IterateIllustrationSettings,C as US17ConsultAiAboutRegistration,I as US18SelectAiByPurpose,f as US19AiCompletesSummary,k as US21ConsultIllustrationTaste,L as US22GenerateIllustrationPrompt,H as US23DefineObjectTypeStatesAndActions,A as US24CreateLocationsAndPlaceObjects,D as US25AuthorDeterministicActionResults,U as US26KeepDependenciesSafe,h as US27SaveIncompleteRuleDataAsDraft,jt as __namedExportsOrder,ht as default};
