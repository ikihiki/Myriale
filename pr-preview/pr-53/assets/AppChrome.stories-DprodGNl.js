import{j as g}from"./jsx-runtime-BO8uF4Og.js";import{w as n,e,u as p}from"./index-C4S39nCK.js";import{A}from"./AppChrome-DR5p-0yD.js";import"./index-D4H_InIO.js";import"./Surfaces-xpIMDkG0.js";import"./navigationRecipes-DkSbwkz5.js";import"./MyrialeToggle-DCXJQOk6.js";import"./index-DzKAYa42.js";import"./MyrialeMenu-Bp2y9ciA.js";const D={title:"コンポーネント/AppChrome",component:A,parameters:{layout:"fullscreen",notes:"全ワイヤー共通のアプリ・ナビゲーション。上部バー（ブランド / セクション / アカウントメニュー）とパンくずで、実アプリと同じ移動ができます。各セクションやアカウントメニューから対応ワイヤーのストーリーへ遷移します。",docs:{description:{component:`AppChrome — the global application navigation shared by every page.
...
}`,...(V=(x=m.parameters)==null?void 0:x.docs)==null?void 0:V.source}}};var H,M,f;u.parameters={...u.parameters,docs:{...(H=u.parameters)==null?void 0:H.docs,source:{originalSource:`{
  name: '運用セクション（管理者）',
  args: {
    section: 'operations',
    breadcrumbs: [{
...
}`,...(f=(M=u.parameters)==null?void 0:M.docs)==null?void 0:f.source}}};const L=["SignedIn","MobileNavigation","SignedOut","OperationsConsole"];export{c as MobileNavigation,u as OperationsConsole,l as SignedIn,m as SignedOut,L as __namedExportsOrder,D as default};
