...
export function AuthScaffold({
  ...
  return (
    <div className="grid grid-cols-[minmax(360px,480px)_minmax(0,360px)] items-start justify-center gap-[18px] px-[22px] py-[clamp(20px,5vh,56px)] max-[1080px]:grid-cols-[minmax(0,480px)]">
      <main
        className="rounded-[28px] border border-[var(--line)] bg-[rgba(255,250,240,.92)] p-[30px] shadow-[var(--shadow)] [&_.desk-brand]:mb-[22px]"
      ...
      >
        ...
        {children}
        {footer && (
          <div className="mt-5 flex flex-wrap items-center gap-x-4 gap-y-1.5 border-t border-[var(--line)] pt-4 text-[13px] text-[var(--ink-soft)]">
            {footer}
          </div>
        )}
      </main>
