...
export const scenarioWizardShellClass = [
  ...
  'max-myr-workspace:grid-cols-1',
].join(' ');

export const wizardPaperClass = [
  'grid min-h-[calc(100vh-28px)] content-start rounded-myr-panel border border-[rgba(220,231,242,0.42)] px-6 py-5',
...
export const wizardPanelClass = [
  'mb-3 max-w-none border-0 bg-transparent px-0 pt-0.5',
  '[&_h2]:mb-1 [&_h2]:font-serif [&_h2]:text-[clamp(28px,3.2vw,46px)] [&_h2]:leading-none [&_h2]:tracking-[-0.05em]',
  '[&_p]:my-1.5 [&_p]:mb-3 [&_p]:max-w-215 [&_p]:text-myr-ui-sm [&_p]:text-[#566072]',
  '[&_label]:my-3 [&_label]:grid [&_label]:gap-1.25 [&_label]:text-xs [&_label]:font-black [&_label]:tracking-[0.02em] [&_label]:text-[#4f5767]',
  '[&_input]:rounded-none [&_input]:border-x-0 [&_input]:border-t-0 [&_input]:border-b-2 [&_input]:border-[rgba(23,21,31,0.22)] [&_input]:bg-white/40 [&_input]:px-3 [&_input]:py-2.5 [&_input]:text-myr-control [&_input]:shadow-none',
  '[&_select]:rounded-none [&_select]:border-x-0 [&_select]:border-t-0 [&_select]:border-b-2 [&_select]:border-[rgba(23,21,31,0.22)] [&_select]:bg-white/40 [&_select]:px-3 [&_select]:py-2.5 [&_select]:text-myr-control [&_select]:shadow-none',
...
export const wizardProgressClass = [
  ...
  '[&_small]:text-myr-caption [&_small]:text-[#566072]',
].join(' ');
...
export const wizardSummaryClass = [
  ...
  '[&_h3]:mb-1.25 [&_h3]:mt-0 [&_h3]:text-xs',
  '[&_p]:my-1 [&_p]:line-clamp-3 [&_p]:overflow-hidden [&_p]:text-myr-caption [&_p]:leading-[1.35] [&_p]:text-[#3f4552]',
].join(' ');
