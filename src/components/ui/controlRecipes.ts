...
export const inputVariantClassNames: Record<InputVariant, string> = {
  ...
  compact: '[font:inherit] min-h-[30px] w-full rounded-2xl border border-myr-line bg-myr-paper-bright px-2 py-1.5 text-myr-ui-sm text-myr-ink',
...
export const textareaVariantClassNames: Record<TextareaVariant, string> = {
  field: '[font:inherit] min-h-[126px] w-full resize-y rounded-2xl border border-myr-line bg-myr-paper-bright px-3.5 py-3 text-myr-ink',
  underline: '[font:inherit] min-h-[126px] w-full resize-y rounded-none border-x-0 border-t-0 border-b-2 border-myr-ink/20 bg-white/45 px-3 py-2.5 text-myr-ink shadow-none',
  compact: '[font:inherit] min-h-[30px] w-full resize-y rounded-2xl border border-myr-line bg-myr-paper-bright px-2 py-1.5 text-myr-ui-sm text-myr-ink',
  borderless: '[font:inherit] min-h-[126px] w-full resize-y rounded-none border-0 bg-transparent px-3.5 py-3 text-myr-ink shadow-none',
  composer: '[font:inherit] block min-h-[76px] max-h-[220px] w-full resize-y rounded-none border-0 bg-transparent px-[19px] pt-[17px] pb-2 text-[15px] leading-[1.6] text-[#24212d] shadow-none placeholder:text-[#8a8791] focus:outline-none focus:shadow-none',
};
