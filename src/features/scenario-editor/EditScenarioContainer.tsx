...
export function EditScenarioContainer({ scenarioId, api }: { scenarioId: string; api?: ScenarioApi }) {
  ...
  return <EditScenarioPresentation
    ...
    saving={saving}
    aiWorking={aiWorking}
    actions={{ save, assist, debug, importNarrativeTest, compareNarrativeDraft, openEvaluationCreate: () => navigate?.('evaluationCreate', { query: { sourceScenarioId: scenarioId } }), checkReadiness, publish }}
