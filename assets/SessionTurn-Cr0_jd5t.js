import{j as t}from"./jsx-runtime-BO8uF4Og.js";function m({lead:e}){return t.jsxs("div",{className:`session-turn-lead lead-${e.tone}`,"data-testid":e.testId,children:[t.jsxs("p",{className:"session-turn-lead-line",children:[t.jsx("span",{className:`session-turn-lead-tag tag-${e.tone}`,"aria-hidden":"true",children:e.tag}),e.srLabel&&t.jsx("span",{className:"sr-only",children:e.srLabel}),t.jsx("span",{className:"session-turn-lead-text",children:e.text})]}),e.actions&&t.jsx("div",{className:"session-turn-lead-actions",children:e.actions}),e.detail]})}function h({headingActions:e,lead:a,narrative:r,narrativeTag:n,narrativeTestId:i,selected:s=!1,variantClassName:l="",ariaLabel:o,testId:d,articleRef:c}){const u=t.jsxs("p",{className:"session-turn-narrative","data-testid":i,children:[n&&t.jsx("span",{className:"session-turn-narrative-tag","aria-hidden":"true",children:n}),r]}),p=a?t.jsx(m,{lead:a}):null;return t.jsxs("article",{className:`session-turn group ${s?"selected":""} ${l}`.trim(),"aria-label":o,"data-testid":d,ref:c,children:[p,u,e&&t.jsx("div",{className:"mt-[-2px] flex min-h-[30px] justify-start",children:t.jsx("div",{className:"flex gap-1 opacity-40 transition-opacity duration-150 group-hover:opacity-100 group-focus-within:opacity-100 max-sm:opacity-100 motion-reduce:transition-none",children:e})})]})}h.__docgenInfo={description:"",methods:[],displayName:"SessionTurn",props:{headingActions:{required:!1,tsType:{name:"ReactNode"},description:'Quiet action row shown after the Narrative (e.g. a "ここまで戻る" button).'},lead:{required:!1,tsType:{name:"signature",type:"object",raw:`{
  tone: TurnLeadTone;
