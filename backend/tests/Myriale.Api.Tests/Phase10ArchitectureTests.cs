...
public sealed class Phase10ArchitectureTests
{
    ...
    public void ClosedDiscriminatorsAndDeletedCompatibilitySymbolsStayAbsent()
    {
        ...
        var absent = new[]
        {
            ...
            "Myriale.Api.Contracts.NarrativeInteractionTypes", "Myriale.Api.Modules.Execution.ModuleHandoffPreparer",
            "Myriale.Api.Services.SessionScenarioProgressionService", "Myriale.Api.Services.PlaySessionListingService",
            "Myriale.Api.Modules.IModulePackageService", "Myriale.Api.Modules.ModulePackageService",
            "Myriale.Api.Modules.Runtime.IModulePackageRuntimeCatalog", "Myriale.Api.Modules.Runtime.ModulePackageRuntimeCatalog",
