...
namespace Myriale.Api.Infrastructure.Persistence.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            {
                UpNpgsql(migrationBuilder);
                return;
            }

            throw new NotSupportedException($"InitialCreate does not support Entity Framework provider '{ActiveProvider}'.");
        }
        ...
        private static void UpNpgsql(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "AiCredentials",
                columns: table => new
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SystemPrompt = table.Column<string>(type: "character varying(20000)", maxLength: 20000, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ActiveProvider = table.Column<string>(type: "character varying(80)", maxLength: 80, nullable: false),
                    Revision = table.Column<long>(type: "bigint", nullable: false),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AlgorithmKey = table.Column<string>(type: "character varying(80)", maxLength: 80, nullable: false),
                    AlgorithmVersion = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: false),
                    SourceWatermark = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: false),
                    IncludedAttemptCount = table.Column<int>(type: "integer", nullable: false),
                    IncludedMachineJudgmentCount = table.Column<int>(type: "integer", nullable: false),
                    IncludedHumanJudgmentCount = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: false),
                    ItemId = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: false),
                    ...
                    Verdict = table.Column<bool>(type: "boolean", nullable: true),
                    TagsJson = table.Column<string>(type: "text", nullable: false),
                    Comment = table.Column<string>(type: "text", nullable: false),
                    Confidence = table.Column<decimal>(type: "numeric", nullable: true),
                    Revision = table.Column<int>(type: "integer", nullable: false),
                    SupersedesJudgmentId = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: false),
                    SessionId = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: false),
                    RubricVersion = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: false),
                    RequiredReviewsPerOutput = table.Column<int>(type: "integer", nullable: false),
                    ReviewerPoolJson = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RetentionPolicy = table.Column<string>(type: "character varying(80)", maxLength: 80, nullable: false),
                    Status = table.Column<string>(type: "character varying(32)", maxLength: 32, nullable: false),
                    Revision = table.Column<long>(type: "bigint", nullable: false),
                    IdempotencyKey = table.Column<string>(type: "character varying(160)", maxLength: 160, nullable: true),
                    CanonicalPayloadHash = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: true),
                    CorpusKey = table.Column<string>(type: "character varying(80)", maxLength: 80, nullable: true),
                    CorpusVersion = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: true),
                    ConfigJson = table.Column<string>(type: "text", nullable: false),
                    RubricJson = table.Column<string>(type: "text", nullable: false),
                    ReviewPolicyJson = table.Column<string>(type: "text", nullable: false),
                    PlannedAttemptCount = table.Column<int>(type: "integer", nullable: false),
                    TerminalAttemptCount = table.Column<int>(type: "integer", nullable: false),
                    SucceededAttemptCount = table.Column<int>(type: "integer", nullable: false),
                    FailedAttemptCount = table.Column<int>(type: "integer", nullable: false),
                    ReviewedItemCount = table.Column<int>(type: "integer", nullable: false),
                    CreatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    ...
                    ReviewOpenedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true),
                    ReviewClosedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true),
                    ...
                    IdentitiesRevealed = table.Column<bool>(type: "boolean", nullable: false),
                    IdentitiesRevealedById = table.Column<string>(type: "character varying(450)", maxLength: 450, nullable: true),
                    IdentitiesRevealedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true),
                    CurrentAggregateRevision = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_EvaluationSessions", x => x.Id);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UpdatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    Revision = table.Column<int>(type: "integer", nullable: false),
                    DefinitionVersionCounter = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Scenarios", x => x.Id);
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: false),
                    BatchId = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: false),
                    OpaqueCode = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: false),
                    ReviewerId = table.Column<string>(type: "character varying(450)", maxLength: 450, nullable: false),
                    Status = table.Column<string>(type: "character varying(24)", maxLength: 24, nullable: false),
                    Revision = table.Column<long>(type: "bigint", nullable: false),
                    CreatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BlindCode = table.Column<string>(type: "character varying(24)", maxLength: 24, nullable: false),
                    ProfileId = table.Column<string>(type: "character varying(80)", maxLength: 80, nullable: false),
                    ProfileRevision = table.Column<long>(type: "bigint", nullable: false),
                    ProfileSource = table.Column<string>(type: "character varying(32)", maxLength: 32, nullable: false),
                    Provider = table.Column<string>(type: "character varying(80)", maxLength: 80, nullable: false),
                    Adapter = table.Column<string>(type: "character varying(80)", maxLength: 80, nullable: false),
                    Model = table.Column<string>(type: "character varying(240)", maxLength: 240, nullable: false),
                    ProfileDescriptorJson = table.Column<string>(type: "text", nullable: false),
                    ProfileDescriptorHash = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: false),
                    GenerationOverridesJson = table.Column<string>(type: "text", nullable: false),
                    RetryPolicyJson = table.Column<string>(type: "text", nullable: false),
                    Repetitions = table.Column<int>(type: "integer", nullable: false),
                    MaxInvocations = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RequestVersion = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: false),
                    PromptVersion = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: false),
                    ResponseSchemaVersion = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: false),
                    CanonicalizationVersion = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: false),
                    RequestHash = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: false),
                    SourceBundleHash = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: false),
                    Sensitivity = table.Column<string>(type: "character varying(32)", maxLength: 32, nullable: false),
                    ImportedById = table.Column<string>(type: "character varying(450)", maxLength: 450, nullable: false),
                    ImportedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    CorpusKey = table.Column<string>(type: "character varying(80)", maxLength: 80, nullable: true),
                    CorpusVersion = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: true),
                    CorpusCaseKey = table.Column<string>(type: "character varying(120)", maxLength: 120, nullable: true),
                    SourceScenarioId = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: true),
                    SourceDefinitionVersionId = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: true),
                    SourceSessionId = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: true),
                    SourceTurnId = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: true),
                    SourceExecutionId = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: true),
                    SourceAttemptId = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: true),
                    SourceRuleStepId = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: true),
                    SourceInteractionId = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: true),
                    ...
                    SupersedesSituationId = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_EvaluationSituations", x => x.Id);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Revision = table.Column<int>(type: "integer", nullable: false),
                    StartLocationCode = table.Column<string>(type: "character varying(80)", maxLength: 80, nullable: false),
                    ScenarioTitle = table.Column<string>(type: "text", nullable: false),
                    ScenarioSummary = table.Column<string>(type: "character varying(2000)", maxLength: 2000, nullable: false),
                    ScenarioGenre = table.Column<string>(type: "character varying(80)", maxLength: 80, nullable: false),
                    ScenarioTone = table.Column<string>(type: "character varying(120)", maxLength: 120, nullable: false),
                    ScenarioLore = table.Column<string>(type: "text", nullable: false),
                    ScenarioAiFreedom = table.Column<string>(type: "character varying(120)", maxLength: 120, nullable: false),
                    ScenarioHeroMode = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
                    ScenarioHeroFreeGenerationAllowed = table.Column<bool>(type: "boolean", nullable: false),
                    ScenarioHero = table.Column<string>(type: "text", nullable: false),
                    ScenarioOpening = table.Column<string>(type: "text", nullable: false),
                    ScenarioIllustrationStyle = table.Column<string>(type: "character varying(240)", maxLength: 240, nullable: false),
                    ScenarioIllustrationMood = table.Column<string>(type: "character varying(240)", maxLength: 240, nullable: false),
                    ScenarioIllustrationNegative = table.Column<string>(type: "text", nullable: false),
                    ScenarioSampleScene = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ScenarioDefinitionVersions", x => x.Id);
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: false),
                    AssignmentId = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: false),
                    AttemptId = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: false),
                    OpaqueCandidateCode = table.Column<string>(type: "character varying(24)", maxLength: 24, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EvaluationReviewItems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_EvaluationReviewItems_EvaluationReviewAssignments_Assignmen~",
                        column: x => x.AssignmentId,
                        principalTable: "EvaluationReviewAssignments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: false),
                    SessionId = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: false),
                    SituationId = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: false),
                    CandidateId = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AuthoringDataJson = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ScenarioLocations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ScenarioLocations_ScenarioDefinitionVersions_DefinitionVers~",
                        column: x => x.DefinitionVersionId,
                        principalTable: "ScenarioDefinitionVersions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "text", nullable: false),
                    SchemaVersion = table.Column<int>(type: "integer", nullable: false),
                    StateSchemaJson = table.Column<string>(type: "text", nullable: false),
                    DefaultStateJson = table.Column<string>(type: "text", nullable: false),
                    PublicProjectionJson = table.Column<string>(type: "text", nullable: false),
                    ProfileSchemaJson = table.Column<string>(type: "text", nullable: false),
                    ProfileDefaultsJson = table.Column<string>(type: "text", nullable: false),
                    GenericActionRulesJson = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ScenarioObjectTypes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ScenarioObjectTypes_ScenarioDefinitionVersions_DefinitionVe~",
                        column: x => x.DefinitionVersionId,
                        principalTable: "ScenarioDefinitionVersions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ScenarioProgressionNodes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ScenarioProgressionNodes_ScenarioDefinitionVersions_Definit~",
                        column: x => x.DefinitionVersionId,
                        principalTable: "ScenarioDefinitionVersions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: false),
                    AttemptId = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: false),
                    InvocationNumber = table.Column<int>(type: "integer", nullable: false),
                    Status = table.Column<string>(type: "character varying(32)", maxLength: 32, nullable: false),
                    LeaseToken = table.Column<string>(type: "character varying(80)", maxLength: 80, nullable: false),
                    AttemptRevision = table.Column<long>(type: "bigint", nullable: false),
                    RequestEnvelopeJson = table.Column<string>(type: "text", nullable: false),
                    SentPrompt = table.Column<string>(type: "text", nullable: true),
                    RawResponse = table.Column<string>(type: "text", nullable: true),
                    RawError = table.Column<string>(type: "text", nullable: true),
                    ParsedOutputJson = table.Column<string>(type: "text", nullable: true),
                    ValidationJson = table.Column<string>(type: "text", nullable: true),
                    ResponseSchemaHash = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: true),
                    ProfileSnapshotJson = table.Column<string>(type: "text", nullable: false),
                    GenerationConfigJson = table.Column<string>(type: "text", nullable: false),
                    ...
                    QueueLatencyMilliseconds = table.Column<long>(type: "bigint", nullable: true),
                    TimeToFirstTokenMilliseconds = table.Column<long>(type: "bigint", nullable: true),
                    GenerationLatencyMilliseconds = table.Column<long>(type: "bigint", nullable: true),
                    EndToEndLatencyMilliseconds = table.Column<long>(type: "bigint", nullable: true),
                    ...
                    RawResultHash = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Code = table.Column<string>(type: "character varying(80)", maxLength: 80, nullable: false),
                    Name = table.Column<string>(type: "character varying(160)", maxLength: 160, nullable: false),
                    ProfileMarkdown = table.Column<string>(type: "text", nullable: false),
                    LocationId = table.Column<string>(type: "text", nullable: false),
                    InitialStateOverrideJson = table.Column<string>(type: "text", nullable: false),
                    MixinTypeCodesJson = table.Column<string>(type: "text", nullable: false),
                    LocalStateSchemaJson = table.Column<string>(type: "text", nullable: false),
                    LocalDefaultStateJson = table.Column<string>(type: "text", nullable: false),
                    LocalPublicProjectionJson = table.Column<string>(type: "text", nullable: false),
                    LocalProfileSchemaJson = table.Column<string>(type: "text", nullable: false),
                    LocalProfileDefaultsJson = table.Column<string>(type: "text", nullable: false),
                    ProfileValuesJson = table.Column<string>(type: "text", nullable: false),
                    LocalActionsJson = table.Column<string>(type: "text", nullable: false),
                    ActionRuleMutationsJson = table.Column<string>(type: "text", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ScenarioObjects", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ScenarioObjects_ScenarioDefinitionVersions_DefinitionVersio~",
                        column: x => x.DefinitionVersionId,
                        principalTable: "ScenarioDefinitionVersions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "text", nullable: false),
                    ArgumentSchemaJson = table.Column<string>(type: "text", nullable: false),
                    AvailabilityConditionJson = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ScenarioProgressionTransitions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ScenarioProgressionTransitions_ScenarioDefinitionVersions_D~",
                        column: x => x.DefinitionVersionId,
                        principalTable: "ScenarioDefinitionVersions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SessionId = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: false),
                    AttemptId = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: false),
                    InvocationId = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: false),
                    OutputHash = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: false),
                    JudgeKey = table.Column<string>(type: "character varying(80)", maxLength: 80, nullable: false),
                    JudgeVersion = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: false),
                    CriterionKey = table.Column<string>(type: "character varying(120)", maxLength: 120, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EvaluationMachineJudgments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_EvaluationMachineJudgments_EvaluationModelInvocations_Invoc~",
                        column: x => x.InvocationId,
                        principalTable: "EvaluationModelInvocations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Stage = table.Column<string>(type: "character varying(32)", maxLength: 32, nullable: false),
                    AiProfileId = table.Column<string>(type: "character varying(80)", maxLength: 80, nullable: false),
                    Provider = table.Column<string>(type: "character varying(80)", maxLength: 80, nullable: true),
                    ...
                    SentPrompt = table.Column<string>(type: "text", nullable: true),
                    ReceivedResult = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<string>(type: "character varying(32)", maxLength: 32, nullable: false),
                    Schema = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PayloadHash = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: false),
                    ActionDecisionAiProfileId = table.Column<string>(type: "character varying(80)", maxLength: 80, nullable: true),
                    NarrativeAiProfileId = table.Column<string>(type: "character varying(80)", maxLength: 80, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Body = table.Column<string>(type: "text", nullable: false),
                    CanonStatus = table.Column<string>(type: "character varying(24)", maxLength: 24, nullable: false),
                    FirstTurnId = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: true),
                    UpdatedFromTurnId = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: true),
                    UpdateSource = table.Column<string>(type: "character varying(24)", maxLength: 24, nullable: false),
                    Revision = table.Column<long>(type: "bigint", nullable: false),
                    CreatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: false),
                    SessionId = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: false),
                    ScenarioObjectId = table.Column<string>(type: "text", nullable: false),
                    LocationId = table.Column<string>(type: "text", nullable: false),
                    StateJson = table.Column<string>(type: "text", nullable: false),
                    Revision = table.Column<long>(type: "bigint", nullable: false),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SessionId = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: false),
                    ExecutionId = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: false),
                    PlayerInputId = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: false),
                    ScenarioDefinitionVersionId = table.Column<string>(type: "text", nullable: false),
                    Stage = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: false),
                    SchemaVersion = table.Column<int>(type: "integer", nullable: false),
                    PreSessionRevision = table.Column<long>(type: "bigint", nullable: false),
                    PostSessionRevision = table.Column<long>(type: "bigint", nullable: true),
                    ObjectRevisionsJson = table.Column<string>(type: "text", nullable: false),
                    ActionSnapshotJson = table.Column<string>(type: "text", nullable: false),
                    DecisionJson = table.Column<string>(type: "text", nullable: true),
                    SelectedRuleId = table.Column<string>(type: "text", nullable: true),
                    ResolutionPlanJson = table.Column<string>(type: "text", nullable: true),
                    EntityStateTransitionJson = table.Column<string>(type: "text", nullable: true),
                    AppliedEffectsJson = table.Column<string>(type: "text", nullable: true),
                    PublicPostStateJson = table.Column<string>(type: "text", nullable: true),
                    FactsJson = table.Column<string>(type: "text", nullable: true),
                    EventsJson = table.Column<string>(type: "text", nullable: true),
                    NarrativeHintsJson = table.Column<string>(type: "text", nullable: true),
                    ForbiddenNarrativeFactsJson = table.Column<string>(type: "text", nullable: true),
                    ExtensionReceiptJson = table.Column<string>(type: "text", nullable: true),
                    EnumeratedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true),
                    SelectedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true),
                    ResolvedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true),
                    ExtensionCompletedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true),
                    AppliedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true),
                    NarrativePublishedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true),
                    CreatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ScenarioDefinitionVersionId = table.Column<string>(type: "text", nullable: true),
                    ...
                    CreationPayloadHash = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Sessions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Sessions_ScenarioDefinitionVersions_ScenarioDefinitionVersi~",
                        column: x => x.ScenarioDefinitionVersionId,
                        principalTable: "ScenarioDefinitionVersions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: false),
                    SessionId = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: false),
                    FromTurnId = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: false),
                    ToTurnId = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: false),
                    ...
                    CluesJson = table.Column<string>(type: "text", nullable: false),
                    InventoryJson = table.Column<string>(type: "text", nullable: false),
                    ModuleResultsJson = table.Column<string>(type: "text", nullable: false),
                    Body = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TurnId = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: false),
                    NoteId = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EvaluationHumanJudgments_ItemId_ReviewerId_CriterionKey_Rev~",
                table: "EvaluationHumanJudgments",
                columns: new[] { "ItemId", "ReviewerId", "CriterionKey", "Revision" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_EvaluationMachineJudgments_InvocationId_JudgeKey_JudgeVersi~",
                table: "EvaluationMachineJudgments",
                columns: new[] { "InvocationId", "JudgeKey", "JudgeVersion", "CriterionKey" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ScenarioProgressionTransitions_DefinitionVersionId_SourceNo~",
                table: "ScenarioProgressionTransitions",
                columns: new[] { "DefinitionVersionId", "SourceNodeId", "SignalCode" },
                unique: true);
